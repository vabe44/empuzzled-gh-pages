 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const Fp="FirebaseError";class Bt extends Error{constructor(e,t,r){super(t),this.code=e,this.customData=r,this.name=Fp,Object.setPrototypeOf(this,Bt.prototype),Error.captureStackTrace&&Error.captureStackTrace(this,fs.prototype.create)}}class fs{constructor(e,t,r){this.service=e,this.serviceName=t,this.errors=r}create(e,...t){const r=t[0]||{},s=`${this.service}/${e}`,o=this.errors[e],a=o?Up(o,r):"Error",c=`${this.serviceName}: ${a} (${s}).`;return new Bt(s,c,r)}}function Up(n,e){return n.replace(Bp,(t,r)=>{const s=e[r];return s!=null?String(s):`<${r}?>`})}const Bp=/\{\$([^}]+)}/g;function jp(n){for(const e in n)if(Object.prototype.hasOwnProperty.call(n,e))return!1;return!0}function Dt(n,e){if(n===e)return!0;const t=Object.keys(n),r=Object.keys(e);for(const s of t){if(!r.includes(s))return!1;const o=n[s],a=e[s];if(hc(o)&&hc(a)){if(!Dt(o,a))return!1}else if(o!==a)return!1}for(const s of r)if(!t.includes(s))return!1;return!0}function hc(n){return n!==null&&typeof n=="object"}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const mr=Fg;function dh(n,e={}){let t=n;typeof e!="object"&&(e={name:e});const r={name:qo,automaticDataCollectionEnabled:!0,...e},s=r.name;if(typeof s!="string"||!s)throw on.create("bad-app-name",{appName:String(s)});if(t||(t=oh()),!t)throw on.create("no-options");const o=rs.get(s);if(o){if(Dt(t,o.options)&&Dt(r,o.config))return o;throw on.create("duplicate-app",{appName:s})}const a=new Kp(s);for(const u of zo.values())a.addComponent(u);const c=new $g(t,r,a);return rs.set(s,c),c}function fh(n=qo){const e=rs.get(n);if(!e&&n===qo&&oh())return dh();if(!e)throw on.create("no-app",{appName:n});return e}function _c(){return Array.from(rs.values())}function an(n,e,t){let r=Ug[n]??n;t&&(r+=`-${t}`);const s=r.match(/\s|\//),o=e.match(/\s|\//);if(s||o){const a=[`Unable to register library "${r}" with version "${e}":`];s&&a.push(`library name "${r}" contains illegal characters (whitespace or "/")`),s&&o&&a.push("and"),o&&a.push(`version name "${e}" contains illegal characters (whitespace or "/")`),Nt.warn(a.join(" "));return}sr(new Dn(`${r}-version`,()=>({library:r,version:e}),"VERSION"))}/**
 * @license
 * Copyright 2021 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const qg="firebase-heartbeat-database",zg=1,ss="firebase-heartbeat-store";let So=null;function ph(){return So||(So=ag(qg,zg,{upgrade:(n,e)=>{switch(e){case 0:try{n.createObjectStore(ss)}catch(t){console.warn(t)}}}}).catch(n=>{throw on.create("idb-open",{originalErrorMessage:n.message})})),So}async function Hg(n){try{const t=(await ph()).transaction(ss),r=await t.objectStore(ss).get(gh(n));return await t.done,r}catch(e){if(e instanceof Bt)Nt.warn(e.message);else{const t=on.create("idb-get",{originalErrorMessage:e?.message});Nt.warn(t.message)}}}async function yc(n,e){try{const r=(await ph()).transaction(ss,"readwrite");await r.objectStore(ss).put(e,gh(n)),await r.done}catch(t){if(t instanceof Bt)Nt.warn(t.message);else{const r=on.create("idb-set",{originalErrorMessage:t?.message});Nt.warn(r.message)}}}function gh(n){return`${n.name}!${n.options.appId}`}/**
 * @license
 * Copyright 2021 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
...
*/var ln,mh;(function(){var n;/** @license
 ...
 Copyright The Closure Library Authors.
 SPDX-License-Identifier: Apache-2.0
*/function e(T,m){function _(){}_.prototype=m.prototype,T.F=m.prototype,T.prototype=new _,T.prototype.constructor=T,T.D=function(E,w,R){for(var v=Array(arguments.length-2),Ae=2;Ae<arguments.length;Ae++)v[Ae-2]=arguments[Ae];return m.prototype[w].apply(E,v)}}function t(){this.blockSize=-1}function r(){this.blockSize=-1,this.blockSize=64,this.g=Array(4),this.C=Array(this.blockSize),this.o=this.h=0,this.u()}e(r,t),r.prototype.u=function(){this.g[0]=1732584193,this.g[1]=4023233417,this.g[2]=2562383102,this.g[3]=271733878,this.o=this.h=0};function s(T,m,_){_||(_=0);const E=Array(16);if(typeof m=="string")for(var w=0;w<16;++w)E[w]=m.charCodeAt(_++)|m.charCodeAt(_++)<<8|m.charCodeAt(_++)<<16|m.charCodeAt(_++)<<24;else for(w=0;w<16;++w)E[w]=m[_++]|m[_++]<<8|m[_++]<<16|m[_++]<<24;m=T.g[0],_=T.g[1],w=T.g[2];let R=T.g[3],v;v=m+(R^_&(w^R))+E[0]+3614090360&4294967295,m=_+(v<<7&4294967295|v>>>25),v=R+(w^m&(_^w))+E[1]+3905402710&4294967295,R=m+(v<<12&4294967295|v>>>20),v=w+(_^R&(m^_))+E[2]+606105819&4294967295,w=R+(v<<17&4294967295|v>>>15),v=_+(m^w&(R^m))+E[3]+3250441966&4294967295,_=w+(v<<22&4294967295|v>>>10),v=m+(R^_&(w^R))+E[4]+4118548399&4294967295,m=_+(v<<7&4294967295|v>>>25),v=R+(w^m&(_^w))+E[5]+1200080426&4294967295,R=m+(v<<12&4294967295|v>>>20),v=w+(_^R&(m^_))+E[6]+2821735955&4294967295,w=R+(v<<17&4294967295|v>>>15),v=_+(m^w&(R^m))+E[7]+4249261313&4294967295,_=w+(v<<22&4294967295|v>>>10),v=m+(R^_&(w^R))+E[8]+1770035416&4294967295,m=_+(v<<7&4294967295|v>>>25),v=R+(w^m&(_^w))+E[9]+2336552879&4294967295,R=m+(v<<12&4294967295|v>>>20),v=w+(_^R&(m^_))+E[10]+4294925233&4294967295,w=R+(v<<17&4294967295|v>>>15),v=_+(m^w&(R^m))+E[11]+2304563134&4294967295,_=w+(v<<22&4294967295|v>>>10),v=m+(R^_&(w^R))+E[12]+1804603682&4294967295,m=_+(v<<7&4294967295|v>>>25),v=R+(w^m&(_^w))+E[13]+4254626195&4294967295,R=m+(v<<12&4294967295|v>>>20),v=w+(_^R&(m^_))+E[14]+2792965006&4294967295,w=R+(v<<17&4294967295|v>>>15),v=_+(m^w&(R^m))+E[15]+1236535329&4294967295,_=w+(v<<22&4294967295|v>>>10),v=m+(w^R&(_^w))+E[1]+4129170786&4294967295,m=_+(v<<5&4294967295|v>>>27),v=R+(_^w&(m^_))+E[6]+3225465664&4294967295,R=m+(v<<9&4294967295|v>>>23),v=w+(m^_&(R^m))+E[11]+643717713&4294967295,w=R+(v<<14&4294967295|v>>>18),v=_+(R^m&(w^R))+E[0]+3921069994&4294967295,_=w+(v<<20&4294967295|v>>>12),v=m+(w^R&(_^w))+E[5]+3593408605&4294967295,m=_+(v<<5&4294967295|v>>>27),v=R+(_^w&(m^_))+E[10]+38016083&4294967295,R=m+(v<<9&4294967295|v>>>23),v=w+(m^_&(R^m))+E[15]+3634488961&4294967295,w=R+(v<<14&4294967295|v>>>18),v=_+(R^m&(w^R))+E[4]+3889429448&4294967295,_=w+(v<<20&4294967295|v>>>12),v=m+(w^R&(_^w))+E[9]+568446438&4294967295,m=_+(v<<5&4294967295|v>>>27),v=R+(_^w&(m^_))+E[14]+3275163606&4294967295,R=m+(v<<9&4294967295|v>>>23),v=w+(m^_&(R^m))+E[3]+4107603335&4294967295,w=R+(v<<14&4294967295|v>>>18),v=_+(R^m&(w^R))+E[8]+1163531501&4294967295,_=w+(v<<20&4294967295|v>>>12),v=m+(w^R&(_^w))+E[13]+2850285829&4294967295,m=_+(v<<5&4294967295|v>>>27),v=R+(_^w&(m^_))+E[2]+4243563512&4294967295,R=m+(v<<9&4294967295|v>>>23),v=w+(m^_&(R^m))+E[7]+1735328473&4294967295,w=R+(v<<14&4294967295|v>>>18),v=_+(R^m&(w^R))+E[12]+2368359562&4294967295,_=w+(v<<20&4294967295|v>>>12),v=m+(_^w^R)+E[5]+4294588738&4294967295,m=_+(v<<4&4294967295|v>>>28),v=R+(m^_^w)+E[8]+2272392833&4294967295,R=m+(v<<11&4294967295|v>>>21),v=w+(R^m^_)+E[11]+1839030562&4294967295,w=R+(v<<16&4294967295|v>>>16),v=_+(w^R^m)+E[14]+4259657740&4294967295,_=w+(v<<23&4294967295|v>>>9),v=m+(_^w^R)+E[1]+2763975236&4294967295,m=_+(v<<4&4294967295|v>>>28),v=R+(m^_^w)+E[4]+1272893353&4294967295,R=m+(v<<11&4294967295|v>>>21),v=w+(R^m^_)+E[7]+4139469664&4294967295,w=R+(v<<16&4294967295|v>>>16),v=_+(w^R^m)+E[10]+3200236656&4294967295,_=w+(v<<23&4294967295|v>>>9),v=m+(_^w^R)+E[13]+681279174&4294967295,m=_+(v<<4&4294967295|v>>>28),v=R+(m^_^w)+E[0]+3936430074&4294967295,R=m+(v<<11&4294967295|v>>>21),v=w+(R^m^_)+E[3]+3572445317&4294967295,w=R+(v<<16&4294967295|v>>>16),v=_+(w^R^m)+E[6]+76029189&4294967295,_=w+(v<<23&4294967295|v>>>9),v=m+(_^w^R)+E[9]+3654602809&4294967295,m=_+(v<<4&4294967295|v>>>28),v=R+(m^_^w)+E[12]+3873151461&4294967295,R=m+(v<<11&4294967295|v>>>21),v=w+(R^m^_)+E[15]+530742520&4294967295,w=R+(v<<16&4294967295|v>>>16),v=_+(w^R^m)+E[2]+3299628645&4294967295,_=w+(v<<23&4294967295|v>>>9),v=m+(w^(_|~R))+E[0]+4096336452&4294967295,m=_+(v<<6&4294967295|v>>>26),v=R+(_^(m|~w))+E[7]+1126891415&4294967295,R=m+(v<<10&4294967295|v>>>22),v=w+(m^(R|~_))+E[14]+2878612391&4294967295,w=R+(v<<15&4294967295|v>>>17),v=_+(R^(w|~m))+E[5]+4237533241&4294967295,_=w+(v<<21&4294967295|v>>>11),v=m+(w^(_|~R))+E[12]+1700485571&4294967295,m=_+(v<<6&4294967295|v>>>26),v=R+(_^(m|~w))+E[3]+2399980690&4294967295,R=m+(v<<10&4294967295|v>>>22),v=w+(m^(R|~_))+E[10]+4293915773&4294967295,w=R+(v<<15&4294967295|v>>>17),v=_+(R^(w|~m))+E[1]+2240044497&4294967295,_=w+(v<<21&4294967295|v>>>11),v=m+(w^(_|~R))+E[8]+1873313359&4294967295,m=_+(v<<6&4294967295|v>>>26),v=R+(_^(m|~w))+E[15]+4264355552&4294967295,R=m+(v<<10&4294967295|v>>>22),v=w+(m^(R|~_))+E[6]+2734768916&4294967295,w=R+(v<<15&4294967295|v>>>17),v=_+(R^(w|~m))+E[13]+1309151649&4294967295,_=w+(v<<21&4294967295|v>>>11),v=m+(w^(_|~R))+E[4]+4149444226&4294967295,m=_+(v<<6&4294967295|v>>>26),v=R+(_^(m|~w))+E[11]+3174756917&4294967295,R=m+(v<<10&4294967295|v>>>22),v=w+(m^(R|~_))+E[2]+718787259&4294967295,w=R+(v<<15&4294967295|v>>>17),v=_+(R^(w|~m))+E[9]+3951481745&4294967295,T.g[0]=T.g[0]+m&4294967295,T.g[1]=T.g[1]+(w+(v<<21&4294967295|v>>>11))&4294967295,T.g[2]=T.g[2]+w&4294967295,T.g[3]=T.g[3]+R&4294967295}r.prototype.v=function(T,m){m===void 0&&(m=T.length);const _=m-this.blockSize,E=this.C;let w=this.h,R=0;for(;R<m;){if(w==0)for(;R<=_;)s(this,T,R),R+=this.blockSize;if(typeof T=="string"){for(;R<m;)if(E[w++]=T.charCodeAt(R++),w==this.blockSize){s(this,E),w=0;break}}else for(;R<m;)if(E[w++]=T[R++],w==this.blockSize){s(this,E),w=0;break}}this.h=w,this.o+=m},r.prototype.A=function(){var T=Array((this.h<56?this.blockSize:this.blockSize*2)-this.h);T[0]=128;for(var m=1;m<T.length-8;++m)T[m]=0;m=this.o*8;for(var _=T.length-8;_<T.length;++_)T[_]=m&255,m/=256;for(this.v(T),T=Array(16),m=0,_=0;_<4;++_)for(let E=0;E<32;E+=8)T[m++]=this.g[_]>>>E&255;return T};function o(T,m){var _=c;return Object.prototype.hasOwnProperty.call(_,T)?_[T]:_[T]=m(T)}function a(T,m){this.h=m;const _=[];let E=!0;for(let w=T.length-1;w>=0;w--){const R=T[w]|0;E&&R==m||(_[w]=R,E=!1)}this.g=_}var c={};function u(T){return-128<=T&&T<128?o(T,function(m){return new a([m|0],m<0?-1:0)}):new a([T|0],T<0?-1:0)}function d(T){if(isNaN(T)||!isFinite(T))return y;if(T<0)return A(d(-T));const m=[];let _=1;for(let E=0;T>=_;E++)m[E]=T/_|0,_*=4294967296;return new a(m,0)}function g(T,m){if(T.length==0)throw Error("number format error: empty string");if(m=m||10,m<2||36<m)throw Error("radix out of range: "+m);if(T.charAt(0)=="-")return A(g(T.substring(1),m));if(T.indexOf("-")>=0)throw Error('number format error: interior "-" character');const _=d(Math.pow(m,8));let E=y;for(let R=0;R<T.length;R+=8){var w=Math.min(8,T.length-R);const v=parseInt(T.substring(R,R+w),m);w<8?(w=d(Math.pow(m,w)),E=E.j(w).add(d(v))):(E=E.j(_),E=E.add(d(v)))}return E}var y=u(0),I=u(1),P=u(16777216);n=a.prototype,n.m=function(){if(L(this))return-A(this).m();let T=0,m=1;for(let _=0;_<this.g.length;_++){const E=this.i(_);T+=(E>=0?E:4294967296+E)*m,m*=4294967296}return T},n.toString=function(T){if(T=T||10,T<2||36<T)throw Error("radix out of range: "+T);if(D(this))return"0";if(L(this))return"-"+A(this).toString(T);const m=d(Math.pow(T,6));var _=this;let E="";for(;;){const w=we(_,m).g;_=F(_,w.j(m));let R=((_.g.length>0?_.g[0]:_.h)>>>0).toString(T);if(_=w,D(_))return R+E;for(;R.length<6;)R="0"+R;E=R+E}},n.i=function(T){return T<0?0:T<this.g.length?this.g[T]:this.h};function D(T){if(T.h!=0)return!1;for(let m=0;m<T.g.length;m++)if(T.g[m]!=0)return!1;return!0}function L(T){return T.h==-1}n.l=function(T){return T=F(this,T),L(T)?-1:D(T)?0:1};function A(T){const m=T.g.length,_=[];for(let E=0;E<m;E++)_[E]=~T.g[E];return new a(_,~T.h).add(I)}n.abs=function(){return L(this)?A(this):this},n.add=function(T){const m=Math.max(this.g.length,T.g.length),_=[];let E=0;for(let w=0;w<=m;w++){let R=E+(this.i(w)&65535)+(T.i(w)&65535),v=(R>>>16)+(this.i(w)>>>16)+(T.i(w)>>>16);E=v>>>16,R&=65535,v&=65535,_[w]=v<<16|R}return new a(_,_[_.length-1]&-2147483648?-1:0)};function F(T,m){return T.add(A(m))}n.j=function(T){if(D(this)||D(T))return y;if(L(this))return L(T)?A(this).j(A(T)):A(A(this).j(T));if(L(T))return A(this.j(A(T)));if(this.l(P)<0&&T.l(P)<0)return d(this.m()*T.m());const m=this.g.length+T.g.length,_=[];for(var E=0;E<2*m;E++)_[E]=0;for(E=0;E<this.g.length;E++)for(let w=0;w<T.g.length;w++){const R=this.i(E)>>>16,v=this.i(E)&65535,Ae=T.i(w)>>>16,De=T.i(w)&65535;_[2*E+2*w]+=v*De,j(_,2*E+2*w),_[2*E+2*w+1]+=R*De,j(_,2*E+2*w+1),_[2*E+2*w+1]+=v*Ae,j(_,2*E+2*w+1),_[2*E+2*w+2]+=R*Ae,j(_,2*E+2*w+2)}for(T=0;T<m;T++)_[T]=_[2*T+1]<<16|_[2*T];for(T=m;T<2*m;T++)_[T]=0;return new a(_,0)};function j(T,m){for(;(T[m]&65535)!=T[m];)T[m+1]+=T[m]>>>16,T[m]&=65535,m++}function Y(T,m){this.g=T,this.h=m}function we(T,m){if(D(m))throw Error("division by zero");if(D(T))return new Y(y,y);if(L(T))return m=we(A(T),m),new Y(A(m.g),A(m.h));if(L(m))return m=we(T,A(m)),new Y(A(m.g),m.h);if(T.g.length>30){if(L(T)||L(m))throw Error("slowDivide_ only works with positive integers.");for(var _=I,E=m;E.l(T)<=0;)_=xe(_),E=xe(E);var w=ge(_,1),R=ge(E,1);for(E=ge(E,2),_=ge(_,2);!D(E);){var v=R.add(E);v.l(T)<=0&&(w=w.add(_),R=v),E=ge(E,1),_=ge(_,1)}return m=F(T,w.j(m)),new Y(w,m)}for(w=y;T.l(m)>=0;){for(_=Math.max(1,Math.floor(T.m()/m.m())),E=Math.ceil(Math.log(_)/Math.LN2),E=E<=48?1:Math.pow(2,E-48),R=d(_),v=R.j(m);L(v)||v.l(T)>0;)_-=E,R=d(_),v=R.j(m);D(R)&&(R=I),w=w.add(R),T=F(T,v)}return new Y(w,T)}n.B=function(T){return we(this,T).h},n.and=function(T){const m=Math.max(this.g.length,T.g.length),_=[];for(let E=0;E<m;E++)_[E]=this.i(E)&T.i(E);return new a(_,this.h&T.h)},n.or=function(T){const m=Math.max(this.g.length,T.g.length),_=[];for(let E=0;E<m;E++)_[E]=this.i(E)|T.i(E);return new a(_,this.h|T.h)},n.xor=function(T){const m=Math.max(this.g.length,T.g.length),_=[];for(let E=0;E<m;E++)_[E]=this.i(E)^T.i(E);return new a(_,this.h^T.h)};function xe(T){const m=T.g.length+1,_=[];for(let E=0;E<m;E++)_[E]=T.i(E)<<1|T.i(E-1)>>>31;return new a(_,T.h)}function ge(T,m){const _=m>>5;m%=32;const E=T.g.length-_,w=[];for(let R=0;R<E;R++)w[R]=m>0?T.i(R+_)>>>m|T.i(R+_+1)<<32-m:T.i(R+_);return new a(w,T.h)}r.prototype.digest=r.prototype.A,r.prototype.reset=r.prototype.u,r.prototype.update=r.prototype.v,mh=r,a.prototype.add=a.prototype.add,a.prototype.multiply=a.prototype.j,a.prototype.modulo=a.prototype.B,a.prototype.compare=a.prototype.l,a.prototype.toNumber=a.prototype.m,a.prototype.toString=a.prototype.toString,a.prototype.getBits=a.prototype.i,a.fromNumber=d,a.fromString=g,ln=a}).apply(typeof bc<"u"?bc:typeof self<"u"?self:typeof window<"u"?window:{});var js=typeof globalThis<"u"?globalThis:typeof window<"u"?window:typeof global<"u"?global:typeof self<"u"?self:{};/** @license
Copyright The Closure Library Authors.
SPDX-License-Identifier: Apache-2.0
*/var _h,Hr,yh,Js,Ho,vh,wh,bh;(function(){var n,e=Object.defineProperty;function t(i){i=[typeof globalThis=="object"&&globalThis,i,typeof window=="object"&&window,typeof self=="object"&&self,typeof js=="object"&&js];for(var l=0;l<i.length;++l){var h=i[l];if(h&&h.Math==Math)return h}throw Error("Cannot find global object")}var r=t(this);function s(i,l){if(l)e:{var h=r;i=i.split(".");for(var p=0;p<i.length-1;p++){var S=i[p];if(!(S in h))break e;h=h[S]}i=i[i.length-1],p=h[i],l=l(p),l!=p&&l!=null&&e(h,i,{configurable:!0,writable:!0,value:l})}}s("Symbol.dispose",function(i){return i||Symbol("Symbol.dispose")}),s("Array.prototype.values",function(i){return i||function(){return this[Symbol.iterator]()}}),s("Object.entries",function(i){return i||function(l){var h=[],p;for(p in l)Object.prototype.hasOwnProperty.call(l,p)&&h.push([p,l[p]]);return h}});/** @license

 Copyright The Closure Library Authors.
 SPDX-License-Identifier: Apache-2.0
*/var o=o||{},a=this||self;function c(i){var l=typeof i;return l=="object"&&i!=null||l=="function"}function u(i,l,h){return i.call.apply(i.bind,arguments)}function d(i,l,h){return d=u,d.apply(null,arguments)}function g(i,l){var h=Array.prototype.slice.call(arguments,1);return function(){var p=h.slice();return p.push.apply(p,arguments),i.apply(this,p)}}function y(i,l){function h(){}h.prototype=l.prototype,i.Z=l.prototype,i.prototype=new h,i.prototype.constructor=i,i.Ob=function(p,S,k){for(var U=Array(arguments.length-2),le=2;le<arguments.length;le++)U[le-2]=arguments[le];return l.prototype[S].apply(p,U)}}var I=typeof AsyncContext<"u"&&typeof AsyncContext.Snapshot=="function"?i=>i&&AsyncContext.Snapshot.wrap(i):i=>i;function P(i){const l=i.length;if(l>0){const h=Array(l);for(let p=0;p<l;p++)h[p]=i[p];return h}return[]}function D(i,l){for(let p=1;p<arguments.length;p++){const S=arguments[p];var h=typeof S;if(h=h!="object"?h:S?Array.isArray(S)?"array":h:"null",h=="array"||h=="object"&&typeof S.length=="number"){h=i.length||0;const k=S.length||0;i.length=h+k;for(let U=0;U<k;U++)i[h+U]=S[U]}else i.push(S)}}class L{constructor(l,h){this.i=l,this.j=h,this.h=0,this.g=null}get(){let l;return this.h>0?(this.h--,l=this.g,this.g=l.next,l.next=null):l=this.i(),l}}function A(i){a.setTimeout(()=>{throw i},0)}function F(){var i=T;let l=null;return i.g&&(l=i.g,i.g=i.g.next,i.g||(i.h=null),l.next=null),l}class j{constructor(){this.h=this.g=null}add(l,h){const p=Y.get();p.set(l,h),this.h?this.h.next=p:this.g=p,this.h=p}}var Y=new L(()=>new we,i=>i.reset());class we{constructor(){this.next=this.g=this.h=null}set(l,h){this.h=l,this.g=h,this.next=null}reset(){this.next=this.g=this.h=null}}let xe,ge=!1,T=new j,m=()=>{const i=Promise.resolve(void 0);xe=()=>{i.then(_)}};function _(){for(var i;i=F();){try{i.h.call(i.g)}catch(h){A(h)}var l=Y;l.j(i),l.h<100&&(l.h++,i.next=l.g,l.g=i)}ge=!1}function E(){this.u=this.u,this.C=this.C}E.prototype.u=!1,E.prototype.dispose=function(){this.u||(this.u=!0,this.N())},E.prototype[Symbol.dispose]=function(){this.dispose()},E.prototype.N=function(){if(this.C)for(;this.C.length;)this.C.shift()()};function w(i,l){this.type=i,this.g=this.target=l,this.defaultPrevented=!1}w.prototype.h=function(){this.defaultPrevented=!0};var R=(function(){if(!a.addEventListener||!Object.defineProperty)return!1;var i=!1,l=Object.defineProperty({},"passive",{get:function(){i=!0}});try{const h=()=>{};a.addEventListener("test",h,l),a.removeEventListener("test",h,l)}catch{}return i})();function v(i){return/^[\s\xa0]*$/.test(i)}function Ae(i,l){w.call(this,i?i.type:""),this.relatedTarget=this.g=this.target=null,this.button=this.screenY=this.screenX=this.clientY=this.clientX=0,this.key="",this.metaKey=this.shiftKey=this.altKey=this.ctrlKey=!1,this.state=null,this.pointerId=0,this.pointerType="",this.i=null,i&&this.init(i,l)}y(Ae,w),Ae.prototype.init=function(i,l){const h=this.type=i.type,p=i.changedTouches&&i.changedTouches.length?i.changedTouches[0]:null;this.target=i.target||i.srcElement,this.g=l,l=i.relatedTarget,l||(h=="mouseover"?l=i.fromElement:h=="mouseout"&&(l=i.toElement)),this.relatedTarget=l,p?(this.clientX=p.clientX!==void 0?p.clientX:p.pageX,this.clientY=p.clientY!==void 0?p.clientY:p.pageY,this.screenX=p.screenX||0,this.screenY=p.screenY||0):(this.clientX=i.clientX!==void 0?i.clientX:i.pageX,this.clientY=i.clientY!==void 0?i.clientY:i.pageY,this.screenX=i.screenX||0,this.screenY=i.screenY||0),this.button=i.button,this.key=i.key||"",this.ctrlKey=i.ctrlKey,this.altKey=i.altKey,this.shiftKey=i.shiftKey,this.metaKey=i.metaKey,this.pointerId=i.pointerId||0,this.pointerType=i.pointerType,this.state=i.state,this.i=i,i.defaultPrevented&&Ae.Z.h.call(this)},Ae.prototype.h=function(){Ae.Z.h.call(this);const i=this.i;i.preventDefault?i.preventDefault():i.returnValue=!1};var De="closure_listenable_"+(Math.random()*1e6|0),Rt=0;function Ir(i,l,h,p,S){this.listener=i,this.proxy=null,this.src=l,this.type=h,this.capture=!!p,this.ha=S,this.key=++Rt,this.da=this.fa=!1}function Ht(i){i.da=!0,i.listener=null,i.proxy=null,i.src=null,i.ha=null}function Gt(i,l,h){for(const p in i)l.call(h,i[p],p,i)}function x(i,l){for(const h in i)l.call(void 0,i[h],h,i)}function C(i){const l={};for(const h in i)l[h]=i[h];return l}const X="constructor hasOwnProperty isPrototypeOf propertyIsEnumerable toLocaleString toString valueOf".split(" ");function te(i,l){let h,p;for(let S=1;S<arguments.length;S++){p=arguments[S];for(h in p)i[h]=p[h];for(let k=0;k<X.length;k++)h=X[k],Object.prototype.hasOwnProperty.call(p,h)&&(i[h]=p[h])}}function se(i){this.src=i,this.g={},this.h=0}se.prototype.add=function(i,l,h,p,S){const k=i.toString();i=this.g[k],i||(i=this.g[k]=[],this.h++);const U=b(i,l,p,S);return U>-1?(l=i[U],h||(l.fa=!1)):(l=new Ir(l,this.src,k,!!p,S),l.fa=h,i.push(l)),l};function O(i,l){const h=l.type;if(h in i.g){var p=i.g[h],S=Array.prototype.indexOf.call(p,l,void 0),k;(k=S>=0)&&Array.prototype.splice.call(p,S,1),k&&(Ht(l),i.g[h].length==0&&(delete i.g[h],i.h--))}}function b(i,l,h,p){for(let S=0;S<i.length;++S){const k=i[S];if(!k.da&&k.listener==l&&k.capture==!!h&&k.ha==p)return S}return-1}var H="closure_lm_"+(Math.random()*1e6|0),Z={};function N(i,l,h,p,S){if(Array.isArray(l)){for(let k=0;k<l.length;k++)N(i,l[k],h,p,S);return null}return h=ut(h),i&&i[De]?i.J(l,h,c(p)?!!p.capture:!1,S):K(i,l,h,!1,p,S)}function K(i,l,h,p,S,k){if(!l)throw Error("Invalid event type");const U=c(S)?!!S.capture:!!S;let le=Ze(i);if(le||(i[H]=le=new se(i)),h=le.add(l,h,p,U,k),h.proxy)return h;if(p=G(),h.proxy=p,p.src=i,p.listener=h,i.addEventListener)R||(S=U),S===void 0&&(S=!1),i.addEventListener(l.toString(),p,S);else if(i.attachEvent)i.attachEvent(ce(l.toString()),p);else if(i.addListener&&i.removeListener)i.addListener(p);else throw Error("addEventListener and attachEvent are unavailable.");return h}function G(){function i(h){return l.call(i.src,i.listener,h)}const l=Ke;return i}function Te(i,l,h,p,S){if(Array.isArray(l))for(var k=0;k<l.length;k++)Te(i,l[k],h,p,S);else p=c(p)?!!p.capture:!!p,h=ut(h),i&&i[De]?(i=i.i,k=String(l).toString(),k in i.g&&(l=i.g[k],h=b(l,h,p,S),h>-1&&(Ht(l[h]),Array.prototype.splice.call(l,h,1),l.length==0&&(delete i.g[k],i.h--)))):i&&(i=Ze(i))&&(l=i.g[l.toString()],i=-1,l&&(i=b(l,h,p,S)),(h=i>-1?l[i]:null)&&Ve(h))}function Ve(i){if(typeof i!="number"&&i&&!i.da){var l=i.src;if(l&&l[De])O(l.i,i);else{var h=i.type,p=i.proxy;l.removeEventListener?l.removeEventListener(h,p,i.capture):l.detachEvent?l.detachEvent(ce(h),p):l.addListener&&l.removeListener&&l.removeListener(p),(h=Ze(l))?(O(h,i),h.h==0&&(h.src=null,l[H]=null)):Ht(i)}}}function ce(i){return i in Z?Z[i]:Z[i]="on"+i}function Ke(i,l){if(i.da)i=!0;else{l=new Ae(l,this);const h=i.listener,p=i.ha||i.src;i.fa&&Ve(i),i=h.call(p,l)}return i}function Ze(i){return i=i[H],i instanceof se?i:null}var et="__closure_events_fn_"+(Math.random()*1e9>>>0);function ut(i){return typeof i=="function"?i:(i[et]||(i[et]=function(l){return i.handleEvent(l)}),i[et])}function Re(){E.call(this),this.i=new se(this),this.M=this,this.G=null}y(Re,E),Re.prototype[De]=!0,Re.prototype.removeEventListener=function(i,l,h,p){Te(this,i,l,h,p)};function be(i,l){var h,p=i.G;if(p)for(h=[];p;p=p.G)h.push(p);if(i=i.M,p=l.type||l,typeof l=="string")l=new w(l,i);else if(l instanceof w)l.target=l.target||i;else{var S=l;l=new w(p,i),te(l,S)}S=!0;let k,U;if(h)for(U=h.length-1;U>=0;U--)k=l.g=h[U],S=$n(k,p,!0,l)&&S;if(k=l.g=i,S=$n(k,p,!0,l)&&S,S=$n(k,p,!1,l)&&S,h)for(U=0;U<h.length;U++)k=l.g=h[U],S=$n(k,p,!1,l)&&S}Re.prototype.N=function(){if(Re.Z.N.call(this),this.i){var i=this.i;for(const l in i.g){const h=i.g[l];for(let p=0;p<h.length;p++)Ht(h[p]);delete i.g[l],i.h--}}this.G=null},Re.prototype.J=function(i,l,h,p){return this.i.add(String(i),l,!1,h,p)},Re.prototype.K=function(i,l,h,p){return this.i.add(String(i),l,!0,h,p)};function $n(i,l,h,p){if(l=i.i.g[String(l)],!l)return!0;l=l.concat();let S=!0;for(let k=0;k<l.length;++k){const U=l[k];if(U&&!U.da&&U.capture==h){const le=U.listener,Fe=U.ha||U.src;U.fa&&O(i.i,U),S=le.call(Fe,p)!==!1&&S}}return S&&!p.defaultPrevented}function oo(i,l){if(typeof i!="function")if(i&&typeof i.handleEvent=="function")i=d(i.handleEvent,i);else throw Error("Invalid listener argument");return Number(l)>2147483647?-1:a.setTimeout(i,l||0)}function Is(i){i.g=oo(()=>{i.g=null,i.i&&(i.i=!1,Is(i))},i.l);const l=i.h;i.h=null,i.m.apply(null,l)}class Cs extends E{constructor(l,h){super(),this.m=l,this.l=h,this.h=null,this.i=!1,this.g=null}j(l){this.h=arguments,this.g?this.i=!0:Is(this)}N(){super.N(),this.g&&(a.clearTimeout(this.g),this.g=null,this.i=!1,this.h=null)}}function yn(i){E.call(this),this.h=i,this.g={}}y(yn,E);var Cr=[];function As(i){Gt(i.g,function(l,h){this.g.hasOwnProperty(h)&&Ve(l)},i),i.g={}}yn.prototype.N=function(){yn.Z.N.call(this),As(this)},yn.prototype.handleEvent=function(){throw Error("EventHandler.handleEvent not implemented")};var Ar=a.JSON.stringify,Rs=a.JSON.parse,Ss=class{stringify(i){return a.JSON.stringify(i,void 0)}parse(i){return a.JSON.parse(i,void 0)}};function qn(){}function xs(){}var vn={OPEN:"a",hb:"b",ERROR:"c",tb:"d"};function ao(){w.call(this,"d")}y(ao,w);function lo(){w.call(this,"c")}y(lo,w);var wn={},vl=null;function ks(){return vl=vl||new Re}wn.Ia="serverreachability";function wl(i){w.call(this,wn.Ia,i)}y(wl,w);function Rr(i){const l=ks();be(l,new wl(l))}wn.STAT_EVENT="statevent";function bl(i,l){w.call(this,wn.STAT_EVENT,i),this.stat=l}y(bl,w);function tt(i){const l=ks();be(l,new bl(l,i))}wn.Ja="timingevent";function El(i,l){w.call(this,wn.Ja,i),this.size=l}y(El,w);function Sr(i,l){if(typeof i!="function")throw Error("Fn must not be null and must be a function");return a.setTimeout(function(){i()},l)}function xr(){this.g=!0}xr.prototype.ua=function(){this.g=!1};function Ff(i,l,h,p,S,k){i.info(function(){if(i.g)if(k){var U="",le=k.split("&");for(let ve=0;ve<le.length;ve++){var Fe=le[ve].split("=");if(Fe.length>1){const $e=Fe[0];Fe=Fe[1];const yt=$e.split("_");U=yt.length>=2&&yt[1]=="type"?U+($e+"="+Fe+"&"):U+($e+"=redacted&")}}}else U=null;else U=k;return"XMLHTTP REQ ("+p+") [attempt "+S+"]: "+l+`
`+h+`
`+U})}function Uf(i,l,h,p,S,k,U){i.info(function(){return"XMLHTTP RESP ("+p+") [ attempt "+S+"]: "+l+`
`+h+`
`+k+" "+U})}function zn(i,l,h,p){i.info(function(){return"XMLHTTP TEXT ("+l+"): "+jf(i,h)+(p?" "+p:"")})}function Bf(i,l){i.info(function(){return"TIMEOUT: "+l})}xr.prototype.info=function(){};function jf(i,l){if(!i.g)return l;if(!l)return null;try{const k=JSON.parse(l);if(k){for(i=0;i<k.length;i++)if(Array.isArray(k[i])){var h=k[i];if(!(h.length<2)){var p=h[1];if(Array.isArray(p)&&!(p.length<1)){var S=p[0];if(S!="noop"&&S!="stop"&&S!="close")for(let U=1;U<p.length;U++)p[U]=""}}}}return Ar(k)}catch{return l}}var Ps={NO_ERROR:0,cb:1,qb:2,pb:3,kb:4,ob:5,rb:6,Ga:7,TIMEOUT:8,ub:9},Tl={ib:"complete",Fb:"success",ERROR:"error",Ga:"abort",xb:"ready",yb:"readystatechange",TIMEOUT:"timeout",sb:"incrementaldata",wb:"progress",lb:"downloadprogress",Nb:"uploadprogress"},Il;function co(){}y(co,qn),co.prototype.g=function(){return new XMLHttpRequest},Il=new co;function kr(i){return encodeURIComponent(String(i))}function $f(i){var l=1;i=i.split(":");const h=[];for(;l>0&&i.length;)h.push(i.shift()),l--;return i.length&&h.push(i.join(":")),h}function Wt(i,l,h,p){this.j=i,this.i=l,this.l=h,this.S=p||1,this.V=new yn(this),this.H=45e3,this.J=null,this.o=!1,this.u=this.B=this.A=this.M=this.F=this.T=this.D=null,this.G=[],this.g=null,this.C=0,this.m=this.v=null,this.X=-1,this.K=!1,this.P=0,this.O=null,this.W=this.L=this.U=this.R=!1,this.h=new Cl}function Cl(){this.i=null,this.g="",this.h=!1}var Al={},uo={};function ho(i,l,h){i.M=1,i.A=Ms(_t(l)),i.u=h,i.R=!0,Rl(i,null)}function Rl(i,l){i.F=Date.now(),Vs(i),i.B=_t(i.A);var h=i.B,p=i.S;Array.isArray(p)||(p=[String(p)]),Bl(h.i,"t",p),i.C=0,h=i.j.L,i.h=new Cl,i.g=sc(i.j,h?l:null,!i.u),i.P>0&&(i.O=new Cs(d(i.Y,i,i.g),i.P)),l=i.V,h=i.g,p=i.ba;var S="readystatechange";Array.isArray(S)||(S&&(Cr[0]=S.toString()),S=Cr);for(let k=0;k<S.length;k++){const U=N(h,S[k],p||l.handleEvent,!1,l.h||l);if(!U)break;l.g[U.key]=U}l=i.J?C(i.J):{},i.u?(i.v||(i.v="POST"),l["Content-Type"]="application/x-www-form-urlencoded",i.g.ea(i.B,i.v,i.u,l)):(i.v="GET",i.g.ea(i.B,i.v,null,l)),Rr(),Ff(i.i,i.v,i.B,i.l,i.S,i.u)}Wt.prototype.ba=function(i){i=i.target;const l=this.O;l&&Yt(i)==3?l.j():this.Y(i)},Wt.prototype.Y=function(i){try{if(i==this.g)e:{const le=Yt(this.g),Fe=this.g.ya(),ve=this.g.ca();if(!(le<3)&&(le!=3||this.g&&(this.h.h||this.g.la()||Wl(this.g)))){this.K||le!=4||Fe==7||(Fe==8||ve<=0?Rr(3):Rr(2)),fo(this);var l=this.g.ca();this.X=l;var h=qf(this);if(this.o=l==200,Uf(this.i,this.v,this.B,this.l,this.S,le,l),this.o){if(this.U&&!this.L){t:{if(this.g){var p,S=this.g;if((p=S.g?S.g.getResponseHeader("X-HTTP-Initial-Response"):null)&&!v(p)){var k=p;break t}}k=null}if(i=k)zn(this.i,this.l,i,"Initial handshake response via X-HTTP-Initial-Response"),this.L=!0,po(this,i);else{this.o=!1,this.m=3,tt(12),bn(this),Pr(this);break e}}if(this.R){i=!0;let $e;for(;!this.K&&this.C<h.length;)if($e=zf(this,h),$e==uo){le==4&&(this.m=4,tt(14),i=!1),zn(this.i,this.l,null,"[Incomplete Response]");break}else if($e==Al){this.m=4,tt(15),zn(this.i,this.l,h,"[Invalid Chunk]"),i=!1;break}else zn(this.i,this.l,$e,null),po(this,$e);if(Sl(this)&&this.C!=0&&(this.h.g=this.h.g.slice(this.C),this.C=0),le!=4||h.length!=0||this.h.h||(this.m=1,tt(16),i=!1),this.o=this.o&&i,!i)zn(this.i,this.l,h,"[Invalid Chunked Response]"),bn(this),Pr(this);else if(h.length>0&&!this.W){this.W=!0;var U=this.j;U.g==this&&U.aa&&!U.P&&(U.j.info("Great, no buffering proxy detected. Bytes received: "+h.length),Eo(U),U.P=!0,tt(11))}}else zn(this.i,this.l,h,null),po(this,h);le==4&&bn(this),this.o&&!this.K&&(le==4?ec(this.j,this):(this.o=!1,Vs(this)))}else sp(this.g),l==400&&h.indexOf("Unknown SID")>0?(this.m=3,tt(12)):(this.m=0,tt(13)),bn(this),Pr(this)}}}catch{}finally{}};function qf(i){if(!Sl(i))return i.g.la();const l=Wl(i.g);if(l==="")return"";let h="";const p=l.length,S=Yt(i.g)==4;if(!i.h.i){if(typeof TextDecoder>"u")return bn(i),Pr(i),"";i.h.i=new a.TextDecoder}for(let k=0;k<p;k++)i.h.h=!0,h+=i.h.i.decode(l[k],{stream:!(S&&k==p-1)});return l.length=0,i.h.g+=h,i.C=0,i.h.g}function Sl(i){return i.g?i.v=="GET"&&i.M!=2&&i.j.Aa:!1}function zf(i,l){var h=i.C,p=l.indexOf(`
`,h);return p==-1?uo:(h=Number(l.substring(h,p)),isNaN(h)?Al:(p+=1,p+h>l.length?uo:(l=l.slice(p,p+h),i.C=p+h,l)))}Wt.prototype.cancel=function(){this.K=!0,bn(this)};function Vs(i){i.T=Date.now()+i.H,xl(i,i.H)}function xl(i,l){if(i.D!=null)throw Error("WatchDog timer not null");i.D=Sr(d(i.aa,i),l)}function fo(i){i.D&&(a.clearTimeout(i.D),i.D=null)}Wt.prototype.aa=function(){this.D=null;const i=Date.now();i-this.T>=0?(Bf(this.i,this.B),this.M!=2&&(Rr(),tt(17)),bn(this),this.m=2,Pr(this)):xl(this,this.T-i)};function Pr(i){i.j.I==0||i.K||ec(i.j,i)}function bn(i){fo(i);var l=i.O;l&&typeof l.dispose=="function"&&l.dispose(),i.O=null,As(i.V),i.g&&(l=i.g,i.g=null,l.abort(),l.dispose())}function po(i,l){try{var h=i.j;if(h.I!=0&&(h.g==i||go(h.h,i))){if(!i.L&&go(h.h,i)&&h.I==3){try{var p=h.Ba.g.parse(l)}catch{p=null}if(Array.isArray(p)&&p.length==3){var S=p;if(S[0]==0){e:if(!h.v){if(h.g)if(h.g.F+3e3<i.F)Fs(h),Ls(h);else break e;bo(h),tt(18)}}else h.xa=S[1],0<h.xa-h.K&&S[2]<37500&&h.F&&h.A==0&&!h.C&&(h.C=Sr(d(h.Va,h),6e3));Vl(h.h)<=1&&h.ta&&(h.ta=void 0)}else Tn(h,11)}else if((i.L||h.g==i)&&Fs(h),!v(l))for(S=h.Ba.g.parse(l),l=0;l<S.length;l++){let ve=S[l];const $e=ve[0];if(!($e<=h.K))if(h.K=$e,ve=ve[1],h.I==2)if(ve[0]=="c"){h.M=ve[1],h.ba=ve[2];const yt=ve[3];yt!=null&&(h.ka=yt,h.j.info("VER="+h.ka));const In=ve[4];In!=null&&(h.za=In,h.j.info("SVER="+h.za));const Jt=ve[5];Jt!=null&&typeof Jt=="number"&&Jt>0&&(p=1.5*Jt,h.O=p,h.j.info("backChannelRequestTimeoutMs_="+p)),p=h;const Xt=i.g;if(Xt){const Bs=Xt.g?Xt.g.getResponseHeader("X-Client-Wire-Protocol"):null;if(Bs){var k=p.h;k.g||Bs.indexOf("spdy")==-1&&Bs.indexOf("quic")==-1&&Bs.indexOf("h2")==-1||(k.j=k.l,k.g=new Set,k.h&&(mo(k,k.h),k.h=null))}if(p.G){const To=Xt.g?Xt.g.getResponseHeader("X-HTTP-Session-Id"):null;To&&(p.wa=To,Ie(p.J,p.G,To))}}h.I=3,h.l&&h.l.ra(),h.aa&&(h.T=Date.now()-i.F,h.j.info("Handshake RTT: "+h.T+"ms")),p=h;var U=i;if(p.na=rc(p,p.L?p.ba:null,p.W),U.L){Ml(p.h,U);var le=U,Fe=p.O;Fe&&(le.H=Fe),le.D&&(fo(le),Vs(le)),p.g=U}else Xl(p);h.i.length>0&&Os(h)}else ve[0]!="stop"&&ve[0]!="close"||Tn(h,7);else h.I==3&&(ve[0]=="stop"||ve[0]=="close"?ve[0]=="stop"?Tn(h,7):wo(h):ve[0]!="noop"&&h.l&&h.l.qa(ve),h.A=0)}}Rr(4)}catch{}}var Hf=class{constructor(i,l){this.g=i,this.map=l}};function kl(i){this.l=i||10,a.PerformanceNavigationTiming?(i=a.performance.getEntriesByType("navigation"),i=i.length>0&&(i[0].nextHopProtocol=="hq"||i[0].nextHopProtocol=="h2")):i=!!(a.chrome&&a.chrome.loadTimes&&a.chrome.loadTimes()&&a.chrome.loadTimes().wasFetchedViaSpdy),this.j=i?this.l:1,this.g=null,this.j>1&&(this.g=new Set),this.h=null,this.i=[]}function Pl(i){return i.h?!0:i.g?i.g.size>=i.j:!1}function Vl(i){return i.h?1:i.g?i.g.size:0}function go(i,l){return i.h?i.h==l:i.g?i.g.has(l):!1}function mo(i,l){i.g?i.g.add(l):i.h=l}function Ml(i,l){i.h&&i.h==l?i.h=null:i.g&&i.g.has(l)&&i.g.delete(l)}kl.prototype.cancel=function(){if(this.i=Dl(this),this.h)this.h.cancel(),this.h=null;else if(this.g&&this.g.size!==0){for(const i of this.g.values())i.cancel();this.g.clear()}};function Dl(i){if(i.h!=null)return i.i.concat(i.h.G);if(i.g!=null&&i.g.size!==0){let l=i.i;for(const h of i.g.values())l=l.concat(h.G);return l}return P(i.i)}var Nl=RegExp("^(?:([^:/?#.]+):)?(?://(?:([^\\\\/?#]*)@)?([^\\\\/?#]*?)(?::([0-9]+))?(?=[\\\\/?#]|$))?([^?#]+)?(?:\\?([^#]*))?(?:#([\\s\\S]*))?$");function Gf(i,l){if(i){i=i.split("&");for(let h=0;h<i.length;h++){const p=i[h].indexOf("=");let S,k=null;p>=0?(S=i[h].substring(0,p),k=i[h].substring(p+1)):S=i[h],l(S,k?decodeURIComponent(k.replace(/\+/g," ")):"")}}}function Kt(i){this.g=this.o=this.j="",this.u=null,this.m=this.h="",this.l=!1;let l;i instanceof Kt?(this.l=i.l,Vr(this,i.j),this.o=i.o,this.g=i.g,Mr(this,i.u),this.h=i.h,_o(this,jl(i.i)),this.m=i.m):i&&(l=String(i).match(Nl))?(this.l=!1,Vr(this,l[1]||"",!0),this.o=Dr(l[2]||""),this.g=Dr(l[3]||"",!0),Mr(this,l[4]),this.h=Dr(l[5]||"",!0),_o(this,l[6]||"",!0),this.m=Dr(l[7]||"")):(this.l=!1,this.i=new Lr(null,this.l))}Kt.prototype.toString=function(){const i=[];var l=this.j;l&&i.push(Nr(l,Ll,!0),":");var h=this.g;return(h||l=="file")&&(i.push("//"),(l=this.o)&&i.push(Nr(l,Ll,!0),"@"),i.push(kr(h).replace(/%25([0-9a-fA-F]{2})/g,"%$1")),h=this.u,h!=null&&i.push(":",String(h))),(h=this.h)&&(this.g&&h.charAt(0)!="/"&&i.push("/"),i.push(Nr(h,h.charAt(0)=="/"?Qf:Kf,!0))),(h=this.i.toString())&&i.push("?",h),(h=this.m)&&i.push("#",Nr(h,Jf)),i.join("")},Kt.prototype.resolve=function(i){const l=_t(this);let h=!!i.j;h?Vr(l,i.j):h=!!i.o,h?l.o=i.o:h=!!i.g,h?l.g=i.g:h=i.u!=null;var p=i.h;if(h)Mr(l,i.u);else if(h=!!i.h){if(p.charAt(0)!="/")if(this.g&&!this.h)p="/"+p;else{var S=l.h.lastIndexOf("/");S!=-1&&(p=l.h.slice(0,S+1)+p)}if(S=p,S==".."||S==".")p="";else if(S.indexOf("./")!=-1||S.indexOf("/.")!=-1){p=S.lastIndexOf("/",0)==0,S=S.split("/");const k=[];for(let U=0;U<S.length;){const le=S[U++];le=="."?p&&U==S.length&&k.push(""):le==".."?((k.length>1||k.length==1&&k[0]!="")&&k.pop(),p&&U==S.length&&k.push("")):(k.push(le),p=!0)}p=k.join("/")}else p=S}return h?l.h=p:h=i.i.toString()!=="",h?_o(l,jl(i.i)):h=!!i.m,h&&(l.m=i.m),l};function _t(i){return new Kt(i)}function Vr(i,l,h){i.j=h?Dr(l,!0):l,i.j&&(i.j=i.j.replace(/:$/,""))}function Mr(i,l){if(l){if(l=Number(l),isNaN(l)||l<0)throw Error("Bad port number "+l);i.u=l}else i.u=null}function _o(i,l,h){l instanceof Lr?(i.i=l,Xf(i.i,i.l)):(h||(l=Nr(l,Yf)),i.i=new Lr(l,i.l))}function Ie(i,l,h){i.i.set(l,h)}function Ms(i){return Ie(i,"zx",Math.floor(Math.random()*2147483648).toString(36)+Math.abs(Math.floor(Math.random()*2147483648)^Date.now()).toString(36)),i}function Dr(i,l){return i?l?decodeURI(i.replace(/%25/g,"%2525")):decodeURIComponent(i):""}function Nr(i,l,h){return typeof i=="string"?(i=encodeURI(i).replace(l,Wf),h&&(i=i.replace(/%25([0-9a-fA-F]{2})/g,"%$1")),i):null}function Wf(i){return i=i.charCodeAt(0),"%"+(i>>4&15).toString(16)+(i&15).toString(16)}var Ll=/[#\/\?@]/g,Kf=/[#\?:]/g,Qf=/[#\?]/g,Yf=/[#\?@]/g,Jf=/#/g;function Lr(i,l){this.h=this.g=null,this.i=i||null,this.j=!!l}function En(i){i.g||(i.g=new Map,i.h=0,i.i&&Gf(i.i,function(l,h){i.add(decodeURIComponent(l.replace(/\+/g," ")),h)}))}n=Lr.prototype,n.add=function(i,l){En(this),this.i=null,i=Hn(this,i);let h=this.g.get(i);return h||this.g.set(i,h=[]),h.push(l),this.h+=1,this};function Ol(i,l){En(i),l=Hn(i,l),i.g.has(l)&&(i.i=null,i.h-=i.g.get(l).length,i.g.delete(l))}function Fl(i,l){return En(i),l=Hn(i,l),i.g.has(l)}n.forEach=function(i,l){En(this),this.g.forEach(function(h,p){h.forEach(function(S){i.call(l,S,p,this)},this)},this)};function Ul(i,l){En(i);let h=[];if(typeof l=="string")Fl(i,l)&&(h=h.concat(i.g.get(Hn(i,l))));else for(i=Array.from(i.g.values()),l=0;l<i.length;l++)h=h.concat(i[l]);return h}n.set=function(i,l){return En(this),this.i=null,i=Hn(this,i),Fl(this,i)&&(this.h-=this.g.get(i).length),this.g.set(i,[l]),this.h+=1,this},n.get=function(i,l){return i?(i=Ul(this,i),i.length>0?String(i[0]):l):l};function Bl(i,l,h){Ol(i,l),h.length>0&&(i.i=null,i.g.set(Hn(i,l),P(h)),i.h+=h.length)}n.toString=function(){if(this.i)return this.i;if(!this.g)return"";const i=[],l=Array.from(this.g.keys());for(let p=0;p<l.length;p++){var h=l[p];const S=kr(h);h=Ul(this,h);for(let k=0;k<h.length;k++){let U=S;h[k]!==""&&(U+="="+kr(h[k])),i.push(U)}}return this.i=i.join("&")};function jl(i){const l=new Lr;return l.i=i.i,i.g&&(l.g=new Map(i.g),l.h=i.h),l}function Hn(i,l){return l=String(l),i.j&&(l=l.toLowerCase()),l}function Xf(i,l){l&&!i.j&&(En(i),i.i=null,i.g.forEach(function(h,p){const S=p.toLowerCase();p!=S&&(Ol(this,p),Bl(this,S,h))},i)),i.j=l}function Zf(i,l){const h=new xr;if(a.Image){const p=new Image;p.onload=g(Qt,h,"TestLoadImage: loaded",!0,l,p),p.onerror=g(Qt,h,"TestLoadImage: error",!1,l,p),p.onabort=g(Qt,h,"TestLoadImage: abort",!1,l,p),p.ontimeout=g(Qt,h,"TestLoadImage: timeout",!1,l,p),a.setTimeout(function(){p.ontimeout&&p.ontimeout()},1e4),p.src=i}else l(!1)}function ep(i,l){const h=new xr,p=new AbortController,S=setTimeout(()=>{p.abort(),Qt(h,"TestPingServer: timeout",!1,l)},1e4);fetch(i,{signal:p.signal}).then(k=>{clearTimeout(S),k.ok?Qt(h,"TestPingServer: ok",!0,l):Qt(h,"TestPingServer: server error",!1,l)}).catch(()=>{clearTimeout(S),Qt(h,"TestPingServer: error",!1,l)})}function Qt(i,l,h,p,S){try{S&&(S.onload=null,S.onerror=null,S.onabort=null,S.ontimeout=null),p(h)}catch{}}function tp(){this.g=new Ss}function yo(i){this.i=i.Sb||null,this.h=i.ab||!1}y(yo,qn),yo.prototype.g=function(){return new Ds(this.i,this.h)};function Ds(i,l){Re.call(this),this.H=i,this.o=l,this.m=void 0,this.status=this.readyState=0,this.responseType=this.responseText=this.response=this.statusText="",this.onreadystatechange=null,this.A=new Headers,this.h=null,this.F="GET",this.D="",this.g=!1,this.B=this.j=this.l=null,this.v=new AbortController}y(Ds,Re),n=Ds.prototype,n.open=function(i,l){if(this.readyState!=0)throw this.abort(),Error("Error reopening a connection");this.F=i,this.D=l,this.readyState=1,Fr(this)},n.send=function(i){if(this.readyState!=1)throw this.abort(),Error("need to call open() first. ");if(this.v.signal.aborted)throw this.abort(),Error("Request was aborted.");this.g=!0;const l={headers:this.A,method:this.F,credentials:this.m,cache:void 0,signal:this.v.signal};i&&(l.body=i),(this.H||a).fetch(new Request(this.D,l)).then(this.Pa.bind(this),this.ga.bind(this))},n.abort=function(){this.response=this.responseText="",this.A=new Headers,this.status=0,this.v.abort(),this.j&&this.j.cancel("Request was aborted.").catch(()=>{}),this.readyState>=1&&this.g&&this.readyState!=4&&(this.g=!1,Or(this)),this.readyState=0},n.Pa=function(i){if(this.g&&(this.l=i,this.h||(this.status=this.l.status,this.statusText=this.l.statusText,this.h=i.headers,this.readyState=2,Fr(this)),this.g&&(this.readyState=3,Fr(this),this.g)))if(this.responseType==="arraybuffer")i.arrayBuffer().then(this.Na.bind(this),this.ga.bind(this));else if(typeof a.ReadableStream<"u"&&"body"in i){if(this.j=i.body.getReader(),this.o){if(this.responseType)throw Error('responseType must be empty for "streamBinaryChunks" mode responses.');this.response=[]}else this.response=this.responseText="",this.B=new TextDecoder;$l(this)}else i.text().then(this.Oa.bind(this),this.ga.bind(this))};function $l(i){i.j.read().then(i.Ma.bind(i)).catch(i.ga.bind(i))}n.Ma=function(i){if(this.g){if(this.o&&i.value)this.response.push(i.value);else if(!this.o){var l=i.value?i.value:new Uint8Array(0);(l=this.B.decode(l,{stream:!i.done}))&&(this.response=this.responseText+=l)}i.done?Or(this):Fr(this),this.readyState==3&&$l(this)}},n.Oa=function(i){this.g&&(this.response=this.responseText=i,Or(this))},n.Na=function(i){this.g&&(this.response=i,Or(this))},n.ga=function(){this.g&&Or(this)};function Or(i){i.readyState=4,i.l=null,i.j=null,i.B=null,Fr(i)}n.setRequestHeader=function(i,l){this.A.append(i,l)},n.getResponseHeader=function(i){return this.h&&this.h.get(i.toLowerCase())||""},n.getAllResponseHeaders=function(){if(!this.h)return"";const i=[],l=this.h.entries();for(var h=l.next();!h.done;)h=h.value,i.push(h[0]+": "+h[1]),h=l.next();return i.join(`\r
`)};function Fr(i){i.onreadystatechange&&i.onreadystatechange.call(i)}Object.defineProperty(Ds.prototype,"withCredentials",{get:function(){return this.m==="include"},set:function(i){this.m=i?"include":"same-origin"}});function ql(i){let l="";return Gt(i,function(h,p){l+=p,l+=":",l+=h,l+=`\r
`}),l}function vo(i,l,h){e:{for(p in h){var p=!1;break e}p=!0}p||(h=ql(h),typeof i=="string"?h!=null&&kr(h):Ie(i,l,h))}function ke(i){Re.call(this),this.headers=new Map,this.L=i||null,this.h=!1,this.g=null,this.D="",this.o=0,this.l="",this.j=this.B=this.v=this.A=!1,this.m=null,this.F="",this.H=!1}y(ke,Re);var np=/^https?$/i,rp=["POST","PUT"];n=ke.prototype,n.Fa=function(i){this.H=i},n.ea=function(i,l,h,p){if(this.g)throw Error("[goog.net.XhrIo] Object is active with another request="+this.D+"; newUri="+i);l=l?l.toUpperCase():"GET",this.D=i,this.l="",this.o=0,this.A=!1,this.h=!0,this.g=this.L?this.L.g():Il.g(),this.g.onreadystatechange=I(d(this.Ca,this));try{this.B=!0,this.g.open(l,String(i),!0),this.B=!1}catch(k){zl(this,k);return}if(i=h||"",h=new Map(this.headers),p)if(Object.getPrototypeOf(p)===Object.prototype)for(var S in p)h.set(S,p[S]);else if(typeof p.keys=="function"&&typeof p.get=="function")for(const k of p.keys())h.set(k,p.get(k));else throw Error("Unknown input type for opt_headers: "+String(p));p=Array.from(h.keys()).find(k=>k.toLowerCase()=="content-type"),S=a.FormData&&i instanceof a.FormData,!(Array.prototype.indexOf.call(rp,l,void 0)>=0)||p||S||h.set("Content-Type","application/x-www-form-urlencoded;charset=utf-8");for(const[k,U]of h)this.g.setRequestHeader(k,U);this.F&&(this.g.responseType=this.F),"withCredentials"in this.g&&this.g.withCredentials!==this.H&&(this.g.withCredentials=this.H);try{this.m&&(clearTimeout(this.m),this.m=null),this.v=!0,this.g.send(i),this.v=!1}catch(k){zl(this,k)}};function zl(i,l){i.h=!1,i.g&&(i.j=!0,i.g.abort(),i.j=!1),i.l=l,i.o=5,Hl(i),Ns(i)}function Hl(i){i.A||(i.A=!0,be(i,"complete"),be(i,"error"))}n.abort=function(i){this.g&&this.h&&(this.h=!1,this.j=!0,this.g.abort(),this.j=!1,this.o=i||7,be(this,"complete"),be(this,"abort"),Ns(this))},n.N=function(){this.g&&(this.h&&(this.h=!1,this.j=!0,this.g.abort(),this.j=!1),Ns(this,!0)),ke.Z.N.call(this)},n.Ca=function(){this.u||(this.B||this.v||this.j?Gl(this):this.Xa())},n.Xa=function(){Gl(this)};function Gl(i){if(i.h&&typeof o<"u"){if(i.v&&Yt(i)==4)setTimeout(i.Ca.bind(i),0);else if(be(i,"readystatechange"),Yt(i)==4){i.h=!1;try{const k=i.ca();e:switch(k){case 200:case 201:case 202:case 204:case 206:case 304:case 1223:var l=!0;break e;default:l=!1}var h;if(!(h=l)){var p;if(p=k===0){let U=String(i.D).match(Nl)[1]||null;!U&&a.self&&a.self.location&&(U=a.self.location.protocol.slice(0,-1)),p=!np.test(U?U.toLowerCase():"")}h=p}if(h)be(i,"complete"),be(i,"success");else{i.o=6;try{var S=Yt(i)>2?i.g.statusText:""}catch{S=""}i.l=S+" ["+i.ca()+"]",Hl(i)}}finally{Ns(i)}}}}function Ns(i,l){if(i.g){i.m&&(clearTimeout(i.m),i.m=null);const h=i.g;i.g=null,l||be(i,"ready");try{h.onreadystatechange=null}catch{}}}n.isActive=function(){return!!this.g};function Yt(i){return i.g?i.g.readyState:0}n.ca=function(){try{return Yt(this)>2?this.g.status:-1}catch{return-1}},n.la=function(){try{return this.g?this.g.responseText:""}catch{return""}},n.La=function(i){if(this.g){var l=this.g.responseText;return i&&l.indexOf(i)==0&&(l=l.substring(i.length)),Rs(l)}};function Wl(i){try{if(!i.g)return null;if("response"in i.g)return i.g.response;switch(i.F){case"":case"text":return i.g.responseText;case"arraybuffer":if("mozResponseArrayBuffer"in i.g)return i.g.mozResponseArrayBuffer}return null}catch{return null}}function sp(i){const l={};i=(i.g&&Yt(i)>=2&&i.g.getAllResponseHeaders()||"").split(`\r
`);for(let p=0;p<i.length;p++){if(v(i[p]))continue;var h=$f(i[p]);const S=h[0];if(h=h[1],typeof h!="string")continue;h=h.trim();const k=l[S]||[];l[S]=k,k.push(h)}x(l,function(p){return p.join(", ")})}n.ya=function(){return this.o},n.Ha=function(){return typeof this.l=="string"?this.l:String(this.l)};function Ur(i,l,h){return h&&h.internalChannelParams&&h.internalChannelParams[i]||l}function Kl(i){this.za=0,this.i=[],this.j=new xr,this.ba=this.na=this.J=this.W=this.g=this.wa=this.G=this.H=this.u=this.U=this.o=null,this.Ya=this.V=0,this.Sa=Ur("failFast",!1,i),this.F=this.C=this.v=this.m=this.l=null,this.X=!0,this.xa=this.K=-1,this.Y=this.A=this.D=0,this.Qa=Ur("baseRetryDelayMs",5e3,i),this.Za=Ur("retryDelaySeedMs",1e4,i),this.Ta=Ur("forwardChannelMaxRetries",2,i),this.va=Ur("forwardChannelRequestTimeoutMs",2e4,i),this.ma=i&&i.xmlHttpFactory||void 0,this.Ua=i&&i.Rb||void 0,this.Aa=i&&i.useFetchStreams||!1,this.O=void 0,this.L=i&&i.supportsCrossDomainXhr||!1,this.M="",this.h=new kl(i&&i.concurrentRequestLimit),this.Ba=new tp,this.S=i&&i.fastHandshake||!1,this.R=i&&i.encodeInitMessageHeaders||!1,this.S&&this.R&&(this.R=!1),this.Ra=i&&i.Pb||!1,i&&i.ua&&this.j.ua(),i&&i.forceLongPolling&&(this.X=!1),this.aa=!this.S&&this.X&&i&&i.detectBufferingProxy||!1,this.ia=void 0,i&&i.longPollingTimeout&&i.longPollingTimeout>0&&(this.ia=i.longPollingTimeout),this.ta=void 0,this.T=0,this.P=!1,this.ja=this.B=null}n=Kl.prototype,n.ka=8,n.I=1,n.connect=function(i,l,h,p){tt(0),this.W=i,this.H=l||{},h&&p!==void 0&&(this.H.OSID=h,this.H.OAID=p),this.F=this.X,this.J=rc(this,null,this.W),Os(this)};function wo(i){if(Ql(i),i.I==3){var l=i.V++,h=_t(i.J);if(Ie(h,"SID",i.M),Ie(h,"RID",l),Ie(h,"TYPE","terminate"),Br(i,h),l=new Wt(i,i.j,l),l.M=2,l.A=Ms(_t(h)),h=!1,a.navigator&&a.navigator.sendBeacon)try{h=a.navigator.sendBeacon(l.A.toString(),"")}catch{}!h&&a.Image&&(new Image().src=l.A,h=!0),h||(l.g=sc(l.j,null),l.g.ea(l.A)),l.F=Date.now(),Vs(l)}nc(i)}function Ls(i){i.g&&(Eo(i),i.g.cancel(),i.g=null)}function Ql(i){Ls(i),i.v&&(a.clearTimeout(i.v),i.v=null),Fs(i),i.h.cancel(),i.m&&(typeof i.m=="number"&&a.clearTimeout(i.m),i.m=null)}function Os(i){if(!Pl(i.h)&&!i.m){i.m=!0;var l=i.Ea;xe||m(),ge||(xe(),ge=!0),T.add(l,i),i.D=0}}function ip(i,l){return Vl(i.h)>=i.h.j-(i.m?1:0)?!1:i.m?(i.i=l.G.concat(i.i),!0):i.I==1||i.I==2||i.D>=(i.Sa?0:i.Ta)?!1:(i.m=Sr(d(i.Ea,i,l),tc(i,i.D)),i.D++,!0)}n.Ea=function(i){if(this.m)if(this.m=null,this.I==1){if(!i){this.V=Math.floor(Math.random()*1e5),i=this.V++;const S=new Wt(this,this.j,i);let k=this.o;if(this.U&&(k?(k=C(k),te(k,this.U)):k=this.U),this.u!==null||this.R||(S.J=k,k=null),this.S)e:{for(var l=0,h=0;h<this.i.length;h++){t:{var p=this.i[h];if("__data__"in p.map&&(p=p.map.__data__,typeof p=="string")){p=p.length;break t}p=void 0}if(p===void 0)break;if(l+=p,l>4096){l=h;break e}if(l===4096||h===this.i.length-1){l=h+1;break e}}l=1e3}else l=1e3;l=Jl(this,S,l),h=_t(this.J),Ie(h,"RID",i),Ie(h,"CVER",22),this.G&&Ie(h,"X-HTTP-Session-Id",this.G),Br(this,h),k&&(this.R?l="headers="+kr(ql(k))+"&"+l:this.u&&vo(h,this.u,k)),mo(this.h,S),this.Ra&&Ie(h,"TYPE","init"),this.S?(Ie(h,"$req",l),Ie(h,"SID","null"),S.U=!0,ho(S,h,null)):ho(S,h,l),this.I=2}}else this.I==3&&(i?Yl(this,i):this.i.length==0||Pl(this.h)||Yl(this))};function Yl(i,l){var h;l?h=l.l:h=i.V++;const p=_t(i.J);Ie(p,"SID",i.M),Ie(p,"RID",h),Ie(p,"AID",i.K),Br(i,p),i.u&&i.o&&vo(p,i.u,i.o),h=new Wt(i,i.j,h,i.D+1),i.u===null&&(h.J=i.o),l&&(i.i=l.G.concat(i.i)),l=Jl(i,h,1e3),h.H=Math.round(i.va*.5)+Math.round(i.va*.5*Math.random()),mo(i.h,h),ho(h,p,l)}function Br(i,l){i.H&&Gt(i.H,function(h,p){Ie(l,p,h)}),i.l&&Gt({},function(h,p){Ie(l,p,h)})}function Jl(i,l,h){h=Math.min(i.i.length,h);const p=i.l?d(i.l.Ka,i.l,i):null;e:{var S=i.i;let le=-1;for(;;){const Fe=["count="+h];le==-1?h>0?(le=S[0].g,Fe.push("ofs="+le)):le=0:Fe.push("ofs="+le);let ve=!0;for(let $e=0;$e<h;$e++){var k=S[$e].g;const yt=S[$e].map;if(k-=le,k<0)le=Math.max(0,S[$e].g-100),ve=!1;else try{k="req"+k+"_"||"";try{var U=yt instanceof Map?yt:Object.entries(yt);for(const[In,Jt]of U){let Xt=Jt;c(Jt)&&(Xt=Ar(Jt)),Fe.push(k+In+"="+encodeURIComponent(Xt))}}catch(In){throw Fe.push(k+"type="+encodeURIComponent("_badmap")),In}}catch{p&&p(yt)}}if(ve){U=Fe.join("&");break e}}U=void 0}return i=i.i.splice(0,h),l.G=i,U}function Xl(i){if(!i.g&&!i.v){i.Y=1;var l=i.Da;xe||m(),ge||(xe(),ge=!0),T.add(l,i),i.A=0}}function bo(i){return i.g||i.v||i.A>=3?!1:(i.Y++,i.v=Sr(d(i.Da,i),tc(i,i.A)),i.A++,!0)}n.Da=function(){if(this.v=null,Zl(this),this.aa&&!(this.P||this.g==null||this.T<=0)){var i=4*this.T;this.j.info("BP detection timer enabled: "+i),this.B=Sr(d(this.Wa,this),i)}},n.Wa=function(){this.B&&(this.B=null,this.j.info("BP detection timeout reached."),this.j.info("Buffering proxy detected and switch to long-polling!"),this.F=!1,this.P=!0,tt(10),Ls(this),Zl(this))};function Eo(i){i.B!=null&&(a.clearTimeout(i.B),i.B=null)}function Zl(i){i.g=new Wt(i,i.j,"rpc",i.Y),i.u===null&&(i.g.J=i.o),i.g.P=0;var l=_t(i.na);Ie(l,"RID","rpc"),Ie(l,"SID",i.M),Ie(l,"AID",i.K),Ie(l,"CI",i.F?"0":"1"),!i.F&&i.ia&&Ie(l,"TO",i.ia),Ie(l,"TYPE","xmlhttp"),Br(i,l),i.u&&i.o&&vo(l,i.u,i.o),i.O&&(i.g.H=i.O);var h=i.g;i=i.ba,h.M=1,h.A=Ms(_t(l)),h.u=null,h.R=!0,Rl(h,i)}n.Va=function(){this.C!=null&&(this.C=null,Ls(this),bo(this),tt(19))};function Fs(i){i.C!=null&&(a.clearTimeout(i.C),i.C=null)}function ec(i,l){var h=null;if(i.g==l){Fs(i),Eo(i),i.g=null;var p=2}else if(go(i.h,l))h=l.G,Ml(i.h,l),p=1;else return;if(i.I!=0){if(l.o)if(p==1){h=l.u?l.u.length:0,l=Date.now()-l.F;var S=i.D;p=ks(),be(p,new El(p,h)),Os(i)}else Xl(i);else if(S=l.m,S==3||S==0&&l.X>0||!(p==1&&ip(i,l)||p==2&&bo(i)))switch(h&&h.length>0&&(l=i.h,l.i=l.i.concat(h)),S){case 1:Tn(i,5);break;case 4:Tn(i,10);break;case 3:Tn(i,6);break;default:Tn(i,2)}}}function tc(i,l){let h=i.Qa+Math.floor(Math.random()*i.Za);return i.isActive()||(h*=2),h*l}function Tn(i,l){if(i.j.info("Error code "+l),l==2){var h=d(i.bb,i),p=i.Ua;const S=!p;p=new Kt(p||"//www.google.com/images/cleardot.gif"),a.location&&a.location.protocol=="http"||Vr(p,"https"),Ms(p),S?Zf(p.toString(),h):ep(p.toString(),h)}else tt(2);i.I=0,i.l&&i.l.pa(l),nc(i),Ql(i)}n.bb=function(i){i?(this.j.info("Successfully pinged google.com"),tt(2)):(this.j.info("Failed to ping google.com"),tt(1))};function nc(i){if(i.I=0,i.ja=[],i.l){const l=Dl(i.h);(l.length!=0||i.i.length!=0)&&(D(i.ja,l),D(i.ja,i.i),i.h.i.length=0,P(i.i),i.i.length=0),i.l.oa()}}function rc(i,l,h){var p=h instanceof Kt?_t(h):new Kt(h);if(p.g!="")l&&(p.g=l+"."+p.g),Mr(p,p.u);else{var S=a.location;p=S.protocol,l=l?l+"."+S.hostname:S.hostname,S=+S.port;const k=new Kt(null);p&&Vr(k,p),l&&(k.g=l),S&&Mr(k,S),h&&(k.h=h),p=k}return h=i.G,l=i.wa,h&&l&&Ie(p,h,l),Ie(p,"VER",i.ka),Br(i,p),p}function sc(i,l,h){if(l&&!i.L)throw Error("Can't create secondary domain capable XhrIo object.");return l=i.Aa&&!i.ma?new ke(new yo({ab:h})):new ke(i.ma),l.Fa(i.L),l}n.isActive=function(){return!!this.l&&this.l.isActive(this)};function ic(){}n=ic.prototype,n.ra=function(){},n.qa=function(){},n.pa=function(){},n.oa=function(){},n.isActive=function(){return!0},n.Ka=function(){};function Us(){}Us.prototype.g=function(i,l){return new at(i,l)};function at(i,l){Re.call(this),this.g=new Kl(l),this.l=i,this.h=l&&l.messageUrlParams||null,i=l&&l.messageHeaders||null,l&&l.clientProtocolHeaderRequired&&(i?i["X-Client-Protocol"]="webchannel":i={"X-Client-Protocol":"webchannel"}),this.g.o=i,i=l&&l.initMessageHeaders||null,l&&l.messageContentType&&(i?i["X-WebChannel-Content-Type"]=l.messageContentType:i={"X-WebChannel-Content-Type":l.messageContentType}),l&&l.sa&&(i?i["X-WebChannel-Client-Profile"]=l.sa:i={"X-WebChannel-Client-Profile":l.sa}),this.g.U=i,(i=l&&l.Qb)&&!v(i)&&(this.g.u=i),this.A=l&&l.supportsCrossDomainXhr||!1,this.v=l&&l.sendRawJson||!1,(l=l&&l.httpSessionIdParam)&&!v(l)&&(this.g.G=l,i=this.h,i!==null&&l in i&&(i=this.h,l in i&&delete i[l])),this.j=new Gn(this)}y(at,Re),at.prototype.m=function(){this.g.l=this.j,this.A&&(this.g.L=!0),this.g.connect(this.l,this.h||void 0)},at.prototype.close=function(){wo(this.g)},at.prototype.o=function(i){var l=this.g;if(typeof i=="string"){var h={};h.__data__=i,i=h}else this.v&&(h={},h.__data__=Ar(i),i=h);l.i.push(new Hf(l.Ya++,i)),l.I==3&&Os(l)},at.prototype.N=function(){this.g.l=null,delete this.j,wo(this.g),delete this.g,at.Z.N.call(this)};function oc(i){ao.call(this),i.__headers__&&(this.headers=i.__headers__,this.statusCode=i.__status__,delete i.__headers__,delete i.__status__);var l=i.__sm__;if(l){e:{for(const h in l){i=h;break e}i=void 0}(this.i=i)&&(i=this.i,l=l!==null&&i in l?l[i]:void 0),this.data=l}else this.data=i}y(oc,ao);function ac(){lo.call(this),this.status=1}y(ac,lo);function Gn(i){this.g=i}y(Gn,ic),Gn.prototype.ra=function(){be(this.g,"a")},Gn.prototype.qa=function(i){be(this.g,new oc(i))},Gn.prototype.pa=function(i){be(this.g,new ac)},Gn.prototype.oa=function(){be(this.g,"b")},Us.prototype.createWebChannel=Us.prototype.g,at.prototype.send=at.prototype.o,at.prototype.open=at.prototype.m,at.prototype.close=at.prototype.close,bh=function(){return new Us},wh=function(){return ks()},vh=wn,Ho={jb:0,mb:1,nb:2,Hb:3,Mb:4,Jb:5,Kb:6,Ib:7,Gb:8,Lb:9,PROXY:10,NOPROXY:11,Eb:12,Ab:13,Bb:14,zb:15,Cb:16,Db:17,fb:18,eb:19,gb:20},Ps.NO_ERROR=0,Ps.TIMEOUT=8,Ps.HTTP_ERROR=6,Js=Ps,Tl.COMPLETE="complete",yh=Tl,xs.EventType=vn,vn.OPEN="a",vn.CLOSE="b",vn.ERROR="c",vn.MESSAGE="d",Re.prototype.listen=Re.prototype.J,Hr=xs,ke.prototype.listenOnce=ke.prototype.K,ke.prototype.getLastError=ke.prototype.Ha,ke.prototype.getLastErrorCode=ke.prototype.ya,ke.prototype.getStatus=ke.prototype.ca,ke.prototype.getResponseJson=ke.prototype.La,ke.prototype.getResponseText=ke.prototype.la,ke.prototype.send=ke.prototype.ea,ke.prototype.setWithCredentials=ke.prototype.Fa,_h=ke}).apply(typeof js<"u"?js:typeof self<"u"?self:typeof window<"u"?window:{});const Ec="@firebase/firestore",Tc="4.9.2";/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function Oe(n,e){const t={typeString:n};return e&&(t.value=e),t}function gs(n,e){if(!Ch(n))throw new B(V.INVALID_ARGUMENT,"JSON must be an object");let t;for(const r in e)if(e[r]){const s=e[r].typeString,o="value"in e[r]?{value:e[r].value}:void 0;if(!(r in n)){t=`JSON missing required field: '${r}'`;break}const a=n[r];if(s&&typeof a!==s){t=`JSON field '${r}' must be a ${s}.`;break}if(o!==void 0&&a!==o.value){t=`Expected '${r}' field to equal '${o.value}'`;break}}if(t)throw new B(V.INVALID_ARGUMENT,t);return!0}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const is=-1;function fm(n,e){const t=n.toTimestamp().seconds,r=n.toTimestamp().nanoseconds+1,s=ie.fromTimestamp(r===1e9?new Ce(t+1,0):new Ce(t,r));return new un(s,ee.empty(),e)}function pm(n){return new un(n.readTime,n.key,is)}class un{constructor(e,t,r){this.readTime=e,this.documentKey=t,this.largestBatchId=r}static min(){return new un(ie.min(),ee.empty(),is)}static max(){return new un(ie.max(),ee.empty(),is)}}function gm(n,e){let t=n.readTime.compareTo(e.readTime);return t!==0?t:(t=ee.comparator(n.documentKey,e.documentKey),t!==0?t:de(n.largestBatchId,e.largestBatchId))}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */async function yr(n){if(n.code!==V.FAILED_PRECONDITION||n.message!==mm)throw n;z("LocalStore","Unexpectedly lost primary lease")}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const va=-1;function Oi(n){return n==null}function hi(n){return n===0&&1/n==-1/0}function vm(n){return typeof n=="number"&&Number.isInteger(n)&&!hi(n)&&n<=Number.MAX_SAFE_INTEGER&&n>=Number.MIN_SAFE_INTEGER}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const xh="server_timestamp",kh="__type__",Ph="__previous_value__",Vh="__local_write_time__";function wa(n){return(n?.mapValue?.fields||{})[kh]?.stringValue===xh}function Fi(n){const e=n.mapValue.fields[Ph];return wa(e)?Fi(e):e}function os(n){const e=hn(n.mapValue.fields[Vh].timestampValue);return new Ce(e.seconds,e.nanos)}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Tm{constructor(e,t,r,s,o,a,c,u,d,g){this.databaseId=e,this.appId=t,this.persistenceKey=r,this.host=s,this.ssl=o,this.forceLongPolling=a,this.autoDetectLongPolling=c,this.longPollingOptions=u,this.useFetchStreams=d,this.isUsingEmulator=g}}const di="(default)";class as{constructor(e,t){this.projectId=e,this.database=t||di}static empty(){return new as("","")}get isDefaultDatabase(){return this.database===di}isEqual(e){return e instanceof as&&e.projectId===this.projectId&&e.database===this.database}}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class it{constructor(e){this.value=e}static empty(){return new it({mapValue:{}})}field(e){if(e.isEmpty())return this.value;{let t=this.value;for(let r=0;r<e.length-1;++r)if(t=(t.mapValue.fields||{})[e.get(r)],!Zs(t))return null;return t=(t.mapValue.fields||{})[e.lastSegment()],t||null}}set(e,t){this.getFieldsMap(e.popLast())[e.lastSegment()]=Yr(t)}setAll(e){let t=Ge.emptyPath(),r={},s=[];e.forEach(((a,c)=>{if(!t.isImmediateParentOf(c)){const u=this.getFieldsMap(t);this.applyChanges(u,r,s),r={},s=[],t=c.popLast()}a?r[c.lastSegment()]=Yr(a):s.push(c.lastSegment())}));const o=this.getFieldsMap(t);this.applyChanges(o,r,s)}delete(e){const t=this.field(e.popLast());Zs(t)&&t.mapValue.fields&&delete t.mapValue.fields[e.lastSegment()]}isEqual(e){return At(this.value,e.value)}getFieldsMap(e){let t=this.value;t.mapValue.fields||(t.mapValue={fields:{}});for(let r=0;r<e.length;++r){let s=t.mapValue.fields[e.get(r)];Zs(s)&&s.mapValue.fields||(s={mapValue:{fields:{}}},t.mapValue.fields[e.get(r)]=s),t=s}return t.mapValue.fields}applyChanges(e,t,r){mn(t,((s,o)=>e[s]=o));for(const s of r)delete e[s]}clone(){return new it(Yr(this.value))}}function Nh(n){const e=[];return mn(n.fields,((t,r)=>{const s=new Ge([t]);if(Zs(r)){const o=Nh(r.mapValue).fields;if(o.length===0)e.push(s);else for(const a of o)e.push(s.child(a))}else e.push(s)})),new ct(e)}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class cs{constructor(e,t="asc"){this.field=e,this.dir=t}}function Rm(n,e){return n.dir===e.dir&&n.field.isEqual(e.field)}/**
 * @license
 * Copyright 2022 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const jm=new Se(ee.comparator);function Ot(){return jm}const Hh=new Se(ee.comparator);function Gr(...n){let e=Hh;for(const t of n)e=e.insert(t.key,t);return e}function Gh(n){let e=Hh;return n.forEach(((t,r)=>e=e.insert(t,r.overlayedDocument))),e}function Sn(){return Xr()}function Wh(){return Xr()}function Xr(){return new Un((n=>n.toString()),((n,e)=>n.isEqual(e)))}const $m=new Se(ee.comparator),qm=new Be(ee.comparator);function fe(...n){let e=qm;for(const t of n)e=e.add(t);return e}const zm=new Be(de);function Hm(){return zm}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function Ia(n,e){if(n.useProto3Json){if(isNaN(e))return{doubleValue:"NaN"};if(e===1/0)return{doubleValue:"Infinity"};if(e===-1/0)return{doubleValue:"-Infinity"}}return{doubleValue:hi(e)?"-0":e}}function Kh(n){return{integerValue:""+n}}function Gm(n,e){return vm(e)?Kh(e):Ia(n,e)}/**
 * @license
 * Copyright 2018 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class $i{constructor(){this._=void 0}}function Wm(n,e,t){return n instanceof us?(function(s,o){const a={fields:{[kh]:{stringValue:xh},[Vh]:{timestampValue:{seconds:s.seconds,nanos:s.nanoseconds}}}};return o&&wa(o)&&(o=Fi(o)),o&&(a.fields[Ph]=o),{mapValue:a}})(t,e):n instanceof cr?Yh(n,e):n instanceof ur?Jh(n,e):(function(s,o){const a=Qh(s,o),c=$c(a)+$c(s.Ae);return Ko(a)&&Ko(s.Ae)?Kh(c):Ia(s.serializer,c)})(n,e)}function Km(n,e,t){return n instanceof cr?Yh(n,e):n instanceof ur?Jh(n,e):t}function Qh(n,e){return n instanceof mi?(function(r){return Ko(r)||(function(o){return!!o&&"doubleValue"in o})(r)})(e)?e:{integerValue:0}:null}class us extends $i{}class cr extends $i{constructor(e){super(),this.elements=e}}function Yh(n,e){const t=Xh(e);for(const r of n.elements)t.some((s=>At(s,r)))||t.push(r);return{arrayValue:{values:t}}}class ur extends $i{constructor(e){super(),this.elements=e}}function Jh(n,e){let t=Xh(e);for(const r of n.elements)t=t.filter((s=>!At(s,r)));return{arrayValue:{values:t}}}class mi extends $i{constructor(e,t){super(),this.serializer=e,this.Ae=t}}function $c(n){return Me(n.integerValue||n.doubleValue)}function Xh(n){return ba(n)&&n.arrayValue.values?n.arrayValue.values.slice():[]}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Ca{constructor(e,t){this.field=e,this.transform=t}}function Qm(n,e){return n.field.isEqual(e.field)&&(function(r,s){return r instanceof cr&&s instanceof cr||r instanceof ur&&s instanceof ur?or(r.elements,s.elements,At):r instanceof mi&&s instanceof mi?At(r.Ae,s.Ae):r instanceof us&&s instanceof us})(n.transform,e.transform)}class Ym{constructor(e,t){this.version=e,this.transformResults=t}}class dt{constructor(e,t){this.updateTime=e,this.exists=t}static none(){return new dt}static exists(e){return new dt(void 0,e)}static updateTime(e){return new dt(e)}get isNone(){return this.updateTime===void 0&&this.exists===void 0}isEqual(e){return this.exists===e.exists&&(this.updateTime?!!e.updateTime&&this.updateTime.isEqual(e.updateTime):!e.updateTime)}}function ei(n,e){return n.updateTime!==void 0?e.isFoundDocument()&&e.version.isEqual(n.updateTime):n.exists===void 0||n.exists===e.isFoundDocument()}class qi{}function Zh(n,e){if(!n.hasLocalMutations||e&&e.fields.length===0)return null;if(e===null)return n.isNoDocument()?new Aa(n.key,dt.none()):new ms(n.key,n.data,dt.none());{const t=n.data,r=it.empty();let s=new Be(Ge.comparator);for(let o of e.fields)if(!s.has(o)){let a=t.field(o);a===null&&o.length>1&&(o=o.popLast(),a=t.field(o)),a===null?r.delete(o):r.set(o,a),s=s.add(o)}return new _n(n.key,r,new ct(s.toArray()),dt.none())}}function Jm(n,e,t){n instanceof ms?(function(s,o,a){const c=s.value.clone(),u=zc(s.fieldTransforms,o,a.transformResults);c.setAll(u),o.convertToFoundDocument(a.version,c).setHasCommittedMutations()})(n,e,t):n instanceof _n?(function(s,o,a){if(!ei(s.precondition,o))return void o.convertToUnknownDocument(a.version);const c=zc(s.fieldTransforms,o,a.transformResults),u=o.data;u.setAll(ed(s)),u.setAll(c),o.convertToFoundDocument(a.version,u).setHasCommittedMutations()})(n,e,t):(function(s,o,a){o.convertToNoDocument(a.version).setHasCommittedMutations()})(0,e,t)}function Zr(n,e,t,r){return n instanceof ms?(function(o,a,c,u){if(!ei(o.precondition,a))return c;const d=o.value.clone(),g=Hc(o.fieldTransforms,u,a);return d.setAll(g),a.convertToFoundDocument(a.version,d).setHasLocalMutations(),null})(n,e,t,r):n instanceof _n?(function(o,a,c,u){if(!ei(o.precondition,a))return c;const d=Hc(o.fieldTransforms,u,a),g=a.data;return g.setAll(ed(o)),g.setAll(d),a.convertToFoundDocument(a.version,g).setHasLocalMutations(),c===null?null:c.unionWith(o.fieldMask.fields).unionWith(o.fieldTransforms.map((y=>y.field)))})(n,e,t,r):(function(o,a,c){return ei(o.precondition,a)?(a.convertToNoDocument(a.version).setHasLocalMutations(),null):c})(n,e,t)}function Xm(n,e){let t=null;for(const r of n.fieldTransforms){const s=e.data.field(r.field),o=Qh(r.transform,s||null);o!=null&&(t===null&&(t=it.empty()),t.set(r.field,o))}return t||null}function qc(n,e){return n.type===e.type&&!!n.key.isEqual(e.key)&&!!n.precondition.isEqual(e.precondition)&&!!(function(r,s){return r===void 0&&s===void 0||!(!r||!s)&&or(r,s,((o,a)=>Qm(o,a)))})(n.fieldTransforms,e.fieldTransforms)&&(n.type===0?n.value.isEqual(e.value):n.type!==1||n.data.isEqual(e.data)&&n.fieldMask.isEqual(e.fieldMask))}class ms extends qi{constructor(e,t,r,s=[]){super(),this.key=e,this.value=t,this.precondition=r,this.fieldTransforms=s,this.type=0}getFieldMask(){return null}}class _n extends qi{constructor(e,t,r,s,o=[]){super(),this.key=e,this.data=t,this.fieldMask=r,this.precondition=s,this.fieldTransforms=o,this.type=1}getFieldMask(){return this.fieldMask}}function ed(n){const e=new Map;return n.fieldMask.fields.forEach((t=>{if(!t.isEmpty()){const r=n.data.field(t);e.set(t,r)}})),e}function zc(n,e,t){const r=new Map;ye(n.length===t.length,32656,{Re:t.length,Ve:n.length});for(let s=0;s<t.length;s++){const o=n[s],a=o.transform,c=e.data.field(o.field);r.set(o.field,Km(a,c,t[s]))}return r}function Hc(n,e,t){const r=new Map;for(const s of n){const o=s.transform,a=t.data.field(s.field);r.set(s.field,Wm(o,a,e))}return r}class Aa extends qi{constructor(e,t){super(),this.key=e,this.precondition=t,this.type=2,this.fieldTransforms=[]}getFieldMask(){return null}}class Zm extends qi{constructor(e,t){super(),this.key=e,this.precondition=t,this.type=3,this.fieldTransforms=[]}getFieldMask(){return null}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class zi{constructor(e,t,r,s,o){this.snapshotVersion=e,this.targetChanges=t,this.targetMismatches=r,this.documentUpdates=s,this.resolvedLimboDocuments=o}static createSynthesizedRemoteEventForCurrentChange(e,t,r){const s=new Map;return s.set(e,_s.createSynthesizedTargetChangeForCurrentChange(e,t,r)),new zi(ie.min(),s,new Se(de),Ot(),fe())}}class _s{constructor(e,t,r,s,o){this.resumeToken=e,this.current=t,this.addedDocuments=r,this.modifiedDocuments=s,this.removedDocuments=o}static createSynthesizedTargetChangeForCurrentChange(e,t,r){return new _s(r,t,fe(),fe(),fe())}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class I0{constructor(e){this.yt=e}}function C0(n){const e=y0({parent:n.parent,structuredQuery:n.structuredQuery});return n.limitType==="LAST"?gi(e,e.limit,"L"):e}/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class ka{constructor(){this.Qr=new Be(ze.$r),this.Ur=new Be(ze.Kr)}isEmpty(){return this.Qr.isEmpty()}addReference(e,t){const r=new ze(e,t);this.Qr=this.Qr.add(r),this.Ur=this.Ur.add(r)}Wr(e,t){e.forEach((r=>this.addReference(r,t)))}removeReference(e,t){this.Gr(new ze(e,t))}zr(e,t){e.forEach((r=>this.removeReference(r,t)))}jr(e){const t=new ee(new Ee([])),r=new ze(t,e),s=new ze(t,e+1),o=[];return this.Ur.forEachInRange([r,s],(a=>{this.Gr(a),o.push(a.key)})),o}Jr(){this.Qr.forEach((e=>this.Gr(e)))}Gr(e){this.Qr=this.Qr.delete(e),this.Ur=this.Ur.delete(e)}Hr(e){const t=new ee(new Ee([])),r=new ze(t,e),s=new ze(t,e+1);let o=fe();return this.Ur.forEachInRange([r,s],(a=>{o=o.add(a.key)})),o}containsKey(e){const t=new ze(e,0),r=this.Qr.firstAfterOrEqual(t);return r!==null&&e.isEqual(r.key)}}class ze{constructor(e,t){this.key=e,this.Yr=t}static $r(e,t){return ee.comparator(e.key,t.key)||de(e.Yr,t.Yr)}static Kr(e,t){return de(e.Yr,t.Yr)||ee.comparator(e.key,t.key)}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class H0{constructor(){this.Rs=!1,this.Vs=!1,this.fs=100,this.gs=(function(){return Np()?8:ym(Xe())>0?6:4})()}initialize(e,t){this.ps=e,this.indexManager=t,this.Rs=!0}getDocumentsMatchingQuery(e,t,r,s){const o={result:null};return this.ys(e,t).next((a=>{o.result=a})).next((()=>{if(!o.result)return this.ws(e,t,s,r).next((a=>{o.result=a}))})).next((()=>{if(o.result)return;const a=new z0;return this.Ss(e,t,a).next((c=>{if(o.result=c,this.Vs)return this.bs(e,t,a,c.size)}))})).next((()=>o.result))}bs(e,t,r,s){return r.documentReadCount<this.fs?(Qn()<=he.DEBUG&&z("QueryEngine","SDK will not create cache indexes for query:",Yn(t),"since it only creates cache indexes for collection contains","more than or equal to",this.fs,"documents"),M.resolve()):(Qn()<=he.DEBUG&&z("QueryEngine","Query:",Yn(t),"scans",r.documentReadCount,"local documents and returns",s,"documents as results."),r.documentReadCount>this.gs*s?(Qn()<=he.DEBUG&&z("QueryEngine","The SDK decides to create cache indexes for query:",Yn(t),"as using cache indexes may help improve performance."),this.indexManager.createTargetIndexes(e,bt(t))):M.resolve())}ys(e,t){if(jc(t))return M.resolve(null);let r=bt(t);return this.indexManager.getIndexType(e,r).next((s=>s===0?null:(t.limit!==null&&s===1&&(t=gi(t,null,"F"),r=bt(t)),this.indexManager.getDocumentsMatchingTarget(e,r).next((o=>{const a=fe(...o);return this.ps.getDocuments(e,a).next((c=>this.indexManager.getMinOffset(e,r).next((u=>{const d=this.Ds(t,c);return this.Cs(t,d,a,u.readTime)?this.ys(e,gi(t,null,"F")):this.vs(e,d,t,u)}))))})))))}ws(e,t,r,s){return jc(t)||s.isEqual(ie.min())?M.resolve(null):this.ps.getDocuments(e,r).next((o=>{const a=this.Ds(t,o);return this.Cs(t,a,r,s)?M.resolve(null):(Qn()<=he.DEBUG&&z("QueryEngine","Re-using previous result from %s to execute query: %s",s.toString(),Yn(t)),this.vs(e,a,t,fm(s,is)).next((c=>c)))}))}Ds(e,t){let r=new Be(zh(e));return t.forEach(((s,o)=>{ji(e,o)&&(r=r.add(o))})),r}Cs(e,t,r,s){if(e.limit===null)return!1;if(r.size!==t.size)return!0;const o=e.limitType==="F"?t.last():t.first();return!!o&&(o.hasPendingWrites||o.version.compareTo(s)>0)}Ss(e,t,r){return Qn()<=he.DEBUG&&z("QueryEngine","Using full collection scan to execute query:",Yn(t)),this.ps.getDocumentsMatchingQuery(e,t,un.min(),r)}vs(e,t,r,s){return this.ps.getDocumentsMatchingQuery(e,r,s).next((o=>(t.forEach((a=>{o=o.insert(a.key,a)})),o)))}}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const Qe="WebChannelConnection";class o1 extends s1{constructor(e){super(e),this.c_=[],this.forceLongPolling=e.forceLongPolling,this.autoDetectLongPolling=e.autoDetectLongPolling,this.useFetchStreams=e.useFetchStreams,this.longPollingOptions=e.longPollingOptions}Jo(e,t,r,s,o){const a=ra();return new Promise(((c,u)=>{const d=new _h;d.setWithCredentials(!0),d.listenOnce(yh.COMPLETE,(()=>{try{switch(d.getLastErrorCode()){case Js.NO_ERROR:const y=d.getResponseJson();z(Qe,`XHR for RPC '${e}' ${a} received:`,JSON.stringify(y)),c(y);break;case Js.TIMEOUT:z(Qe,`RPC '${e}' ${a} timed out`),u(new B(V.DEADLINE_EXCEEDED,"Request time out"));break;case Js.HTTP_ERROR:const I=d.getStatus();if(z(Qe,`RPC '${e}' ${a} failed with status:`,I,"response text:",d.getResponseText()),I>0){let P=d.getResponseJson();Array.isArray(P)&&(P=P[0]);const D=P?.error;if(D&&D.status&&D.message){const L=(function(F){const j=F.toLowerCase().replace(/_/g,"-");return Object.values(V).indexOf(j)>=0?j:V.UNKNOWN})(D.status);u(new B(L,D.message))}else u(new B(V.UNKNOWN,"Server responded with status "+d.getStatus()))}else u(new B(V.UNAVAILABLE,"Connection failed."));break;default:re(9055,{l_:e,streamId:a,h_:d.getLastErrorCode(),P_:d.getLastError()})}}finally{z(Qe,`RPC '${e}' ${a} completed.`)}}));const g=JSON.stringify(s);z(Qe,`RPC '${e}' ${a} sending request:`,s),d.send(t,"POST",g,r,15)}))}T_(e,t,r){const s=ra(),o=[this.Uo,"/","google.firestore.v1.Firestore","/",e,"/channel"],a=bh(),c=wh(),u={httpSessionIdParam:"gsessionid",initMessageHeaders:{},messageUrlParams:{database:`projects/${this.databaseId.projectId}/databases/${this.databaseId.database}`},sendRawJson:!0,supportsCrossDomainXhr:!0,internalChannelParams:{forwardChannelRequestTimeoutMs:6e5},forceLongPolling:this.forceLongPolling,detectBufferingProxy:this.autoDetectLongPolling},d=this.longPollingOptions.timeoutSeconds;d!==void 0&&(u.longPollingTimeout=Math.round(1e3*d)),this.useFetchStreams&&(u.useFetchStreams=!0),this.jo(u.initMessageHeaders,t,r),u.encodeInitMessageHeaders=!0;const g=o.join("");z(Qe,`Creating RPC '${e}' stream ${s}: ${g}`,u);const y=a.createWebChannel(g,u);this.I_(y);let I=!1,P=!1;const D=new i1({Yo:A=>{P?z(Qe,`Not sending because RPC '${e}' stream ${s} is closed:`,A):(I||(z(Qe,`Opening RPC '${e}' stream ${s} transport.`),y.open(),I=!0),z(Qe,`RPC '${e}' stream ${s} sending:`,A),y.send(A))},Zo:()=>y.close()}),L=(A,F,j)=>{A.listen(F,(Y=>{try{j(Y)}catch(we){setTimeout((()=>{throw we}),0)}}))};return L(y,Hr.EventType.OPEN,(()=>{P||(z(Qe,`RPC '${e}' stream ${s} transport opened.`),D.o_())})),L(y,Hr.EventType.CLOSE,(()=>{P||(P=!0,z(Qe,`RPC '${e}' stream ${s} transport closed`),D.a_(),this.E_(y))})),L(y,Hr.EventType.ERROR,(A=>{P||(P=!0,ir(Qe,`RPC '${e}' stream ${s} transport errored. Name:`,A.name,"Message:",A.message),D.a_(new B(V.UNAVAILABLE,"The operation could not be completed")))})),L(y,Hr.EventType.MESSAGE,(A=>{if(!P){const F=A.data[0];ye(!!F,16349);const j=F,Y=j?.error||j[0]?.error;if(Y){z(Qe,`RPC '${e}' stream ${s} received error:`,Y);const we=Y.status;let xe=(function(m){const _=Ne[m];if(_!==void 0)return td(_)})(we),ge=Y.message;xe===void 0&&(xe=V.INTERNAL,ge="Unknown error status: "+we+" with message "+Y.message),P=!0,D.a_(new B(xe,ge)),y.close()}else z(Qe,`RPC '${e}' stream ${s} received:`,F),D.u_(F)}})),L(c,vh.STAT_EVENT,(A=>{A.stat===Ho.PROXY?z(Qe,`RPC '${e}' stream ${s} detected buffering proxy`):A.stat===Ho.NOPROXY&&z(Qe,`RPC '${e}' stream ${s} detected no buffering proxy`)})),setTimeout((()=>{D.__()}),0),D}terminate(){this.c_.forEach((e=>e.close())),this.c_=[]}I_(e){this.c_.push(e)}E_(e){this.c_=this.c_.filter((t=>t===e))}}function Vo(){return typeof document<"u"?document:null}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
...
This typically indicates that your device does not have a healthy Internet connection at the moment. The client will operate in offline mode until it is able to successfully connect to the backend.`;this.aa?(Lt(t),this.aa=!1):z("OnlineStateTracker",t)}Pa(){this._a!==null&&(this._a.cancel(),this._a=null)}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Tt{constructor(e,t){if(!isFinite(e)||e<-90||e>90)throw new B(V.INVALID_ARGUMENT,"Latitude must be a number between -90 and 90, but was: "+e);if(!isFinite(t)||t<-180||t>180)throw new B(V.INVALID_ARGUMENT,"Longitude must be a number between -180 and 180, but was: "+t);this._lat=e,this._long=t}get latitude(){return this._lat}get longitude(){return this._long}isEqual(e){return this._lat===e._lat&&this._long===e._long}_compareTo(e){return de(this._lat,e._lat)||de(this._long,e._long)}toJSON(){return{latitude:this._lat,longitude:this._long,type:Tt._jsonSchemaVersion}}static fromJSON(e){if(gs(e,Tt._jsonSchema))return new Tt(e.latitude,e.longitude)}}Tt._jsonSchemaVersion="firestore/geoPoint/1.0",Tt._jsonSchema={type:Oe("string",Tt._jsonSchemaVersion),latitude:Oe("number"),longitude:Oe("number")};/**
 * @license
 * Copyright 2024 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class It{constructor(e){this._values=(e||[]).map((t=>t))}toArray(){return this._values.map((e=>e))}isEqual(e){return(function(r,s){if(r.length!==s.length)return!1;for(let o=0;o<r.length;++o)if(r[o]!==s[o])return!1;return!0})(this._values,e._values)}toJSON(){return{type:It._jsonSchemaVersion,vectorValues:this._values}}static fromJSON(e){if(gs(e,It._jsonSchema)){if(Array.isArray(e.vectorValues)&&e.vectorValues.every((t=>typeof t=="number")))return new It(e.vectorValues);throw new B(V.INVALID_ARGUMENT,"Expected 'vectorValues' field to be a number array")}}}It._jsonSchemaVersion="firestore/vectorValue/1.0",It._jsonSchema={type:Oe("string",It._jsonSchemaVersion),vectorValues:Oe("object")};/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function ri(n){n=ot(n,Pe);const e=ot(n.firestore,Ft);return Q1(Qi(e),n._key).then((t=>Gd(e,n,t)))}Mn._jsonSchemaVersion="firestore/querySnapshot/1.0",Mn._jsonSchema={type:Oe("string",Mn._jsonSchemaVersion),bundleSource:Oe("string","QuerySnapshot"),bundleName:Oe("string"),bundle:Oe("string")};class sl extends l2{constructor(e){super(),this.firestore=e}convertBytes(e){return new ht(e)}convertReference(e){const t=this.convertDocumentKey(e,this.firestore._databaseId);return new Pe(this.firestore,null,t)}}function il(n){n=ot(n,jt);const e=ot(n.firestore,Ft),t=Qi(e),r=new sl(e);return $d(n._query),Y1(t,n._query).then((s=>new Mn(e,r,n,s)))}function si(n,e,t){n=ot(n,Pe);const r=ot(n.firestore,Ft),s=Hd(n.converter,e,t);return no(r,[Ld(Xi(r),"setDoc",n._key,s,n.converter!==null,t).toMutation(n._key,dt.none())])}function u2(n,e,t,...r){n=ot(n,Pe);const s=ot(n.firestore,Ft),o=Xi(s);let a;return a=typeof(e=je(e))=="string"||e instanceof Yi?s2(o,"updateDoc",n._key,e,t,r):r2(o,"updateDoc",n._key,e),no(s,[a.toMutation(n._key,dt.exists(!0))])}function l4(n){return no(ot(n.firestore,Ft),[new Aa(n._key,dt.none())])}function c4(n,e){const t=ot(n.firestore,Ft),r=xn(n),s=Hd(n.converter,e);return no(t,[Ld(Xi(n.firestore),"addDoc",r._key,s,n.converter!==null,{}).toMutation(r._key,dt.exists(!1))]).then((()=>r))}function u4(n,...e){n=je(n);let t={includeMetadataChanges:!1,source:"default"},r=0;typeof e[r]!="object"||yu(e[r])||(t=e[r++]);const s={includeMetadataChanges:t.includeMetadataChanges,source:t.source};if(yu(e[r])){const u=e[r];e[r]=u.next?.bind(u),e[r+1]=u.error?.bind(u),e[r+2]=u.complete?.bind(u)}let o,a,c;if(n instanceof Pe)a=ot(n.firestore,Ft),c=Ui(n._key.path),o={next:u=>{e[r]&&e[r](Gd(a,n,u))},error:e[r+1],complete:e[r+2]};else{const u=ot(n,jt);a=ot(u.firestore,Ft),c=u._query;const d=new sl(a);o={next:g=>{e[r]&&e[r](new Mn(a,d,u,g))},error:e[r+1],complete:e[r+2]},$d(n._query)}return(function(d,g,y,I){const P=new Ga(I),D=new qa(g,P,y);return d.asyncQueue.enqueueAndForget((async()=>Ba(await bi(d),D))),()=>{P.Nu(),d.asyncQueue.enqueueAndForget((async()=>ja(await bi(d),D)))}})(Qi(a),c,s,o)}function no(n,e){return(function(r,s){const o=new Vt;return r.asyncQueue.enqueueAndForget((async()=>O1(await K1(r),s,o))),o.promise})(Qi(n),e)}function Gd(n,e,t){const r=t.docs.get(e._key),s=new sl(n);return new Vn(n,s,e._key,r,new Kr(t.hasPendingWrites,t.fromCache),e.converter)}function bu(){return new Ka("serverTimestamp")}function h4(...n){return new Qa("arrayUnion",n)}function d4(...n){return new Ya("arrayRemove",n)}(function(e,t=!0){(function(s){_r=s})(mr),sr(new Dn("firestore",((r,{instanceIdentifier:s,options:o})=>{const a=r.getProvider("app").getImmediate(),c=new Ft(new rm(r.getProvider("auth-internal")),new om(a,r.getProvider("app-check-internal")),(function(d,g){if(!Object.prototype.hasOwnProperty.apply(d.options,["projectId"]))throw new B(V.INVALID_ARGUMENT,'"projectId" not provided in firebase.initializeApp.');return new as(d.options.projectId,g)})(a,s),a);return o={useFetchStreams:t,...o},c._setSettings(o),c}),"PUBLIC").setMultipleInstances(!0)),an(Ec,Tc,e),an(Ec,Tc,"esm2020")})();function Wd(){return{"dependent-sdk-initialized-before-auth":"Another Firebase SDK was initialized and is trying to use Auth before Auth is initialized. Please be sure to call `initializeAuth` or `getAuth` before starting any other Firebase SDK."}}const h2=Wd,Kd=new fs("auth","Firebase",Wd());/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const Ci=new pa("@firebase/auth");function d2(n,...e){Ci.logLevel<=he.WARN&&Ci.warn(`Auth (${mr}): ${n}`,...e)}function ii(n,...e){Ci.logLevel<=he.ERROR&&Ci.error(`Auth (${mr}): ${n}`,...e)}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class ws{constructor(e,t){this.shortDelay=e,this.longDelay=t,Ut(t>e,"Short delay should be less than long delay!"),this.isMobile=xp()||Mp()}get(){return g2()?this.isMobile?this.longDelay:this.shortDelay:Math.min(5e3,this.shortDelay)}}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const y2=["/v1/accounts:signInWithCustomToken","/v1/accounts:signInWithEmailLink","/v1/accounts:signInWithIdp","/v1/accounts:signInWithPassword","/v1/accounts:signInWithPhoneNumber","/v1/token"],v2=new ws(3e4,6e4);function $t(n,e){return n.tenantId&&!e.tenantId?{...e,tenantId:n.tenantId}:e}async function qt(n,e,t,r,s={}){return Yd(n,s,async()=>{let o={},a={};r&&(e==="GET"?a=r:o={body:JSON.stringify(r)});const c=ps({key:n.config.apiKey,...a}).slice(1),u=await n._getAdditionalHeaders();u["Content-Type"]="application/json",n.languageCode&&(u["X-Firebase-Locale"]=n.languageCode);const d={method:e,headers:u,...o};return Pp()||(d.referrerPolicy="no-referrer"),n.emulatorConfig&&gr(n.emulatorConfig.host)&&(d.credentials="include"),Qd.fetch()(await Jd(n,n.config.apiHost,t,c),d)})}async function Yd(n,e,t){n._canInitEmulator=!1;const r={..._2,...e};try{const s=new b2(n),o=await Promise.race([t(),s.promise]);s.clearNetworkTimeout();const a=await o.json();if("needConfirmation"in a)throw Gs(n,"account-exists-with-different-credential",a);if(o.ok&&!("errorMessage"in a))return a;{const c=o.ok?a.errorMessage:a.error.message,[u,d]=c.split(" : ");if(u==="FEDERATED_USER_ID_ALREADY_LINKED")throw Gs(n,"credential-already-in-use",a);if(u==="EMAIL_EXISTS")throw Gs(n,"email-already-in-use",a);if(u==="USER_DISABLED")throw Gs(n,"user-disabled",a);const g=r[u]||u.toLowerCase().replace(/[_\s]+/g,"-");if(d)throw ol(n,g,d);ft(n,g)}}catch(s){if(s instanceof Bt)throw s;ft(n,"network-request-failed",{message:String(s)})}}async function bs(n,e,t,r,s={}){const o=await qt(n,e,t,r,s);return"mfaPendingCredential"in o&&ft(n,"multi-factor-auth-required",{_serverResponse:o}),o}async function Jd(n,e,t,r){const s=`${e}${t}?${r}`,o=n,a=o.config.emulator?ll(n.config,s):`${n.config.apiScheme}://${s}`;return y2.includes(t)&&(await o._persistenceManagerAvailable,o._getPersistenceType()==="COOKIE")?o._getPersistence()._getFinalTarget(a).toString():a}function w2(n){switch(n){case"ENFORCE":return"ENFORCE";case"AUDIT":return"AUDIT";case"OFF":return"OFF";default:return"ENFORCEMENT_STATE_UNSPECIFIED"}}class b2{clearNetworkTimeout(){clearTimeout(this.timer)}constructor(e){this.auth=e,this.timer=null,this.promise=new Promise((t,r)=>{this.timer=setTimeout(()=>r(gt(this.auth,"network-request-failed")),v2.get())})}}function Gs(n,e,t){const r={appName:n.name};t.email&&(r.email=t.email),t.phoneNumber&&(r.phoneNumber=t.phoneNumber);const s=gt(n,e,r);return s.customData._tokenResponse=t,s}function Tu(n){return n!==void 0&&n.enterprise!==void 0}class E2{constructor(e){if(this.siteKey="",this.recaptchaEnforcementState=[],e.recaptchaKey===void 0)throw new Error("recaptchaKey undefined");this.siteKey=e.recaptchaKey.split("/")[3],this.recaptchaEnforcementState=e.recaptchaEnforcementState}getProviderEnforcementState(e){if(!this.recaptchaEnforcementState||this.recaptchaEnforcementState.length===0)return null;for(const t of this.recaptchaEnforcementState)if(t.provider&&t.provider===e)return w2(t.enforcementState);return null}isProviderEnabled(e){return this.getProviderEnforcementState(e)==="ENFORCE"||this.getProviderEnforcementState(e)==="AUDIT"}isAnyProviderEnabled(){return this.isProviderEnabled("EMAIL_PASSWORD_PROVIDER")||this.isProviderEnabled("PHONE_PROVIDER")}}async function T2(n,e){return qt(n,"GET","/v2/recaptchaConfig",$t(n,e))}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */async function I2(n,e){return qt(n,"POST","/v1/accounts:delete",e)}async function Ai(n,e){return qt(n,"POST","/v1/accounts:lookup",e)}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */async function hs(n,e,t=!1){if(t)return e;try{return await e}catch(r){throw r instanceof Bt&&A2(r)&&n.auth.currentUser===n&&await n.auth.signOut(),r}}function A2({code:n}){return n==="auth/user-disabled"||n==="auth/user-token-expired"}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */async function Ri(n){const e=n.auth,t=await n.getIdToken(),r=await hs(n,Ai(e,{idToken:t}));ne(r?.users.length,e,"internal-error");const s=r.users[0];n._notifyReloadListener(s);const o=s.providerUserInfo?.length?Xd(s.providerUserInfo):[],a=x2(n.providerData,o),c=n.isAnonymous,u=!(n.email&&s.passwordHash)&&!a?.length,d=c?u:!1,g={uid:s.localId,displayName:s.displayName||null,photoURL:s.photoUrl||null,email:s.email||null,emailVerified:s.emailVerified||!1,phoneNumber:s.phoneNumber||null,tenantId:s.tenantId||null,providerData:a,metadata:new ua(s.createdAt,s.lastLoginAt),isAnonymous:d};Object.assign(n,g)}async function S2(n){const e=je(n);await Ri(e),await e.auth._persistUserIfCurrent(e),e.auth._notifyListenersIfCurrent(e)}function x2(n,e){return[...n.filter(r=>!e.some(s=>s.providerId===r.providerId)),...e]}function Xd(n){return n.map(({providerId:e,...t})=>({providerId:e,uid:t.rawId||"",displayName:t.displayName||null,email:t.email||null,phoneNumber:t.phoneNumber||null,photoURL:t.photoUrl||null}))}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */async function k2(n,e){const t=await Yd(n,{},async()=>{const r=ps({grant_type:"refresh_token",refresh_token:e}).slice(1),{tokenApiHost:s,apiKey:o}=n.config,a=await Jd(n,s,"/v1/token",`key=${o}`),c=await n._getAdditionalHeaders();c["Content-Type"]="application/x-www-form-urlencoded";const u={method:"POST",headers:c,body:r};return n.emulatorConfig&&gr(n.emulatorConfig.host)&&(u.credentials="include"),Qd.fetch()(a,u)});return{accessToken:t.access_token,expiresIn:t.expires_in,refreshToken:t.refresh_token}}async function P2(n,e){return qt(n,"POST","/v2/accounts:revokeToken",$t(n,e))}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function oi(n,e,t){return`firebase:${n}:${e}:${t}`}class nr{constructor(e,t,r){this.persistence=e,this.auth=t,this.userKey=r;const{config:s,name:o}=this.auth;this.fullUserKey=oi(this.userKey,s.apiKey,o),this.fullPersistenceKey=oi("persistence",s.apiKey,o),this.boundEventHandler=t._onStorageEvent.bind(t),this.persistence._addListener(this.fullUserKey,this.boundEventHandler)}setCurrentUser(e){return this.persistence._set(this.fullUserKey,e.toJSON())}async getCurrentUser(){const e=await this.persistence._get(this.fullUserKey);if(!e)return null;if(typeof e=="string"){const t=await Ai(this.auth,{idToken:e}).catch(()=>{});return t?pt._fromGetAccountInfoResponse(this.auth,t,e):null}return pt._fromJSON(this.auth,e)}removeCurrentUser(){return this.persistence._remove(this.fullUserKey)}savePersistenceForRedirect(){return this.persistence._set(this.fullPersistenceKey,this.persistence.type)}async setPersistence(e){if(this.persistence===e)return;const t=await this.getCurrentUser();if(await this.removeCurrentUser(),this.persistence=e,t)return this.setCurrentUser(t)}delete(){this.persistence._removeListener(this.fullUserKey,this.boundEventHandler)}static async create(e,t,r="authUser"){if(!t.length)return new nr(Pt(Au),e,r);const s=(await Promise.all(t.map(async d=>{if(await d._isAvailable())return d}))).filter(d=>d);let o=s[0]||Pt(Au);const a=oi(r,e.config.apiKey,e.name);let c=null;for(const d of t)try{const g=await d._get(a);if(g){let y;if(typeof g=="string"){const I=await Ai(e,{idToken:g}).catch(()=>{});if(!I)break;y=await pt._fromGetAccountInfoResponse(e,I,g)}else y=pt._fromJSON(e,g);d!==o&&(c=y),o=d;break}}catch{}const u=s.filter(d=>d._shouldAllowMigration);return!o._shouldAllowMigration||!u.length?new nr(o,e,r):(o=u[0],c&&await o._set(a,c.toJSON()),await Promise.all(t.map(async d=>{if(d!==o)try{await d._remove(a)}catch{}})),new nr(o,e,r))}}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */async function Z2(n,e){return bs(n,"POST","/v1/accounts:signInWithPassword",$t(n,e))}async function e_(n,e){return qt(n,"POST","/v1/accounts:sendOobCode",$t(n,e))}async function t_(n,e){return e_(n,e)}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */async function n_(n,e){return bs(n,"POST","/v1/accounts:signInWithEmailLink",$t(n,e))}async function r_(n,e){return bs(n,"POST","/v1/accounts:signInWithEmailLink",$t(n,e))}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */async function rr(n,e){return bs(n,"POST","/v1/accounts:signInWithIdp",$t(n,e))}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Tr{constructor(){this.providerId=Tr.PROVIDER_ID}static credential(e,t){return ds._fromEmailAndPassword(e,t)}static credentialWithLink(e,t){const r=dl.parseLink(t);return ne(r,"argument-error"),ds._fromEmailAndCode(e,r.code,r.tenantId)}}Tr.PROVIDER_ID="password";Tr.EMAIL_PASSWORD_SIGN_IN_METHOD="password";Tr.EMAIL_LINK_SIGN_IN_METHOD="emailLink";/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class en extends Es{constructor(){super("facebook.com")}static credential(e){return On._fromParams({providerId:en.PROVIDER_ID,signInMethod:en.FACEBOOK_SIGN_IN_METHOD,accessToken:e})}static credentialFromResult(e){return en.credentialFromTaggedObject(e)}static credentialFromError(e){return en.credentialFromTaggedObject(e.customData||{})}static credentialFromTaggedObject({_tokenResponse:e}){if(!e||!("oauthAccessToken"in e)||!e.oauthAccessToken)return null;try{return en.credential(e.oauthAccessToken)}catch{return null}}}en.FACEBOOK_SIGN_IN_METHOD="facebook.com";en.PROVIDER_ID="facebook.com";/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class St extends Es{constructor(){super("google.com"),this.addScope("profile")}static credential(e,t){return On._fromParams({providerId:St.PROVIDER_ID,signInMethod:St.GOOGLE_SIGN_IN_METHOD,idToken:e,accessToken:t})}static credentialFromResult(e){return St.credentialFromTaggedObject(e)}static credentialFromError(e){return St.credentialFromTaggedObject(e.customData||{})}static credentialFromTaggedObject({_tokenResponse:e}){if(!e)return null;const{oauthIdToken:t,oauthAccessToken:r}=e;if(!t&&!r)return null;try{return St.credential(t,r)}catch{return null}}}St.GOOGLE_SIGN_IN_METHOD="google.com";St.PROVIDER_ID="google.com";/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class tn extends Es{constructor(){super("github.com")}static credential(e){return On._fromParams({providerId:tn.PROVIDER_ID,signInMethod:tn.GITHUB_SIGN_IN_METHOD,accessToken:e})}static credentialFromResult(e){return tn.credentialFromTaggedObject(e)}static credentialFromError(e){return tn.credentialFromTaggedObject(e.customData||{})}static credentialFromTaggedObject({_tokenResponse:e}){if(!e||!("oauthAccessToken"in e)||!e.oauthAccessToken)return null;try{return tn.credential(e.oauthAccessToken)}catch{return null}}}tn.GITHUB_SIGN_IN_METHOD="github.com";tn.PROVIDER_ID="github.com";/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class nn extends Es{constructor(){super("twitter.com")}static credential(e,t){return On._fromParams({providerId:nn.PROVIDER_ID,signInMethod:nn.TWITTER_SIGN_IN_METHOD,oauthToken:e,oauthTokenSecret:t})}static credentialFromResult(e){return nn.credentialFromTaggedObject(e)}static credentialFromError(e){return nn.credentialFromTaggedObject(e.customData||{})}static credentialFromTaggedObject({_tokenResponse:e}){if(!e)return null;const{oauthAccessToken:t,oauthTokenSecret:r}=e;if(!t||!r)return null;try{return nn.credential(t,r)}catch{return null}}}nn.TWITTER_SIGN_IN_METHOD="twitter.com";nn.PROVIDER_ID="twitter.com";/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */async function a_(n,e){return bs(n,"POST","/v1/accounts:signUp",$t(n,e))}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class _f{constructor(e,t){this.storageRetriever=e,this.type=t}_isAvailable(){try{return this.storage?(this.storage.setItem(ki,"1"),this.storage.removeItem(ki),Promise.resolve(!0)):Promise.resolve(!1)}catch{return Promise.resolve(!1)}}_set(e,t){return this.storage.setItem(e,JSON.stringify(t)),Promise.resolve()}_get(e){const t=this.storage.getItem(e);return Promise.resolve(t?JSON.parse(t):null)}_remove(e){return this.storage.removeItem(e),Promise.resolve()}get storage(){return this.storageRetriever()}}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const O_="pendingRedirect",ai=new Map;class F_ extends Af{constructor(e,t,r=!1){super(e,["signInViaRedirect","linkViaRedirect","reauthViaRedirect","unknown"],t,void 0,r),this.eventId=null}async execute(){let e=ai.get(this.auth._key());if(!e){try{const r=await U_(this.resolver,this.auth)?await super.execute():null;e=()=>Promise.resolve(r)}catch(t){e=()=>Promise.reject(t)}ai.set(this.auth._key(),e)}return this.bypassAuthState||ai.set(this.auth._key(),()=>Promise.resolve(null)),e()}async onAuthEvent(e){if(e.type==="signInViaRedirect")return super.onAuthEvent(e);if(e.type==="unknown"){this.resolve(null);return}if(e.eventId){const t=await this.auth._redirectUserForId(e.eventId);if(t)return this.user=t,super.onAuthEvent(e);this.resolve(null)}}async onExecution(){}cleanUp(){}}async function U_(n,e){const t=$_(e),r=j_(n);if(!await r._isAvailable())return!1;const s=await r._get(t)==="true";return await r._remove(t),s}function B_(n,e){ai.set(n._key(),e)}function j_(n){return Pt(n._redirectPersistence)}function $_(n){return oi(O_,n.config.apiKey,n.name)}async function q_(n,e,t=!1){if(lt(n.app))return Promise.reject(Mt(n));const r=zt(n),s=Cf(r,e),a=await new F_(r,s,t).execute();return a&&!t&&(delete a.user._redirectEventId,await r._persistUserIfCurrent(a.user),await r._setRedirectUser(null,e)),a}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const ty=new ws(5e3,15e3),ny="__/auth/iframe",ry="emulator/auth/iframe",sy={style:{position:"absolute",top:"-100px",width:"1px",height:"1px"},"aria-hidden":"true",tabindex:"-1"},iy=new Map([["identitytoolkit.googleapis.com","p"],["staging-identitytoolkit.sandbox.googleapis.com","s"],["test-identitytoolkit.sandbox.googleapis.com","t"]]);function oy(n){const e=n.config;ne(e.authDomain,n,"auth-domain-config-required");const t=e.emulator?ll(e,ry):`https://${n.config.authDomain}/${ny}`,r={apiKey:e.apiKey,appName:n.name,v:mr},s=iy.get(n.config.apiHost);s&&(r.eid=s);const o=n._getFrameworks();return o.length&&(r.fw=o.join(",")),`${t}?${ps(r).slice(1)}`}async function ay(n){const e=await ey(n),t=Ct().gapi;return ne(t,n,"internal-error"),e.open({where:document.body,url:oy(n),messageHandlersFilter:t.iframes.CROSS_ORIGIN_IFRAMES_FILTER,attributes:sy,dontclear:!0},r=>new Promise(async(s,o)=>{await r.restyle({setHideOnLeave:!1});const a=gt(n,"network-request-failed"),c=Ct().setTimeout(()=>{o(a)},ty.get());function u(){Ct().clearTimeout(c),s(r)}r.ping(u).then(u,()=>{o(a)})}))}/**
 * @license
 * Copyright 2020 Google LLC.
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const Iy=300,Cy=ah("authIdTokenMaxAge")||Iy;let Bu=null;const Ay=n=>async e=>{const t=e&&await e.getIdTokenResult(),r=t&&(new Date().getTime()-Date.parse(t.issuedAtTime))/1e3;if(r&&r>Cy)return;const s=t?.token;Bu!==s&&(Bu=s,await fetch(n,{method:s?"POST":"DELETE",headers:s?{Authorization:`Bearer ${s}`}:{}}))};function Ry(n=fh()){const e=ma(n,"auth");if(e.isInitialized())return e.getImmediate();const t=W2(n,{popupRedirectResolver:wy,persistence:[P_,v_,wf]}),r=ah("authTokenSyncURL");if(r&&typeof isSecureContext=="boolean"&&isSecureContext){const o=new URL(r,location.origin);if(location.origin===o.origin){const a=Ay(o.toString());g_(t,a,()=>a(t.currentUser)),p_(t,c=>a(c))}}const s=ih("auth");return s&&Q2(t,`http://${s}`),t}function Sy(){return document.getElementsByTagName("head")?.[0]??document}U2({loadJS(n){return new Promise((e,t)=>{const r=document.createElement("script");r.setAttribute("src",n),r.onload=e,r.onerror=s=>{const o=gt("internal-error");o.customData=s,t(o)},r.type="text/javascript",r.charset="UTF-8",Sy().appendChild(r)})},gapiScript:"https://apis.google.com/js/api.js",recaptchaV2Script:"https://www.google.com/recaptcha/api.js",recaptchaEnterpriseScript:"https://www.google.com/recaptcha/enterprise.js?render="});Ty("Browser");const xy={apiKey:"AIzaSyAaqnWcFLOwmNYoyFgyRCe1z5EhSbDKXRc",authDomain:"empuzzled-3de4d.firebaseapp.com",projectId:"empuzzled-3de4d",storageBucket:"empuzzled-3de4d.firebasestorage.app",messagingSenderId:"984365730335",appId:"1:984365730335:web:19c961e053a66399c92251"},Sf=_c().length===0?dh(xy):_c()[0],xt=X1(Sf),wt=Ry(Sf);var ml={};(function n(e,t,r,s){var o=!!(e.Worker&&e.Blob&&e.Promise&&e.OffscreenCanvas&&e.OffscreenCanvasRenderingContext2D&&e.HTMLCanvasElement&&e.HTMLCanvasElement.prototype.transferControlToOffscreen&&e.URL&&e.URL.createObjectURL),a=typeof Path2D=="function"&&typeof DOMMatrix=="function",c=(function(){if(!e.OffscreenCanvas)return!1;var x=new OffscreenCanvas(1,1),C=x.getContext("2d");C.fillRect(0,0,1,1);var X=x.transferToImageBitmap();try{C.createPattern(X,"no-repeat")}catch{return!1}return!0})();function u(){}function d(x){var C=t.exports.Promise,X=C!==void 0?C:e.Promise;return typeof X=="function"?new X(x):(x(u,u),null)}var g=(function(x,C){return{transform:function(X){if(x)return X;if(C.has(X))return C.get(X);var te=new OffscreenCanvas(X.width,X.height),se=te.getContext("2d");return se.drawImage(X,0,0),C.set(X,te),te},clear:function(){C.clear()}}})(c,new Map),y=(function(){var x=Math.floor(16.666666666666668),C,X,te={},se=0;return typeof requestAnimationFrame=="function"&&typeof cancelAnimationFrame=="function"?(C=function(O){var b=Math.random();return te[b]=requestAnimationFrame(function H(Z){se===Z||se+x-1<Z?(se=Z,delete te[b],O()):te[b]=requestAnimationFrame(H)}),b},X=function(O){te[O]&&cancelAnimationFrame(te[O])}):(C=function(O){return setTimeout(O,x)},X=function(O){return clearTimeout(O)}),{frame:C,cancel:X}})(),I=(function(){var x,C,X={};function te(se){function O(b,H){se.postMessage({options:b||{},callback:H})}se.init=function(H){var Z=H.transferControlToOffscreen();se.postMessage({canvas:Z},[Z])},se.fire=function(H,Z,N){if(C)return O(H,null),C;var K=Math.random().toString(36).slice(2);return C=d(function(G){function Te(Ve){Ve.data.callback===K&&(delete X[K],se.removeEventListener("message",Te),C=null,g.clear(),N(),G())}se.addEventListener("message",Te),O(H,K),X[K]=Te.bind(null,{data:{callback:K}})}),C},se.reset=function(){se.postMessage({reset:!0});for(var H in X)X[H](),delete X[H]}}return function(){if(x)return x;if(!r&&o){var se=["var CONFETTI, SIZE = {}, module = {};","("+n.toString()+")(this, module, true, SIZE);","onmessage = function(msg) {","  if (msg.data.options) {","    CONFETTI(msg.data.options).then(function () {","      if (msg.data.callback) {","        postMessage({ callback: msg.data.callback });","      }","    });","  } else if (msg.data.reset) {","    CONFETTI && CONFETTI.reset();","  } else if (msg.data.resize) {","    SIZE.width = msg.data.resize.width;","    SIZE.height = msg.data.resize.height;","  } else if (msg.data.canvas) {","    SIZE.width = msg.data.canvas.width;","    SIZE.height = msg.data.canvas.height;","    CONFETTI = module.exports.create(msg.data.canvas);","  }","}"].join(`
`);try{x=new Worker(URL.createObjectURL(new Blob([se])))}catch(O){return typeof console!==void 0&&typeof console.warn=="function"&&console.warn("🎊 Could not load worker",O),null}te(x)}return x}})(),P={particleCount:50,angle:90,spread:45,startVelocity:45,decay:.9,gravity:1,drift:0,ticks:200,x:.5,y:.5,shapes:["square","circle"],zIndex:100,colors:["#26ccff","#a25afd","#ff5e7e","#88ff5a","#fcff42","#ffa62d","#ff36ff"],disableForReducedMotion:!1,scalar:1};function D(x,C){return C?C(x):x}function L(x){return x!=null}function A(x,C,X){return D(x&&L(x[C])?x[C]:P[C],X)}function F(x){return x<0?0:Math.floor(x)}function j(x,C){return Math.floor(Math.random()*(C-x))+x}function Y(x){return parseInt(x,16)}function we(x){return x.map(xe)}function xe(x){var C=String(x).replace(/[^0-9a-f]/gi,"");return C.length<6&&(C=C[0]+C[0]+C[1]+C[1]+C[2]+C[2]),{r:Y(C.substring(0,2)),g:Y(C.substring(2,4)),b:Y(C.substring(4,6))}}function ge(x){var C=A(x,"origin",Object);return C.x=A(C,"x",Number),C.y=A(C,"y",Number),C}function T(x){x.width=document.documentElement.clientWidth,x.height=document.documentElement.clientHeight}function m(x){var C=x.getBoundingClientRect();x.width=C.width,x.height=C.height}function _(x){var C=document.createElement("canvas");return C.style.position="fixed",C.style.top="0px",C.style.left="0px",C.style.pointerEvents="none",C.style.zIndex=x,C}function E(x,C,X,te,se,O,b,H,Z){x.save(),x.translate(C,X),x.rotate(O),x.scale(te,se),x.arc(0,0,1,b,H,Z),x.restore()}function w(x){var C=x.angle*(Math.PI/180),X=x.spread*(Math.PI/180);return{x:x.x,y:x.y,wobble:Math.random()*10,wobbleSpeed:Math.min(.11,Math.random()*.1+.05),velocity:x.startVelocity*.5+Math.random()*x.startVelocity,angle2D:-C+(.5*X-Math.random()*X),tiltAngle:(Math.random()*(.75-.25)+.25)*Math.PI,color:x.color,shape:x.shape,tick:0,totalTicks:x.ticks,decay:x.decay,drift:x.drift,random:Math.random()+2,tiltSin:0,tiltCos:0,wobbleX:0,wobbleY:0,gravity:x.gravity*3,ovalScalar:.6,scalar:x.scalar,flat:x.flat}}function R(x,C){C.x+=Math.cos(C.angle2D)*C.velocity+C.drift,C.y+=Math.sin(C.angle2D)*C.velocity+C.gravity,C.velocity*=C.decay,C.flat?(C.wobble=0,C.wobbleX=C.x+10*C.scalar,C.wobbleY=C.y+10*C.scalar,C.tiltSin=0,C.tiltCos=0,C.random=1):(C.wobble+=C.wobbleSpeed,C.wobbleX=C.x+10*C.scalar*Math.cos(C.wobble),C.wobbleY=C.y+10*C.scalar*Math.sin(C.wobble),C.tiltAngle+=.1,C.tiltSin=Math.sin(C.tiltAngle),C.tiltCos=Math.cos(C.tiltAngle),C.random=Math.random()+2);var X=C.tick++/C.totalTicks,te=C.x+C.random*C.tiltCos,se=C.y+C.random*C.tiltSin,O=C.wobbleX+C.random*C.tiltCos,b=C.wobbleY+C.random*C.tiltSin;if(x.fillStyle="rgba("+C.color.r+", "+C.color.g+", "+C.color.b+", "+(1-X)+")",x.beginPath(),a&&C.shape.type==="path"&&typeof C.shape.path=="string"&&Array.isArray(C.shape.matrix))x.fill(Ir(C.shape.path,C.shape.matrix,C.x,C.y,Math.abs(O-te)*.1,Math.abs(b-se)*.1,Math.PI/10*C.wobble));else if(C.shape.type==="bitmap"){var H=Math.PI/10*C.wobble,Z=Math.abs(O-te)*.1,N=Math.abs(b-se)*.1,K=C.shape.bitmap.width*C.scalar,G=C.shape.bitmap.height*C.scalar,Te=new DOMMatrix([Math.cos(H)*Z,Math.sin(H)*Z,-Math.sin(H)*N,Math.cos(H)*N,C.x,C.y]);Te.multiplySelf(new DOMMatrix(C.shape.matrix));var Ve=x.createPattern(g.transform(C.shape.bitmap),"no-repeat");Ve.setTransform(Te),x.globalAlpha=1-X,x.fillStyle=Ve,x.fillRect(C.x-K/2,C.y-G/2,K,G),x.globalAlpha=1}else if(C.shape==="circle")x.ellipse?x.ellipse(C.x,C.y,Math.abs(O-te)*C.ovalScalar,Math.abs(b-se)*C.ovalScalar,Math.PI/10*C.wobble,0,2*Math.PI):E(x,C.x,C.y,Math.abs(O-te)*C.ovalScalar,Math.abs(b-se)*C.ovalScalar,Math.PI/10*C.wobble,0,2*Math.PI);else if(C.shape==="star")for(var ce=Math.PI/2*3,Ke=4*C.scalar,Ze=8*C.scalar,et=C.x,ut=C.y,Re=5,be=Math.PI/Re;Re--;)et=C.x+Math.cos(ce)*Ze,ut=C.y+Math.sin(ce)*Ze,x.lineTo(et,ut),ce+=be,et=C.x+Math.cos(ce)*Ke,ut=C.y+Math.sin(ce)*Ke,x.lineTo(et,ut),ce+=be;else x.moveTo(Math.floor(C.x),Math.floor(C.y)),x.lineTo(Math.floor(C.wobbleX),Math.floor(se)),x.lineTo(Math.floor(O),Math.floor(b)),x.lineTo(Math.floor(te),Math.floor(C.wobbleY));return x.closePath(),x.fill(),C.tick<C.totalTicks}function v(x,C,X,te,se){var O=C.slice(),b=x.getContext("2d"),H,Z,N=d(function(K){function G(){H=Z=null,b.clearRect(0,0,te.width,te.height),g.clear(),se(),K()}function Te(){r&&!(te.width===s.width&&te.height===s.height)&&(te.width=x.width=s.width,te.height=x.height=s.height),!te.width&&!te.height&&(X(x),te.width=x.width,te.height=x.height),b.clearRect(0,0,te.width,te.height),O=O.filter(function(Ve){return R(b,Ve)}),O.length?H=y.frame(Te):G()}H=y.frame(Te),Z=G});return{addFettis:function(K){return O=O.concat(K),N},canvas:x,promise:N,reset:function(){H&&y.cancel(H),Z&&Z()}}}function Ae(x,C){var X=!x,te=!!A(C||{},"resize"),se=!1,O=A(C,"disableForReducedMotion",Boolean),b=o&&!!A(C||{},"useWorker"),H=b?I():null,Z=X?T:m,N=x&&H?!!x.__confetti_initialized:!1,K=typeof matchMedia=="function"&&matchMedia("(prefers-reduced-motion)").matches,G;function Te(ce,Ke,Ze){for(var et=A(ce,"particleCount",F),ut=A(ce,"angle",Number),Re=A(ce,"spread",Number),be=A(ce,"startVelocity",Number),$n=A(ce,"decay",Number),oo=A(ce,"gravity",Number),Is=A(ce,"drift",Number),Cs=A(ce,"colors",we),yn=A(ce,"ticks",Number),Cr=A(ce,"shapes"),As=A(ce,"scalar"),Ar=!!A(ce,"flat"),Rs=ge(ce),Ss=et,qn=[],xs=x.width*Rs.x,vn=x.height*Rs.y;Ss--;)qn.push(w({x:xs,y:vn,angle:ut,spread:Re,startVelocity:be,color:Cs[Ss%Cs.length],shape:Cr[j(0,Cr.length)],ticks:yn,decay:$n,gravity:oo,drift:Is,scalar:As,flat:Ar}));return G?G.addFettis(qn):(G=v(x,qn,Z,Ke,Ze),G.promise)}function Ve(ce){var Ke=O||A(ce,"disableForReducedMotion",Boolean),Ze=A(ce,"zIndex",Number);if(Ke&&K)return d(function(be){be()});X&&G?x=G.canvas:X&&!x&&(x=_(Ze),document.body.appendChild(x)),te&&!N&&Z(x);var et={width:x.width,height:x.height};H&&!N&&H.init(x),N=!0,H&&(x.__confetti_initialized=!0);function ut(){if(H){var be={getBoundingClientRect:function(){if(!X)return x.getBoundingClientRect()}};Z(be),H.postMessage({resize:{width:be.width,height:be.height}});return}et.width=et.height=null}function Re(){G=null,te&&(se=!1,e.removeEventListener("resize",ut)),X&&x&&(document.body.contains(x)&&document.body.removeChild(x),x=null,N=!1)}return te&&!se&&(se=!0,e.addEventListener("resize",ut,!1)),H?H.fire(ce,et,Re):Te(ce,et,Re)}return Ve.reset=function(){H&&H.reset(),G&&G.reset()},Ve}var De;function Rt(){return De||(De=Ae(null,{useWorker:!0,resize:!0})),De}function Ir(x,C,X,te,se,O,b){var H=new Path2D(x),Z=new Path2D;Z.addPath(H,new DOMMatrix(C));var N=new Path2D;return N.addPath(Z,new DOMMatrix([Math.cos(b)*se,Math.sin(b)*se,-Math.sin(b)*O,Math.cos(b)*O,X,te])),N}function Ht(x){if(!a)throw new Error("path confetti are not supported in this browser");var C,X;typeof x=="string"?C=x:(C=x.path,X=x.matrix);var te=new Path2D(C),se=document.createElement("canvas"),O=se.getContext("2d");if(!X){for(var b=1e3,H=b,Z=b,N=0,K=0,G,Te,Ve=0;Ve<b;Ve+=2)for(var ce=0;ce<b;ce+=2)O.isPointInPath(te,Ve,ce,"nonzero")&&(H=Math.min(H,Ve),Z=Math.min(Z,ce),N=Math.max(N,Ve),K=Math.max(K,ce));G=N-H,Te=K-Z;var Ke=10,Ze=Math.min(Ke/G,Ke/Te);X=[Ze,0,0,Ze,-Math.round(G/2+H)*Ze,-Math.round(Te/2+Z)*Ze]}return{type:"path",path:C,matrix:X}}function Gt(x){var C,X=1,te="#000000",se='"Apple Color Emoji", "Segoe UI Emoji", "Segoe UI Symbol", "Noto Color Emoji", "EmojiOne Color", "Android Emoji", "Twemoji Mozilla", "system emoji", sans-serif';typeof x=="string"?C=x:(C=x.text,X="scalar"in x?x.scalar:X,se="fontFamily"in x?x.fontFamily:se,te="color"in x?x.color:te);var O=10*X,b=""+O+"px "+se,H=new OffscreenCanvas(O,O),Z=H.getContext("2d");Z.font=b;var N=Z.measureText(C),K=Math.ceil(N.actualBoundingBoxRight+N.actualBoundingBoxLeft),G=Math.ceil(N.actualBoundingBoxAscent+N.actualBoundingBoxDescent),Te=2,Ve=N.actualBoundingBoxLeft+Te,ce=N.actualBoundingBoxAscent+Te;K+=Te+Te,G+=Te+Te,H=new OffscreenCanvas(K,G),Z=H.getContext("2d"),Z.font=b,Z.fillStyle=te,Z.fillText(C,Ve,ce);var Ke=1/X;return{type:"bitmap",bitmap:H.transferToImageBitmap(),matrix:[Ke,0,0,Ke,-K*Ke/2,-G*Ke/2]}}t.exports=function(){return Rt().apply(this,arguments)},t.exports.reset=function(){Rt().reset()},t.exports.create=Ae,t.exports.shapeFromPath=Ht,t.exports.shapeFromText=Gt})((function(){return typeof window<"u"?window:typeof self<"u"?self:this||{}})(),ml,!1);const Ws=ml.exports;ml.exports.create;const ju=["SUMMONSGREETINGS2025","XMAS2025","HAPPY2026"],$u=ae(ju[Math.floor(Math.random()*ju.length)]),xf=()=>{const n=["❄️","🎁","🎅","🎄","🍪","🥛","⛄","🌟","🧣","🧤","⛸️","🏔️","🌬️","🧊"],e=(r=!1,s)=>{const u=(s||["❄️","❄️","❄️","❄️","❄️","❄️","❅","❅","❆","❆","🧊","🧊","🧊","🎁","🎁","🎁","🎄","⛄","🌟","☃️","🧣","🧤","🍪","🥛","🌬️","🌲","🏔️","⛸️"]).map(y=>{try{return Ws.shapeFromText({text:y,scalar:3})}catch{return"circle"}}),d=(y,I)=>Math.random()*(I-y)+y,g=["#ffffff","#bae6fd","#60a5fa","#38bdf8","#fef3c7"];if(r){const I=Date.now()+4e3,P=ap(()=>{const D=I-Date.now();if(D<=0)return clearInterval(P);const L=15*(D/4e3);Ws({particleCount:L,spread:100,origin:{x:d(.1,.3),y:Math.random()-.2},scalar:3,shapes:u,ticks:150,gravity:.6,colors:g,zIndex:200}),Ws({particleCount:L,spread:100,origin:{x:d(.7,.9),y:Math.random()-.2},scalar:3,shapes:u,ticks:150,gravity:.6,colors:g,zIndex:200})},250)}else Ws({particleCount:40,spread:90,origin:{x:.5,y:.4},scalar:3,shapes:u,ticks:250,gravity:.6,colors:g,zIndex:200})};async function t(){try{const r=Ti(Wa(xt,"codes"),qd("status","==","holiday"),Ii(1)),s=await il(r);if(!s.empty){const o=s.docs[0].data();$u.value=o.code}}catch(r){console.error("Error fetching holiday code:",r)}}return{winterCode:$u,holidayIcons:n,fireHolidayConfetti:e,fetchHolidayCode:t}};function qu(n,e){return q(),Q("svg",{xmlns:"http://www.w3.org/2000/svg",fill:"none",viewBox:"0 0 24 24","stroke-width":"1.5",stroke:"currentColor","aria-hidden":"true","data-slot":"icon"},[f("path",{"stroke-linecap":"round","stroke-linejoin":"round",d:"M4.26 10.147a60.438 60.438 0 0 0-.491 6.347A48.62 48.62 0 0 1 12 20.904a48.62 48.62 0 0 1 8.232-4.41 60.46 60.46 0 0 0-.491-6.347m-15.482 0a50.636 50.636 0 0 0-2.658-.813A59.906 59.906 0 0 1 12 3.493a59.903 59.903 0 0 1 10.399 5.84c-.896.248-1.783.52-2.658.814m-15.482 0A50.717 50.717 0 0 1 12 13.489a50.702 50.702 0 0 1 7.74-3.342M6.75 15a.75.75 0 1 0 0-1.5.75.75 0 0 0 0 1.5Zm0 0v-3.675A55.378 55.378 0 0 1 12 8.443m-7.007 11.55A5.981 5.981 0 0 0 6.75 15.75v-1.5"})])}function ky(n,e){return q(),Q("svg",{xmlns:"http://www.w3.org/2000/svg",fill:"none",viewBox:"0 0 24 24","stroke-width":"1.5",stroke:"currentColor","aria-hidden":"true","data-slot":"icon"},[f("path",{"stroke-linecap":"round","stroke-linejoin":"round",d:"M15.75 9V5.25A2.25 2.25 0 0 0 13.5 3h-6a2.25 2.25 0 0 0-2.25 2.25v13.5A2.25 2.25 0 0 0 7.5 21h6a2.25 2.25 0 0 0 2.25-2.25V15m3 0 3-3m0 0-3-3m3 3H9"})])}function Py(n,e){return q(),Q("svg",{xmlns:"http://www.w3.org/2000/svg",fill:"none",viewBox:"0 0 24 24","stroke-width":"1.5",stroke:"currentColor","aria-hidden":"true","data-slot":"icon"},[f("path",{"stroke-linecap":"round","stroke-linejoin":"round",d:"M3.75 6.75h16.5M3.75 12h16.5m-16.5 5.25h16.5"})])}function zu(n,e){return q(),Q("svg",{xmlns:"http://www.w3.org/2000/svg",fill:"none",viewBox:"0 0 24 24","stroke-width":"1.5",stroke:"currentColor","aria-hidden":"true","data-slot":"icon"},[f("path",{"stroke-linecap":"round","stroke-linejoin":"round",d:"m3.75 13.5 10.5-11.25L12 10.5h8.25L9.75 21.75 12 13.5H3.75Z"})])}function Vy(n,e){return q(),Q("svg",{xmlns:"http://www.w3.org/2000/svg",fill:"none",viewBox:"0 0 24 24","stroke-width":"1.5",stroke:"currentColor","aria-hidden":"true","data-slot":"icon"},[f("path",{"stroke-linecap":"round","stroke-linejoin":"round",d:"m4.5 15.75 7.5-7.5 7.5 7.5"})])}function My(n,e){return q(),Q("svg",{xmlns:"http://www.w3.org/2000/svg",fill:"none",viewBox:"0 0 24 24","stroke-width":"1.5",stroke:"currentColor","aria-hidden":"true","data-slot":"icon"},[f("path",{"stroke-linecap":"round","stroke-linejoin":"round",d:"M21 11.25v8.25a1.5 1.5 0 0 1-1.5 1.5H5.25a1.5 1.5 0 0 1-1.5-1.5v-8.25M12 4.875A2.625 2.625 0 1 0 9.375 7.5H12m0-2.625V7.5m0-2.625A2.625 2.625 0 1 1 14.625 7.5H12m0 0V21m-8.625-9.75h18c.621 0 1.125-.504 1.125-1.125v-1.5c0-.621-.504-1.125-1.125-1.125h-18c-.621 0-1.125.504-1.125 1.125v1.5c0 .621.504 1.125 1.125 1.125Z"})])}function Hu(n,e){return q(),Q("svg",{xmlns:"http://www.w3.org/2000/svg",fill:"none",viewBox:"0 0 24 24","stroke-width":"1.5",stroke:"currentColor","aria-hidden":"true","data-slot":"icon"},[f("path",{"stroke-linecap":"round","stroke-linejoin":"round",d:"m2.25 15.75 5.159-5.159a2.25 2.25 0 0 1 3.182 0l5.159 5.159m-1.5-1.5 1.409-1.409a2.25 2.25 0 0 1 3.182 0l2.909 2.909m-18 3.75h16.5a1.5 1.5 0 0 0 1.5-1.5V6a1.5 1.5 0 0 0-1.5-1.5H3.75A1.5 1.5 0 0 0 2.25 6v12a1.5 1.5 0 0 0 1.5 1.5Zm10.5-11.25h.008v.008h-.008V8.25Zm.375 0a.375.375 0 1 1-.75 0 .375.375 0 0 1 .75 0Z"})])}function Lo(n,e){return q(),Q("svg",{xmlns:"http://www.w3.org/2000/svg",fill:"none",viewBox:"0 0 24 24","stroke-width":"1.5",stroke:"currentColor","aria-hidden":"true","data-slot":"icon"},[f("path",{"stroke-linecap":"round","stroke-linejoin":"round",d:"M15.75 6a3.75 3.75 0 1 1-7.5 0 3.75 3.75 0 0 1 7.5 0ZM4.501 20.118a7.5 7.5 0 0 1 14.998 0A17.933 17.933 0 0 1 12 21.75c-2.676 0-5.216-.584-7.499-1.632Z"})])}function Dy(n,e){return q(),Q("svg",{xmlns:"http://www.w3.org/2000/svg",fill:"none",viewBox:"0 0 24 24","stroke-width":"1.5",stroke:"currentColor","aria-hidden":"true","data-slot":"icon"},[f("path",{"stroke-linecap":"round","stroke-linejoin":"round",d:"M6 18 18 6M6 6l12 12"})])}const Ny={class:"holiday-gift group relative overflow-hidden rounded-2xl bg-slate-900/60 backdrop-blur-xl border border-cyan-400/30 shadow-2xl transition-all duration-500 max-h-[90vh] overflow-y-auto custom-scrollbar select-none"},Ly={class:"absolute -top-3 -right-10 w-48 md:w-80 opacity-30 md:opacity-40 pointer-events-none transform -rotate-12 transition-all duration-1000 group-hover:scale-110 group-hover:-rotate-6 group-active:scale-110 group-active:-rotate-6 not-prose"},Oy=["src"],Fy={class:"absolute -top-6 -left-6 w-40 md:w-72 opacity-20 md:opacity-30 pointer-events-none transform rotate-12 transition-all duration-1000 group-hover:scale-110 group-hover:rotate-6 group-active:scale-110 group-active:rotate-6 not-prose"},Uy=["src"],By={class:"relative z-10 pt-8 pb-4 px-4 flex flex-col items-center text-center border-b border-white/5 mb-4"},jy={class:"transform transition-transform duration-500 group-hover/icon:rotate-12 group-active/icon:scale-75 inline-block pointer-events-none"},$y={class:"relative z-10 flex flex-col gap-12 pb-12"},qy={key:0,class:"gift-section flex flex-col items-center px-4 md:px-10"},zy={class:"mb-4 flex items-center gap-3"},Hy={class:"text-[10px] font-black uppercase tracking-[0.3em] text-cyan-400 drop-shadow-[0_0_8px_rgba(34,211,238,0.5)]"},Gy={class:"flex flex-wrap items-center justify-center gap-1.5 sm:gap-2 mb-6 max-w-xl mx-auto"},Wy=["onClick","title"],Ky=["src","alt"],Qy={class:"text-xs sm:text-sm font-black text-white"},Yy={key:1,class:"jiggle-wiggle pointer-events-none"},Jy={class:"mb-4 w-full max-w-sm"},Xy={class:"text-[16px] md:text-2xl font-mono font-black text-yellow-400 tracking-wider drop-shadow-[0_0_10px_rgba(250,204,21,0.3)] group-hover:text-yellow-300 transition-colors pointer-events-none uppercase"},Zy={key:0,class:"absolute inset-0 flex items-center justify-center bg-cyan-600/90 rounded-xl text-white font-black uppercase tracking-widest text-xs md:text-sm backdrop-blur-sm"},ev={class:"absolute bottom-10 -right-16 w-48 md:w-80 opacity-30 md:opacity-40 pointer-events-none transform -rotate-12 transition-all duration-1000 group-hover:scale-110 group-hover:-rotate-6 group-active:scale-110 group-active:-rotate-6 not-prose"},tv=["src"],nv={class:"absolute bottom-40 -left-16 w-48 md:w-80 opacity-30 md:opacity-40 pointer-events-none transform -rotate-12 transition-all duration-1000 group-hover:scale-110 group-hover:-rotate-6 group-active:scale-110 group-active:-rotate-6 not-prose"},rv=["src"],jr="https://raw.githubusercontent.com/vabe44/31f5d518-epzl-cdn/main",sv=fr({__name:"HolidayGift",props:{code:{}},setup(n){const e=n,{holidayIcons:t,fireHolidayConfetti:r}=xf(),s=ae("❄️"),o=ae(null),a=lc({}),c=lc({}),u={SUMMONSGREETINGS2025:[{id:"gems",name:"Gems",quantity:25,image:"symbol_gem.webp",emojis:["💎"]},{id:"tickets",name:"Loot Tickets",quantity:12,image:"loot_ticket.webp",emojis:["🎟"]},{id:"hurricanes",name:"Hurricanes",quantity:20,image:"titan_battle_hurricane.webp",emojis:["🌀"]},{id:"harpoons",name:"Giant Harpoons",quantity:25,image:"titan_battle_giant_harpoon.webp",emojis:["🔱"]}],XMAS2025:[{id:"avatars",name:"Avatars",quantity:2,image:"profile_avatar.webp",emojis:["👤","🎅"]},{id:"covenant",name:"Covenant Coins",quantity:100,image:"covenant_coin.webp",emojis:["🪙"]},{id:"aethers",name:"Aether Shards",quantity:10,image:"aether_crystal.webp",emojis:["💎"]},{id:"dragon",name:"Ancient Dragon Coins",quantity:100,image:"ancient_dragon_coin.webp",emojis:["🐉"]},{id:"energy",name:"World Energy Flask",quantity:1,image:"energy_pve_full.webp",emojis:["⚡"]}],HAPPY2026:[{id:"avatar",name:"Avatar",quantity:1,image:"profile_avatar.webp",emojis:["👤"]},{id:"tickets",name:"Loot Tickets",quantity:5,image:"loot_ticket.webp",emojis:["🎟"]},{id:"untold",name:"Untold Tales Coins",quantity:50,image:"coin_untold_tales.webp",emojis:["📖"]}]},d=A=>A==="SUMMONSGREETINGS2025"?"December Greeting":A==="XMAS2025"?"Christmas Special":A==="HAPPY2026"?"New Year Countdown":"Limited Reward",g=(A,F)=>a[A]?.[F]||!1,y=()=>{const A=t.filter(F=>F!==s.value);s.value=A[Math.floor(Math.random()*A.length)]},I=()=>{r(!1,[s.value]),y()},P=(A,F,j)=>{a[A]||(a[A]={}),a[A][F]||(a[A][F]=!0),r(!1,j)},D=A=>{navigator.clipboard.writeText(A).then(()=>{c[A]=!0,setTimeout(()=>{c[A]=!1},2e3)})},L=A=>{D(A),r(!0),setTimeout(()=>{window.open(`https://www.empiresandpuzzles.com/redeem?code=${A}`,"_blank")},1e3)};return Mi(()=>{s.value=t[Math.floor(Math.random()*t.length)];const A=Object.keys(u);e.code&&u[e.code]?o.value=e.code:o.value=A[Math.floor(Math.random()*A.length)]}),(A,F)=>(q(),Q("div",Ny,[F[8]||(F[8]=f("div",{class:"absolute inset-0 bg-[url('https://www.transparenttextures.com/patterns/snow.png')] opacity-10 pointer-events-none sticky top-0 h-full"},null,-1)),f("div",Ly,[f("img",{src:`${jr}/avatar/christmas_carol.webp`,alt:"",class:"w-full h-auto"},null,8,Oy)]),f("div",Fy,[f("img",{src:`${jr}/avatar/christmas_ginger_costume_gift_wrapper.webp`,alt:"",class:"w-full h-auto"},null,8,Uy)]),f("div",By,[f("div",{onClick:I,class:"holiday-icon-toggle animate-holiday-float group/icon w-16 h-16 md:w-20 md:h-20 bg-gradient-to-br from-blue-500 to-cyan-600 rounded-full flex items-center justify-center text-3xl md:text-4xl shadow-[0_0_20px_rgba(59,130,246,0.5)] cursor-pointer hover:shadow-[0_0_30px_rgba(59,130,246,0.8)] transition-all duration-300 active:scale-90 select-none mb-4",title:"Click for a surprise!"},[f("span",jy,qe(s.value),1)]),F[2]||(F[2]=lp('<h2 class="text-[30px] md:text-5xl font-black py-2 mb-2 tracking-tighter bg-gradient-to-b from-white via-cyan-100 to-blue-500 bg-clip-text text-transparent drop-shadow-[0_0_25px_rgba(59,130,246,0.8)] leading-tight not-prose" data-v-9b1372fc> Happy Winter Holidays! </h2><div class="space-y-0 text-center max-w-lg" data-v-9b1372fc><p class="text-base md:text-lg text-slate-300 leading-relaxed m-0" data-v-9b1372fc> Warmest greetings from <span class="text-yellow-400 font-bold" data-v-9b1372fc>Small Giant</span> and the <span class="text-cyan-400 font-bold" data-v-9b1372fc>Empuzzled</span> team! </p><p class="text-base md:text-lg text-slate-300 leading-relaxed m-0" data-v-9b1372fc>Scroll down to unwrap all your special gifts.</p></div>',2))]),f("div",$y,[o.value?(q(),Q("div",qy,[f("div",zy,[F[3]||(F[3]=f("div",{class:"h-px w-8 md:w-16 bg-gradient-to-r from-transparent to-cyan-500/50"},null,-1)),f("span",Hy,qe(d(o.value)),1),F[4]||(F[4]=f("div",{class:"h-px w-8 md:w-16 bg-gradient-to-l from-transparent to-cyan-500/50"},null,-1))]),F[7]||(F[7]=f("span",{class:"block text-[10px] uppercase tracking-[0.2em] text-slate-500 mb-4 font-black"},"Click to Unwrap Rewards",-1)),f("div",Gy,[(q(!0),Q(ns,null,ci(u[o.value],j=>(q(),Q("div",{key:j.id,onClick:Y=>P(o.value,j.id,j.emojis),class:"bg-black/40 rounded-xl p-1.5 sm:p-2 border border-white/5 flex items-center gap-1 sm:gap-2 group/reward hover:border-cyan-400/30 transition-all cursor-pointer active:scale-95 not-prose min-w-[65px] sm:min-w-[85px] justify-center h-11 sm:h-14 select-none",title:g(o.value,j.id)?`Click for a ${j.name} rain!`:"Click to unwrap!"},[g(o.value,j.id)?(q(),Q(ns,{key:0},[f("img",{src:`${jr}/items/${j.image}`,class:ue(["h-8 w-8 sm:h-10 sm:w-10 object-contain pointer-events-none",{"bg-black rounded-full":j.image==="profile_avatar.webp"}]),alt:j.name},null,10,Ky),f("span",Qy,"x"+qe(j.quantity),1)],64)):(q(),Q("div",Yy,[$(W(My),{class:"h-6 w-6 sm:h-8 sm:w-8 text-red-500 drop-shadow-[0_0_8px_rgba(239,68,68,0.4)]"})]))],8,Wy))),128))]),f("div",Jy,[F[5]||(F[5]=f("span",{class:"block text-[10px] text-center uppercase tracking-[0.2em] text-slate-500 mb-1 font-black"},"Code",-1)),f("div",{onClick:F[0]||(F[0]=j=>D(o.value)),class:"relative text-center bg-black/40 backdrop-blur-md border border-white/10 rounded-xl p-3 group transition-all hover:border-cyan-400/50 cursor-pointer active:scale-95 transform-gpu select-none",title:"Click to copy"},[f("span",Xy,qe(o.value),1),$(eh,{name:"fade"},{default:J(()=>[c[o.value]?(q(),Q("div",Zy," Copied! ")):Ue("",!0)]),_:1})])]),f("button",{onClick:F[1]||(F[1]=j=>L(o.value)),class:"w-full max-w-sm px-2 md:px-10 py-3 bg-gradient-to-r from-blue-700 via-blue-600 to-blue-700 hover:from-blue-600 hover:via-blue-500 hover:to-blue-600 text-white font-black uppercase tracking-widest rounded-xl shadow-[0_0_20px_rgba(34,211,238,0.3)] transition-all hover:scale-105 active:scale-95 flex items-center justify-center gap-3 group cursor-pointer border border-white/20 relative overflow-hidden"},[...F[6]||(F[6]=[f("div",{class:"absolute inset-0 bg-[url('https://www.transparenttextures.com/patterns/snow.png')] opacity-10 pointer-events-none"},null,-1),f("span",{class:"flex items-center gap-2 drop-shadow-[0_2px_3px_rgba(0,0,0,0.5)] text-xs md:text-sm"},[f("span",{class:"text-lg animate-pulse group-hover:rotate-12 transition-transform"},"🎁"),me(" Redeem ")],-1)])])])):Ue("",!0)]),f("div",ev,[f("img",{src:`${jr}/avatar/christmas_noel.webp`,alt:"",class:"w-full h-auto"},null,8,tv)]),f("div",nv,[f("img",{src:`${jr}/avatar/christmas_augustus.webp`,alt:"",class:"w-full h-auto"},null,8,rv)])]))}}),kf=Object.assign(pr(sv,[["__scopeId","data-v-9b1372fc"]]),{__name:"HolidayGift"}),f4=Object.freeze(Object.defineProperty({__proto__:null,default:kf},Symbol.toStringTag,{value:"Module"})),iv=fr({__name:"BaseTooltip",props:{style:{type:Object,default:()=>({})}},setup(n){const e=n,t=st(()=>e.style);return(r,s)=>(q(),Q("span",cp({class:"base-tooltip text-sm md:text-[1.05rem] px-[0.45rem] py-[0.3rem] md:px-[1.1rem] md:py-[0.45rem]",style:t.value,role:"tooltip"},r.$attrs),[fa(r.$slots,"default",{},void 0,!0)],16))}}),nt=Object.assign(pr(iv,[["__scopeId","data-v-7d80316b"]]),{__name:"BaseTooltip"}),ts=ae([]),Pf=ae({}),Vf=ae([]),Mf=ae({}),Df=ae({}),da=ae(!0),Nf=ae(null);let Gu=!1;const ov=async()=>{if(!(Gu||ts.value.length>0)){Gu=!0;try{const e=await(await fetch("https://raw.githubusercontent.com/vabe44/31f5d518-epzl-cdn/main/assets/cached_configurations/characters.json")).json(),t=Object.values(e.charactersConfig.heroes),o=(await(await fetch("https://raw.githubusercontent.com/vabe44/31f5d518-epzl-cdn/main/assets/languages/English")).text()).split(`
`).slice(1),a={},c={},u={};for(const A of o){const F=A.split(",");if(F.length>=2){const j=F[0]?F[0].trim().replace(/"/g,""):"",Y=F.slice(1).join(",").trim().replace(/"/g,"");j&&Y&&(j.startsWith("heroes.name.")||j.startsWith("heroes.name_fancy.")||j.startsWith("specials.name."))?a[j]=Y:j&&Y&&j.startsWith("herocard.family.title.")?c[j.replace("herocard.family.title.","")]=Y:j&&Y&&j.startsWith("limitbreak.gift.title.")&&(u[j.replace("limitbreak.gift.title.","")]=Y)}}Pf.value=c,Df.value=u;const d=e.charactersConfig.heroes,y=await(await fetch("https://raw.githubusercontent.com/vabe44/31f5d518-epzl-cdn/main/assets/heroes_audio_map.json")).json(),P=await(await fetch("https://raw.githubusercontent.com/vabe44/31f5d518-epzl-cdn/main/assets/data_en.json")).json();Mf.value=P.family_values||{},Vf.value=P.families_bonus||[];const D=new Set(P.allHeroes.map(A=>A.name)),L=new Map;for(const A of P.allHeroes){const F=A.name+" C1";A.hasCostume=D.has(F),L.set(A.heroId,A)}ts.value=t.map(A=>{const F=A.specialId;let j=A.specialId;if(A.parentHeroId){const w=d[A.parentHeroId];w&&(j=w.specialId)}const Y=`heroes.name.${A.id}`,we=`heroes.name_fancy.${A.id}`,xe=`specials.name.${j}`,ge=A.canBeReceivedDate??549590400,T=new Date("2000-01-01T00:00:00Z").getTime(),m=new Date(T+ge*1e3),_=y[A.id]||[],E=L.get(A.id);return{...A,costume:!!A.parentHeroId,trainer:!!A.trainerType,specialId:j,specialImageId:F,name:a[Y]||E?.name||A.id,fancyName:a[we],specialName:a[xe],canBeReceivedDateParsed:m,specialAudioFiles:_,heroData:E||null}}),da.value=!1}catch(n){console.log("Error fetching heroes:",n),Nf.value=n,da.value=!1}}};function av(){const n=ae(!1),e=ae(!1),t=st(()=>{let d=ts.value;return n.value||(d=d.filter(g=>!g.costume)),e.value||(d=d.filter(g=>!g.trainer)),d}),r=st(()=>ts.value),s=st(()=>{const d=new Map;return ts.value.forEach(g=>{d.set(g.id,g)}),d}),o=st(()=>Pf.value),a=st(()=>Df.value),c=st(()=>Vf.value),u=st(()=>Mf.value);return Mi(ov),{heroesAll:r,heroesById:s,heroes:t,loading:da,error:Nf,showCostumes:n,familiesAll:o,aetherGiftsAll:a,familiesBonusAll:c,familiesValuesAll:u}}const Wu=ae(null),Oo=ae([]),$r=ae(!1);function _l(){const{heroesAll:n,loading:e}=av(),t=(c,u)=>{const d=u.filter(D=>D.claimed),g=d.length,y=d.reduce((D,L)=>{const A=n.value.find(F=>F.id===L.answerId);if(A&&A.heroData){const F=A.heroData.lb2||A.heroData.lb1||A.heroData;return D+(F.power||0)+125}return D},0),I=u.length,P=u.filter(D=>D.won).length;return{totalPower:y,claimedCount:g,gamesPlayed:I,gamesWon:P}},r=async(c,u)=>{const d=wt.currentUser;if(!d)return u;if(n.value.length===0||e.value){let P=0;for(;(n.value.length===0||e.value)&&P<20;)await new Promise(D=>setTimeout(D,500)),P++}const g=xn(xt,"users",d.uid),y=xn(xt,"users",d.uid,"gameData",c),I=xn(xt,"leaderboard",d.uid);try{$r.value=!0;const P=await ri(g),D=P.exists()?P.data():{stats:{}},L=D.displayName||d.displayName||"Hero",A=D.photoURL||d.photoURL||"",F=await ri(y);let j=[];F.exists()&&(j=F.data().results||[]);const Y=[...j];u.forEach(_=>{const E=Y.findIndex(w=>w.gameDocId===_.gameDocId&&w.difficulty===_.difficulty);E===-1?Y.push(_):((_.won&&!Y[E].won||_.claimed&&!Y[E].claimed)&&(Y[E]={...Y[E],..._}),_.guessesHistory?.length>(Y[E].guessesHistory?.length||0)&&(Y[E].guessesHistory=_.guessesHistory,Y[E].guesses=_.guesses))}),await si(y,{results:Y},{merge:!0});const we=t(c,Y),xe=["shadow","classic","skill"].filter(_=>_!==c);let ge=we.totalPower;xe.forEach(_=>{ge+=D.stats?.[_]?.totalPower||0});const T={displayName:L,photoURL:A,lastUpdated:bu(),totalPowerScore:ge,stats:{[c]:we}};await si(g,T,{merge:!0});const m={uid:d.uid,displayName:L,photoURL:A,lastUpdated:bu(),totalPowerScore:ge,stats:{[c]:{totalPower:we.totalPower,claimedCount:we.claimedCount}}};return await si(I,m,{merge:!0}),Y}catch(P){return console.error(`Error syncing ${c} results:`,P),u}finally{$r.value=!1}},s=async()=>{if(!wt.currentUser)return;const c=["shadow","classic","skill"];for(const u of c){const d=localStorage.getItem(`${u}ModeResults`);if(d)try{const g=JSON.parse(d);await r(u,g)}catch(g){console.error(`Error parsing local results for ${u}:`,g)}else await r(u,[])}await o()},o=async()=>{const c=wt.currentUser;if(c)try{const u=xn(xt,"users",c.uid),d=await ri(u);d.exists()&&(Wu.value=d.data())}catch(u){console.error("Error fetching profile:",u)}};return{profile:Wu,leaderboard:Oo,loading:$r,syncGameResults:r,syncAllModes:s,fetchProfile:o,calculateStats:t,fetchLeaderboard:async(c="shadow",u=20)=>{try{$r.value=!0,Oo.value=[];const d=Wa(xt,"leaderboard");let g;c==="global"?g=Ti(d,la("totalPowerScore","desc"),Ii(u)):g=Ti(d,la(`stats.${c}.totalPower`,"desc"),Ii(u));const y=await il(g),I=[];y.forEach(P=>{I.push({uid:P.id,...P.data()})}),Oo.value=I}catch(d){console.error("Error fetching leaderboard:",d)}finally{$r.value=!1}}}}const Fo=ae(null),Ku=ae(!0),lv=ae(!1);let Qu=!1;function yl(){const{syncAllModes:n}=_l();return!Qu&&typeof window<"u"&&(Qu=!0,mf(wt,async e=>{Fo.value=e,e&&await n(),Ku.value=!1})),{user:Fo,loading:Ku,isAuthenticated:st(()=>!!Fo.value),showLoginModal:lv}}const Lf="classicModeResults",Cn=ae([]),Yu=ae({rare:[],epic:[],legendary:[]});function Ju(){if(typeof window>"u")return[];const n=localStorage.getItem(Lf);if(!n)return[];try{return JSON.parse(n)}catch{return[]}}function Ks(n){typeof window>"u"||localStorage.setItem(Lf,JSON.stringify(n))}function cv(){const{isAuthenticated:n}=yl(),{syncGameResults:e}=_l(),t=async s=>{let o=Ju();Cn.value=o,n.value&&(o=await e("classic",o),Cn.value=o,Ks(o));for(const a of["rare","epic","legendary"]){const c=o.find(u=>u.difficulty===a&&u.gameDocId===s&&!u.finished);Yu.value[a]=c?c.guessesHistory.map(u=>({id:u})):[]}},r=async(s,o=!1)=>{const a=[...Cn.value],c=a.findIndex(u=>u.gameDocId===s.gameDocId&&u.difficulty===s.difficulty);if(o&&c!==-1&&a[c]!==void 0&&!a[c].finished||c!==-1?a[c]=s:a.push(s),Cn.value=a,Ks(a),n.value){const u=await e("classic",a);Cn.value=u,Ks(u)}};return Vi(n,async s=>{if(s){const o=Ju(),a=await e("classic",o);Cn.value=a,Ks(a)}}),{classicResults:Cn,guessesByDifficulty:Yu,initializeClassicGameState:t,saveClassicGameResult:r}}const Of="shadowModeResults",An=ae([]),Xu=ae({rare:[],epic:[],legendary:[]});function Zu(){if(typeof window>"u")return[];const n=localStorage.getItem(Of);if(!n)return[];try{return JSON.parse(n)}catch{return[]}}function Qs(n){typeof window>"u"||localStorage.setItem(Of,JSON.stringify(n))}function uv(){const{isAuthenticated:n}=yl(),{syncGameResults:e}=_l(),t=async s=>{let o=Zu();An.value=o,n.value&&(o=await e("shadow",o),An.value=o,Qs(o));for(const a of["rare","epic","legendary"]){const c=o.find(u=>u.difficulty===a&&u.gameDocId===s&&!u.finished);Xu.value[a]=c?c.guessesHistory.map(u=>({id:u})):[]}},r=async(s,o=!1)=>{const a=[...An.value],c=a.findIndex(u=>u.gameDocId===s.gameDocId&&u.difficulty===s.difficulty);if(o&&c!==-1&&!a[c].finished||c!==-1?a[c]=s:a.push(s),An.value=a,Qs(a),n.value){const u=await e("shadow",a);An.value=u,Qs(u)}};return Vi(n,async s=>{if(s){const o=Zu(),a=await e("shadow",o);An.value=a,Qs(a)}}),{shadowResults:An,guessesByDifficulty:Xu,initializeShadowGameState:t,saveShadowGameResult:r}}const hv=[{name:"Chadmo",message:"Thanks for all you do for the community",note:"Mythic Supporter",tier:"mythic"},{name:"MyB!",message:"Amazing site you've created... Thanks for sharing!",note:"Mythic Supporter",tier:"mythic"},{name:"Gary",message:"This site is really well done.",note:"Mythic Supporter",tier:"mythic"},{name:"Combonator",message:"Thanks for making this awesome site!",note:"First Supporter",tier:"first"},{name:"MMMiaMMM",message:"Thank you for this!",note:"Legendary Supporter",tier:"legendary"},{name:"L33t-Vortex",message:"Thanks for all the hard work",note:"Legendary Supporter",tier:"legendary"},{name:"Arkin",message:"This site is amazing! Keep up the great work",note:"Epic Supporter",tier:"epic"},{name:"Lamerko1993",message:"Good work deserves a reward and Gastille too. :)",note:"Epic Supporter",tier:"epic"},{name:"Hoots",message:"Thank you",note:"Legendary Supporter",tier:"legendary"},{name:"Regina",message:null,note:"Epic Supporter",tier:"epic"},{name:"King Klecko",message:null,note:"Epic Supporter",tier:"epic"},{name:"Shazam",message:"😘",note:"Epic Supporter",tier:"epic"},{name:"Vic",message:"Thank you so much for the huge help!",note:"Epic Supporter",tier:"epic"},{name:"Ship",message:"Thank you for everything",note:"Legendary Supporter",tier:"legendary"},{name:"Caput Corvi",message:"This is an awesome site! Many, many thanks!",note:"Epic Supporter",tier:"epic"},{name:"Psycrowsis [YouTube]",message:"Awesome for the community!",note:"Epic Supporter",tier:"epic"},{name:"Ruby Sorceresses",message:"Amazing website! TY:)",note:"Epic Supporter",tier:"epic"},{name:"Danila",message:"Thank you for such a great and super useful portal. Keep doing great work",note:"Epic Supporter",tier:"epic"}],dv=()=>{const n=hv,e=["#f87171","#fb923c","#fbbf24","#facc15","#a3e635","#4ade80","#2dd4bf","#22d3ee","#38bdf8","#60a5fa","#818cf8","#a78bfa","#c084fc","#e879f9","#f472b6","#fb7185"],t=()=>e[Math.floor(Math.random()*e.length)];return{supporters:n,getTierConfig:o=>{switch(o){case"mythic":return{icon:"💎",label:"Mythic",class:"tier-mythic",glowIntensity:"0.9",shadowSize:"25px"};case"first":return{icon:"🥇",label:"First",class:"tier-first",glowIntensity:"0.8",shadowSize:"20px"};case"legendary":return{icon:"🌟",label:"Legendary",class:"tier-legendary",glowIntensity:"0.7",shadowSize:"15px"};case"epic":return{icon:"🔥",label:"Epic",class:"tier-epic",glowIntensity:"0.5",shadowSize:"10px"};default:return{icon:"⚔️",label:"Hero",class:"tier-rare",glowIntensity:"0.3",shadowSize:"6px"}}},getProcessedSupporters:(o=!1)=>{const a=n.map(d=>({...d,color:t()}));if(o)return[...a].sort(()=>Math.random()-.5);const c=["mythic","first","legendary","epic","rare"],u=a.reduce((d,g)=>(d[g.tier]=d[g.tier]||[],d[g.tier].push(g),d),{});return c.flatMap(d=>[...u[d]||[]].sort(()=>Math.random()-.5))},getRandomColor:t}},fv={class:"supporter-marquee-container w-full relative group"},pv={class:"flex items-center justify-center gap-2 mb-1 relative"},gv={class:"marquee-wrapper bg-black/20 backdrop-blur-sm border-y border-white/5 py-1.5 md:py-2 relative h-8 md:h-9 flex items-center overflow-hidden"},mv=["onMouseenter"],_v={class:"text-[11px] opacity-80"},yv={class:"text-xs font-black uppercase tracking-wider italic"},vv=["onMouseenter"],wv={class:"text-[11px] opacity-80"},bv={class:"text-xs font-black uppercase tracking-wider italic"},Ev=fr({__name:"SupporterMarquee",setup(n){const{getProcessedSupporters:e,getTierConfig:t}=dv(),r=ae(e(!0)),s=ae(null),o=st(()=>`${Math.max(20,r.value.length*3)}s`);return Mi(()=>{r.value=e(!0)}),(a,c)=>{const u=th;return q(),Q("div",fv,[f("div",pv,[$(u,{to:"/support-us",class:"relative group/title inline-flex items-center justify-center no-underline"},{default:J(()=>[c[2]||(c[2]=f("span",{class:"text-[10px] font-black uppercase tracking-[0.2em] text-slate-500 flex items-center gap-1.5 cursor-pointer hover:text-[#e2b04a] transition-colors"},[f("svg",{class:"w-3 h-3 text-yellow-500 animate-pulse",fill:"currentColor",viewBox:"0 0 24 24"},[f("path",{d:"M12 17.27L18.18 21l-1.64-7.03L22 9.24l-7.19-.61L12 2 9.19 8.63 2 9.24l5.46 4.73L5.82 21z"})]),me(" Hall of Heroes ")],-1)),s.value&&s.value!=="null"?(q(),Zn(nt,{key:0},{default:J(()=>[me(qe(s.value),1)]),_:1})):Ue("",!0)]),_:1})]),f("div",gv,[c[3]||(c[3]=f("div",{class:"absolute inset-y-0 left-0 w-16 bg-gradient-to-r from-[#111827] via-[#111827]/80 to-transparent z-20 pointer-events-none"},null,-1)),c[4]||(c[4]=f("div",{class:"absolute inset-y-0 right-0 w-16 bg-gradient-to-l from-[#111827] via-[#111827]/80 to-transparent z-20 pointer-events-none"},null,-1)),f("div",{class:"marquee-content flex gap-12 whitespace-nowrap px-4 hover:pause-animation",style:Pn({animationDuration:o.value})},[(q(!0),Q(ns,null,ci(r.value,(d,g)=>(q(),Q("div",{key:"a-"+d.name+g,onMouseenter:y=>s.value=d.message,onMouseleave:c[0]||(c[0]=y=>s.value=null),class:"inline-flex items-center gap-1 cursor-help transition-all duration-300 hover:scale-110 active:scale-95",style:Pn({color:d.color,textShadow:`0 0 ${W(t)(d.tier).shadowSize} ${d.color}${Math.round(parseFloat(W(t)(d.tier).glowIntensity)*255).toString(16).padStart(2,"0")}`})},[f("span",_v,qe(W(t)(d.tier).icon),1),f("span",yv,qe(d.name),1)],44,mv))),128)),(q(!0),Q(ns,null,ci(r.value,(d,g)=>(q(),Q("div",{key:"b-"+d.name+g,onMouseenter:y=>s.value=d.message,onMouseleave:c[1]||(c[1]=y=>s.value=null),class:"inline-flex items-center gap-1 cursor-help transition-all duration-300 hover:scale-110 active:scale-95",style:Pn({color:d.color,textShadow:`0 0 ${W(t)(d.tier).shadowSize} ${d.color}${Math.round(parseFloat(W(t)(d.tier).glowIntensity)*255).toString(16).padStart(2,"0")}`})},[f("span",wv,qe(W(t)(d.tier).icon),1),f("span",bv,qe(d.name),1)],44,vv))),128))],4)])])}}}),Tv=Object.assign(pr(Ev,[["__scopeId","data-v-3cd8f37a"]]),{__name:"SupporterMarquee"}),Iv={class:"flex flex-col items-center bg-transparent shadow-none w-full relative z-40"},Cv={class:"relative w-full flex flex-col items-center px-4 mt-2 md:pt-1"},Av={class:"flex flex-col items-center justify-center relative"},Rv=["src"];const Sv=["src"],xv={class:"mt-2 px-2"},kv={class:"w-full mt-2 max-w-2xl mx-auto relative z-10"},Pv={key:0,class:"hidden md:flex wrapper w-100 mt-4 items-center justify-center relative"},Vv={class:"flex items-center gap-3 z-10 relative justify-center w-auto"},Mv={class:"w-12 h-12 md:w-16 md:h-16 flex items-center justify-center relative group"},Dv=["onClick"],Nv={key:0,class:"checkmark-overlay"},Lv={class:"w-12 h-12 md:w-16 md:h-16 flex items-center justify-center relative group"},Ov=["onClick"],Fv={key:0,class:"checkmark-overlay"},Uv={class:"w-12 h-12 md:w-16 md:h-16 flex items-center justify-center relative group"},Bv=["onClick"],jv={key:0,class:"checkmark-overlay"},$v={class:"w-12 h-12 md:w-16 md:h-16 flex items-center justify-center relative group"},qv=["onClick"],zv={class:"w-12 h-12 md:w-16 md:h-16 flex items-center justify-center relative group"},Hv=["onClick"],Gv={class:"w-12 h-12 md:w-16 md:h-16 flex items-center justify-center relative group"},Wv=["onClick"],Kv={class:"w-12 h-12 md:w-16 md:h-16 flex items-center justify-center relative group"},Qv=["onClick"],Yv={class:"w-12 h-12 md:w-16 md:h-16 flex items-center justify-center relative group"},Jv=["onClick"],Xv={class:"w-12 h-12 md:w-16 md:h-16 flex items-center justify-center relative group"},Zv=["onClick"],ew={class:"w-12 h-12 md:w-16 md:h-16 flex items-center justify-center relative group"},tw=["onClick"],nw={class:"w-12 h-12 md:w-16 md:h-16 flex items-center justify-center relative group"},rw=["onClick"],sw={class:"w-12 h-12 md:w-16 md:h-16 flex items-center justify-center relative group"},iw=["onClick"],ow={class:"w-12 h-12 md:w-16 md:h-16 flex items-center justify-center relative group"},aw=["onClick"],lw={class:"w-12 h-12 md:w-16 md:h-16 flex items-center justify-center relative group"},cw=["onClick"],uw={key:0,class:"fixed inset-0 z-[100] bg-black/95 overflow-y-auto"},hw={class:"flex flex-col p-4 min-h-screen"},dw={class:"flex justify-center relative mb-2"},fw=["src"],pw=["src"],gw={class:"mt-2 px-4"},mw={class:"grid grid-cols-1 md:grid-cols-2 gap-4 w-full mb-12 mt-4"},_w={class:"h-full flex items-center p-4 bg-slate-900/60 backdrop-blur-md border border-slate-700/50 rounded-2xl transition-all duration-300 group-hover:border-blue-400/50 group-hover:bg-slate-800/60 shadow-xl"},yw={class:"flex-shrink-0 w-14 h-14 rounded-xl bg-gradient-to-br from-yellow-400 to-yellow-600 flex items-center justify-center mr-4 shadow-lg border-2 border-yellow-400/20"},vw={class:"h-full flex items-center p-4 bg-slate-900/60 backdrop-blur-md border border-slate-700/50 rounded-2xl transition-all duration-300 group-hover:border-purple-400/50 group-hover:bg-slate-800/60 shadow-xl"},ww={class:"flex-shrink-0 w-14 h-14 rounded-xl bg-gradient-to-br from-yellow-400 to-yellow-600 flex items-center justify-center mr-4 shadow-lg border-2 border-yellow-400/20"},bw={class:"h-full flex items-center p-4 bg-slate-900/60 backdrop-blur-md border border-slate-700/50 rounded-2xl transition-all duration-300 group-hover:border-yellow-400/50 group-hover:bg-slate-800/60 shadow-xl relative overflow-visible"},Ew={class:"flex-shrink-0 w-14 h-14 rounded-xl bg-gradient-to-br from-yellow-400 to-yellow-600 flex items-center justify-center mr-4 shadow-lg border-2 border-yellow-400/20"},Tw={class:"overflow-y-auto md:px-4 py-3 max-w-md mx-auto"},Iw={key:0,class:"flex flex-col items-center gap-4 py-4"},Cw={class:"flex flex-col items-center gap-2"},Aw=["src"],Rw={key:1,class:"w-16 h-16 rounded-full bg-gray-700 flex items-center justify-center"},Sw={class:"text-white text-xl font-semibold"},xw={key:2,class:"text-gray-400 text-sm"},kw={class:"w-full mt-6 bg-gray-800/50 p-4 rounded-xl border border-gray-700"},Pw={class:"flex flex-col gap-2"},Vw={class:"flex gap-2"},Mw=["disabled"],Dw={class:"w-full mt-4"},Nw={key:0,class:"text-gray-400 text-sm italic"},Lw={key:1,class:"text-gray-500 text-sm italic"},Ow={key:2,class:"space-y-2 max-h-60 overflow-y-auto pr-2"},Fw={class:"text-xs text-gray-500"},Uw={key:1},Bw={key:0,class:"bg-red-500/20 border border-red-500 text-red-200 px-4 py-2 rounded-lg mb-4 text-sm"},jw={class:"flex justify-center mb-6"},$w=["disabled"],qw=["disabled"],zw={key:2,class:"flex flex-col gap-2 mt-4 text-sm text-gray-300"},Hw={class:"flex flex-col gap-6 mt-2"},Gw=["disabled"],Ww={key:0,class:"w-5 h-5 text-white",fill:"none",stroke:"currentColor","stroke-width":"2",viewBox:"0 0 24 24"},Kw={class:"flex flex-col gap-6 mt-2"},Qw=["disabled"],Yw={key:0,class:"w-5 h-5 text-white",fill:"none",stroke:"currentColor","stroke-width":"2",viewBox:"0 0 24 24"},Jw="https://raw.githubusercontent.com/vabe44/31f5d518-epzl-cdn/main",Xw=fr({__name:"AppHeader",props:{showNav:{type:Boolean,default:!0},showScrollToTop:{type:Boolean,default:!0},forceShowLoginMobile:{type:Boolean,default:!1}},setup(n){const e=Jw;ae(!0);const t=ae(!1),{winterCode:r}=xf(),s=["rgba(226, 88, 34, 0.8)","rgba(248, 200, 10, 0.8)","rgba(185, 56, 248, 0.8)","rgba(24, 188, 8, 0.8)","rgba(56, 189, 248, 0.8)"],o=ae(s[Math.floor(Math.random()*s.length)]),a=()=>{o.value=s[Math.floor(Math.random()*s.length)]};ae(!1);const c=ae(!1),u=up(),d=st(()=>u.path.startsWith("/blog")),g=st(()=>u.path==="/shadow"),{classicResults:y}=cv(),I=ae(!1),P=()=>{I.value=window.scrollY>400},D=()=>{window.scrollTo({top:0,behavior:"smooth"})},{user:L,showLoginModal:A}=yl(),{shadowResults:F}=uv(),j=["rare","epic","legendary"],Y=st(()=>{if(!y?.value)return!1;const O=Array.from(new Set(y.value.map(H=>H.gameDocId)));if(O.length===0)return!1;const b=O[O.length-1];return j.every(H=>y.value.some(Z=>Z.won&&Z.difficulty===H&&Z.gameDocId===b))}),we=st(()=>{if(!F?.value)return!1;const O=Array.from(new Set(F.value.map(H=>H.gameDocId)));if(O.length===0)return!1;const b=O[O.length-1];return j.every(H=>F.value.some(Z=>Z.won&&Z.difficulty===H&&Z.gameDocId===b))}),xe=ae(60),ge=ae(!1),T=ae(!1),m=ae(""),_=ae(""),E=ae(""),w=ae(!1),R=ae([]),v=ae(!1),Ae=ae(null),De=ae(""),Rt=ae(!1);async function Ir(O){const b=xn(xt,"users",O.uid),H=await ri(b);if(H.exists())Ae.value=H.data();else{const Z={uid:O.uid,email:O.email,displayName:O.displayName||"Hero",photoURL:O.photoURL||"",createdAt:new Date().toISOString(),updatedAt:new Date().toISOString()};await si(b,Z),Ae.value=Z}De.value=Ae.value?.displayName||""}async function Ht(){if(!(!L.value||!De.value||!De.value.trim())){Rt.value=!0;try{const O=xn(xt,"users",L.value.uid);await u2(O,{displayName:De.value.trim(),updatedAt:new Date().toISOString()}),Ae.value&&(Ae.value.displayName=De.value.trim()),alert("Profile updated!")}catch(O){console.error("Error updating profile:",O)}finally{Rt.value=!1}}}async function Gt(O){v.value=!0;try{const b=Ti(Wa(xt,"tierlists"),qd("userId","==",O),la("updatedAt","desc"),Ii(10)),H=await il(b),Z=[];H.forEach(N=>{Z.push({id:N.id,...N.data()})}),R.value=Z}catch(b){console.error("Error fetching tierlists:",b)}finally{v.value=!1}}Mi(()=>{window.addEventListener("scroll",P),mf(wt,O=>{L.value=O,O?(Ir(O),Gt(O.uid)):(R.value=[],Ae.value=null)})}),hp(()=>{window.removeEventListener("scroll",P)}),Vi(A,O=>{O||(ge.value=!1,T.value=!1,E.value="",_.value="")});const x=async()=>{E.value="",w.value=!0;try{await f_(wt,m.value,_.value),A.value=!1,m.value="",_.value=""}catch(O){E.value=O.message}finally{w.value=!1}},C=async()=>{E.value="",w.value=!0;try{await d_(wt,m.value,_.value),A.value=!1,m.value="",_.value=""}catch(O){E.value=O.message}finally{w.value=!1}},X=async()=>{if(!m.value){E.value="Please enter your email address.";return}E.value="",w.value=!0;try{await h_(wt,m.value),alert("Password reset email sent!"),T.value=!1}catch(O){E.value=O.message}finally{w.value=!1}},te=async()=>{E.value="",w.value=!0;const O=new St;try{await L_(wt,O),A.value=!1}catch(b){E.value=b.message}finally{w.value=!1}},se=async()=>{try{await m_(wt),A.value=!1}catch(O){console.error("Error signing out:",O)}};return(O,b)=>{const H=gp,Z=kf;return q(),Q("header",Iv,[f("div",Cv,[f("div",Av,[$(W(_e),{to:"/",class:"block group relative transition-all duration-500"},{default:J(()=>[b[17]||(b[17]=f("div",{class:"absolute -inset-4 bg-blue-500/10 rounded-full blur-2xl opacity-0 group-hover:opacity-100 transition-opacity duration-700 pointer-events-none"},null,-1)),f("img",{alt:"Empuzzled logo",class:"logo w-[100px] md:w-[112px] relative z-10 transition-all duration-500 ease-[cubic-bezier(0.34,1.56,0.64,1)] group-hover:scale-110 group-hover:-rotate-2 group-active:scale-95 group-hover:drop-shadow-[0_0_20px_rgba(59,130,246,0.4)]",src:`${W(e)}/logo-crop.webp`,loading:"lazy"},null,8,Rv),Ue("",!0)]),_:1})]),f("div",{class:ue(["absolute top-0 right-2",O.forceShowLoginMobile?"block":"hidden md:block"])},[f("button",{onClick:b[0]||(b[0]=N=>A.value=!0),class:"text-white p-1 rounded-full hover:bg-blue-600 shadow-lg transition duration-150 focus:outline-none focus:ring-2 focus:ring-blue-400 cursor-pointer overflow-hidden","aria-label":"Account"},[W(L)?.photoURL?(q(),Q("img",{key:0,src:W(L).photoURL,class:"w-9 h-9 rounded-full object-cover"},null,8,Sv)):(q(),Zn(W(Lo),{key:1,class:"w-8 h-8 m-0.5"}))])],2),f("div",xv,[f("h2",{onMouseenter:a,class:"text-[14px] sm:text-lg md:text-2xl font-black text-center tracking-tight leading-tight bg-gradient-to-b from-white via-slate-200 to-slate-400 bg-clip-text text-transparent drop-shadow-md max-w-[300px] sm:max-w-none mx-auto transition-all duration-500 ease-out hover:scale-[1.02] hover:brightness-125 cursor-default select-none companion-glow",style:Pn({"--glow-color":o.value})}," Your Ultimate E&P Companion ",36)]),f("div",kv,[$(Tv)]),O.showNav?(q(),Q("button",{key:0,onClick:b[1]||(b[1]=N=>c.value=!0),class:"md:hidden absolute top-0 right-4 text-white p-2","aria-label":"Open menu"},[$(W(Py),{class:"w-8 h-8"})])):Ue("",!0)]),O.showNav?(q(),Q("div",Pv,[f("nav",Vv,[$(W(_e),{to:"/classic",custom:""},{default:J(({navigate:N,isActive:K,isExactActive:G})=>[f("div",Mv,[f("button",{type:"button",class:ue([["flex items-center justify-center rounded-2xl border-2 shadow-lg transition-all duration-200 relative cursor-pointer origin-center",K||G?"border-yellow-400 bg-gradient-to-br from-yellow-400 to-yellow-600 ring-4 ring-yellow-400/50 scale-110":"border-slate-700 bg-slate-800 group-hover:bg-gradient-to-br group-hover:from-yellow-400 group-hover:to-yellow-600 group-hover:border-yellow-400/50","group-hover:scale-110 focus:outline-none"],"w-[48px] h-[48px] md:w-[56px] md:h-[56px]"]),onClick:N,"aria-label":"Classic mode"},[$(W(qu),{class:ue(["h-8 w-8 flex-shrink-0 transition-colors",K||G?"text-black":"text-slate-400 group-hover:text-black"])},null,8,["class"]),Y.value?(q(),Q("span",Nv,[...b[18]||(b[18]=[f("svg",{viewBox:"0 0 24 24",class:"checkmark-svg"},[f("circle",{cx:"12",cy:"12",r:"11",fill:"#22c55e"}),f("path",{d:"M7 12.5l3 3 6-6",stroke:"#fff","stroke-width":"2.5","stroke-linecap":"round","stroke-linejoin":"round",fill:"none"})],-1)])])):Ue("",!0)],10,Dv),$(nt,null,{default:J(()=>[...b[19]||(b[19]=[me("Classic Mode",-1)])]),_:1})])]),_:1}),$(W(_e),{to:"/skill",custom:""},{default:J(({navigate:N,isActive:K,isExactActive:G})=>[f("div",Lv,[f("button",{type:"button",class:ue([["flex items-center justify-center rounded-2xl border-2 shadow-lg transition-all duration-200 relative cursor-pointer origin-center",K||G?"border-yellow-400 bg-gradient-to-br from-yellow-400 to-yellow-600 ring-4 ring-yellow-400/50 scale-110":"border-slate-700 bg-slate-800 group-hover:bg-gradient-to-br group-hover:from-yellow-400 group-hover:to-yellow-600 group-hover:border-yellow-400/50","group-hover:scale-110 focus:outline-none"],"w-[48px] h-[48px] md:w-[56px] md:h-[56px]"]),onClick:N,"aria-label":"Skill mode"},[$(W(zu),{class:ue(["h-8 w-8 flex-shrink-0 transition-colors",K||G?"text-black":"text-slate-400 group-hover:text-black"])},null,8,["class"]),Y.value?(q(),Q("span",Fv,[...b[20]||(b[20]=[f("svg",{viewBox:"0 0 24 24",class:"checkmark-svg"},[f("circle",{cx:"12",cy:"12",r:"11",fill:"#22c55e"}),f("path",{d:"M7 12.5l3 3 6-6",stroke:"#fff","stroke-width":"2.5","stroke-linecap":"round","stroke-linejoin":"round",fill:"none"})],-1)])])):Ue("",!0)],10,Ov),$(nt,null,{default:J(()=>[...b[21]||(b[21]=[me("Skill Mode",-1)])]),_:1})])]),_:1}),$(W(_e),{to:"/shadow",custom:""},{default:J(({navigate:N,isActive:K,isExactActive:G})=>[f("div",Uv,[f("button",{type:"button",class:ue([["flex items-center justify-center rounded-2xl border-2 shadow-lg transition-all duration-200 relative cursor-pointer origin-center",K||G?"border-yellow-400 bg-gradient-to-br from-yellow-400 to-yellow-600 ring-4 ring-yellow-400/50 scale-110":"border-slate-700 bg-slate-800 group-hover:bg-gradient-to-br group-hover:from-yellow-400 group-hover:to-yellow-600 group-hover:border-yellow-400/50","group-hover:scale-110 focus:outline-none"],"w-[48px] h-[48px] md:w-[56px] md:h-[56px]"]),onClick:N,"aria-label":"Shadow mode"},[$(W(Hu),{class:ue(["h-8 w-8 flex-shrink-0 transition-colors",K||G?"text-black":"text-slate-400 group-hover:text-black"])},null,8,["class"]),we.value?(q(),Q("span",jv,[...b[22]||(b[22]=[f("svg",{viewBox:"0 0 24 24",class:"checkmark-svg"},[f("circle",{cx:"12",cy:"12",r:"11",fill:"#22c55e"}),f("path",{d:"M7 12.5l3 3 6-6",stroke:"#fff","stroke-width":"2.5","stroke-linecap":"round","stroke-linejoin":"round",fill:"none"})],-1)])])):(q(),Q("span",{key:1,class:ue(["absolute -top-2 -right-2 text-[8px] font-black px-1.5 py-0.5 rounded-full shadow-lg animate-pulse z-20 transition-all duration-300 border",K||G?"bg-slate-900 text-yellow-400 border-yellow-400/50":"bg-gradient-to-r from-yellow-400 to-yellow-600 text-slate-900 border-yellow-300/50"])}," NEW ",2))],10,Bv),$(nt,null,{default:J(()=>[...b[23]||(b[23]=[me("Shadow Mode",-1)])]),_:1})])]),_:1}),$(W(_e),{to:"/blog",custom:""},{default:J(({navigate:N})=>[f("div",$v,[f("button",{type:"button",class:ue([["flex items-center justify-center rounded-2xl border-2 shadow-lg transition-all duration-200 relative cursor-pointer origin-center",d.value?"border-red-400 bg-gradient-to-br from-red-400 to-red-600 ring-4 ring-red-500/50 scale-110":"border-slate-700 bg-slate-800 group-hover:bg-gradient-to-br group-hover:from-red-400 group-hover:to-red-600 group-hover:border-red-400/50","group-hover:scale-110 focus:outline-none"],"w-[48px] h-[48px] md:w-[56px] md:h-[56px]"]),onClick:N,"aria-label":"Blog page"},[(q(),Q("svg",{version:"1.1",id:"_x32_",xmlns:"http://www.w3.org/2000/svg","xmlns:xlink":"http://www.w3.org/1999/xlink",viewBox:"0 0 512 512","xml:space":"preserve",fill:"currentColor",class:ue(["h-8 w-8 flex-shrink-0 transition-colors",d.value?"text-black":"text-slate-400 group-hover:text-black"])},[...b[24]||(b[24]=[f("g",{id:"SVGRepo_bgCarrier","stroke-width":"0"},null,-1),f("g",{id:"SVGRepo_tracerCarrier","stroke-linecap":"round","stroke-linejoin":"round"},null,-1),f("g",{id:"SVGRepo_iconCarrier"},[f("g",null,[f("rect",{x:"293.186",y:"307.184",width:"131.572",height:"112.986"}),f("rect",{x:"87.243",y:"308.893",width:"154.448",height:"17.162"}),f("rect",{x:"87.243",y:"401.298",width:"154.448",height:"17.162"}),f("rect",{x:"87.243",y:"355.1",width:"154.448",height:"17.162"}),f("path",{d:"M416.428,0.004H95.58C42.787,0.013,0.016,42.792,0,95.577v303.685 c0.025,62.262,50.463,112.717,112.742,112.734h286.524c62.27-0.017,112.717-50.464,112.734-112.734V95.577 C511.992,42.792,469.212,0.013,416.428,0.004z M464.805,399.262c-0.008,18.15-7.308,34.424-19.198,46.34 c-11.916,11.891-28.19,19.19-46.34,19.198H112.742c-18.15-0.009-34.433-7.308-46.348-19.198 c-11.892-11.916-19.182-28.19-19.198-46.34V118.696h417.61V399.262z"}),f("path",{d:"M88.96,267.908h34.583c19.71,0,31.642-8.581,31.642-26.548c0-10.852-6.167-18.368-12.2-20.648v-0.268 c6.034-3.352,10.592-9.519,10.592-19.432c0-14.489-9.251-24.268-29.086-24.268H88.96c-0.796,0-1.332,0.536-1.332,1.34v88.475 C87.628,267.371,88.164,267.908,88.96,267.908z M107.338,193.495c0-0.528,0.251-0.804,0.804-0.804h13.944 c7.5,0,11.925,3.888,11.925,10.584c0,6.712-4.425,10.734-11.925,10.734h-13.944c-0.553,0-0.804-0.268-0.804-0.804V193.495z M107.338,229.955c0-0.528,0.251-0.795,0.804-0.795h15c8.061,0,12.343,4.424,12.343,11.405c0,7.097-4.282,11.396-12.343,11.396h-15 c-0.553,0-0.804-0.276-0.804-0.812V229.955z"}),f("path",{d:"M181.516,267.908h59.404c0.796,0,1.332-0.536,1.332-1.349v-14.874c0-0.813-0.536-1.341-1.332-1.341h-40.224 c-0.544,0-0.804-0.268-0.804-0.812v-71.447c0-0.804-0.528-1.34-1.341-1.34h-17.036c-0.805,0-1.332,0.536-1.332,1.34v88.475 C180.183,267.371,180.711,267.908,181.516,267.908z"}),f("path",{d:"M292.708,269.374c15.963,0,28.558-7.366,33.251-22.115c2.011-6.301,2.539-11.396,2.539-24.938 c0-13.542-0.528-18.637-2.539-24.939c-4.693-14.739-17.288-22.114-33.251-22.114c-15.956,0-28.558,7.375-33.243,22.114 c-2.02,6.302-2.556,11.397-2.556,24.939c0,13.542,0.536,18.637,2.556,24.938C264.149,262.009,276.752,269.374,292.708,269.374z M278.361,202.746c2.011-6.301,6.847-10.055,14.346-10.055c7.508,0,12.335,3.754,14.346,10.055 c1.073,3.226,1.474,7.634,1.474,19.576c0,11.924-0.402,16.357-1.474,19.567c-2.011,6.31-6.838,10.072-14.346,10.072 c-7.5,0-12.335-3.763-14.346-10.072c-1.064-3.21-1.475-7.643-1.475-19.567C276.886,210.38,277.297,205.972,278.361,202.746z"}),f("path",{d:"M387.961,269.374c16.081,0,28.685-8.171,33.251-22.794c1.6-4.952,2.263-12.46,2.263-20.505v-7.517 c0-0.788-0.536-1.333-1.332-1.333h-31.366c-0.813,0-1.349,0.545-1.349,1.333v12.888c0,0.796,0.536,1.332,1.349,1.332h12.326 c0.536,0,0.805,0.277,0.805,0.805c0,3.879-0.403,6.703-1.073,8.991c-1.878,6.026-7.777,9.386-14.614,9.386 c-7.91,0-12.88-3.763-14.891-10.072c-1.064-3.21-1.466-7.643-1.466-19.567c0-11.941,0.402-16.223,1.466-19.441 c2.011-6.302,6.847-10.19,14.631-10.19c7.5,0,12.05,3.218,15.678,9.385c0.269,0.67,0.939,0.939,1.886,0.67l14.338-6.033 c0.796-0.402,0.947-1.206,0.536-2.019c-4.299-10.995-15.419-19.425-32.439-19.425c-16.232,0-28.835,7.375-33.527,22.114 c-2.012,6.302-2.556,11.397-2.556,24.939c0,13.542,0.545,18.637,2.556,24.938C359.126,262.009,371.73,269.374,387.961,269.374z"})])],-1)])],2))],10,qv),$(nt,null,{default:J(()=>[...b[25]||(b[25]=[me("Hero Reviews & Guides",-1)])]),_:1})])]),_:1}),$(W(_e),{to:"/farming-guide",custom:""},{default:J(({navigate:N,isActive:K,isExactActive:G})=>[f("div",zv,[f("button",{type:"button",class:ue([["flex items-center justify-center rounded-2xl border-2 shadow-lg transition-all duration-200 relative cursor-pointer origin-center",K||G?"border-indigo-400 bg-gradient-to-br from-indigo-400 to-indigo-600 ring-4 ring-indigo-500/50 scale-110":"border-slate-700 bg-slate-800 group-hover:bg-gradient-to-br group-hover:from-indigo-400 group-hover:to-indigo-600 group-hover:border-indigo-400/50","group-hover:scale-110 focus:outline-none"],"w-[48px] h-[48px] md:w-[56px] md:h-[56px]"]),onClick:N,"aria-label":"Farming Guide"},[(q(),Q("svg",{viewBox:"0 0 16 16",fill:"currentColor",xmlns:"http://www.w3.org/2000/svg",class:ue(["h-8 w-8 flex-shrink-0 transition-colors",K||G?"text-black":"text-slate-400 group-hover:text-black"])},[...b[26]||(b[26]=[f("g",{id:"SVGRepo_bgCarrier","stroke-width":"0"},null,-1),f("g",{id:"SVGRepo_tracerCarrier","stroke-linecap":"round","stroke-linejoin":"round"},null,-1),f("g",{id:"SVGRepo_iconCarrier"},[f("path",{d:"M16 0H13L3.70711 9.29289L2.20711 7.79289L0.792893 9.20711L3.08579 11.5L1.5835 13.0023C1.55586 13.0008 1.52802 13 1.5 13C0.671573 13 0 13.6716 0 14.5C0 15.3284 0.671573 16 1.5 16C2.32843 16 3 15.3284 3 14.5C3 14.472 2.99923 14.4441 2.99771 14.4165L4.5 12.9142L6.79289 15.2071L8.20711 13.7929L6.70711 12.2929L16 3V0Z"})],-1)])],2))],10,Hv),$(nt,null,{default:J(()=>[...b[27]||(b[27]=[me("Farming Guide",-1)])]),_:1})])]),_:1}),$(W(_e),{to:"/calendar",custom:""},{default:J(({navigate:N,isActive:K,isExactActive:G})=>[f("div",Gv,[f("button",{type:"button",class:ue([["flex items-center justify-center rounded-2xl border-2 shadow-lg transition-all duration-200 relative cursor-pointer origin-center",K||G?"border-orange-400 bg-gradient-to-br from-orange-400 to-orange-600 ring-4 ring-orange-400/50 scale-110":"border-slate-700 bg-slate-800 group-hover:bg-gradient-to-br group-hover:from-orange-400 group-hover:to-orange-600 group-hover:border-orange-400/50","group-hover:scale-110 focus:outline-none"],"w-[48px] h-[48px] md:w-[56px] md:h-[56px]"]),onClick:N,"aria-label":"Calendar"},[(q(),Q("svg",{viewBox:"0 0 24 24",fill:"currentColor",xmlns:"http://www.w3.org/2000/svg",class:ue(["h-8 w-8 flex-shrink-0 transition-colors",K||G?"text-black":"text-slate-400 group-hover:text-black"])},[...b[28]||(b[28]=[f("g",{id:"SVGRepo_bgCarrier","stroke-width":"0"},null,-1),f("g",{id:"SVGRepo_tracerCarrier","stroke-linecap":"round","stroke-linejoin":"round"},null,-1),f("g",{id:"SVGRepo_iconCarrier"},[f("path",{"fill-rule":"evenodd","clip-rule":"evenodd",d:"M7 1C6.44772 1 6 1.44772 6 2V3H5C3.34315 3 2 4.34315 2 6V20C2 21.6569 3.34315 23 5 23H13.101C12.5151 22.4259 12.0297 21.7496 11.6736 21H5C4.44772 21 4 20.5523 4 20V11H20V11.2899C20.7224 11.5049 21.396 11.8334 22 12.2547V6C22 4.34315 20.6569 3 19 3H18V2C18 1.44772 17.5523 1 17 1C16.4477 1 16 1.44772 16 2V3H8V2C8 1.44772 7.55228 1 7 1ZM16 6V5H8V6C8 6.55228 7.55228 7 7 7C6.44772 7 6 6.55228 6 6V5H5C4.44772 5 4 5.44772 4 6V9H20V6C20 5.44772 19.5523 5 19 5H18V6C18 6.55228 17.5523 7 17 7C16.4477 7 16 6.55228 16 6Z"}),f("path",{d:"M17 16C17 15.4477 17.4477 15 18 15C18.5523 15 19 15.4477 19 16V17.703L19.8801 18.583C20.2706 18.9736 20.2706 19.6067 19.8801 19.9973C19.4896 20.3878 18.8564 20.3878 18.4659 19.9973L17.2929 18.8243C17.0828 18.6142 16.9857 18.3338 17.0017 18.0588C17.0006 18.0393 17 18.0197 17 18V16Z"}),f("path",{"fill-rule":"evenodd","clip-rule":"evenodd",d:"M24 18C24 21.3137 21.3137 24 18 24C14.6863 24 12 21.3137 12 18C12 14.6863 14.6863 12 18 12C21.3137 12 24 14.6863 24 18ZM13.9819 18C13.9819 20.2191 15.7809 22.0181 18 22.0181C20.2191 22.0181 22.0181 20.2191 22.0181 18C22.0181 15.7809 20.2191 13.9819 18 13.9819C15.7809 13.9819 13.9819 15.7809 13.9819 18Z"})],-1)])],2))],10,Wv),$(nt,null,{default:J(()=>[...b[29]||(b[29]=[me("Calendar",-1)])]),_:1})])]),_:1}),$(W(_e),{to:"/hero-database",custom:""},{default:J(({navigate:N,isActive:K,isExactActive:G})=>[f("div",Kv,[f("button",{type:"button",class:ue([["flex items-center justify-center rounded-2xl border-2 shadow-lg transition-all duration-200 relative cursor-pointer origin-center",K||G?"border-teal-400 bg-gradient-to-br from-teal-400 to-teal-600 ring-4 ring-teal-500/50 scale-110":"border-slate-700 bg-slate-800 group-hover:bg-gradient-to-br group-hover:from-teal-400 group-hover:to-teal-600 group-hover:border-teal-400/50","group-hover:scale-110 focus:outline-none"],"w-[48px] h-[48px] md:w-[56px] md:h-[56px]"]),onClick:N,"aria-label":"Hero Database"},[(q(),Q("svg",{viewBox:"0 0 600 600",version:"1.1",id:"svg9724",fill:"currentColor",class:ue(["h-8 w-8 flex-shrink-0 transition-colors",K||G?"text-black":"text-slate-400 group-hover:text-black"])},[...b[30]||(b[30]=[f("g",{id:"SVGRepo_bgCarrier","stroke-width":"0"},null,-1),f("g",{id:"SVGRepo_tracerCarrier","stroke-linecap":"round","stroke-linejoin":"round"},null,-1),f("g",{id:"SVGRepo_iconCarrier"},[f("defs",{id:"defs9728"}),f("path",{id:"path3428",style:{color:"currentColor",fill:"currentColor","stroke-linejoin":"round","paint-order":"stroke fill markers"},d:"M 300 0 C 221.30245 0 150.09841 8.0113158 97.068359 21.535156 C 70.553346 28.297076 48.605538 36.277916 31.677734 46.484375 C 16.579982 55.587421 3.2445893 67.928721 0.53125 85 L 0 85 L 0 90 C 0 95.160045 3.6392602 102.94345 17.03125 112.83789 C 30.423241 122.73233 52.11942 133.00486 79.691406 141.62109 C 134.83535 158.85361 213.32376 170 300 170 C 386.67624 170 465.16467 158.85361 520.30859 141.62109 C 547.8806 133.00486 569.57675 122.73233 582.96875 112.83789 C 596.36075 102.94345 600 95.160045 600 90 L 599.87305 90 C 599.19452 70.318664 584.84711 56.447884 568.32227 46.484375 C 551.39442 36.277916 529.44664 28.297076 502.93164 21.535156 C 449.90159 8.0113158 378.69755 0 300 0 z M 0 149.67969 L 0 234.10742 C 0.70499641 239.21983 4.6599347 246.30446 16.722656 255.2168 C 30.11466 265.11125 51.810798 275.38376 79.382812 284 C 134.52681 301.23251 213.01506 312.37891 299.69141 312.37891 C 386.36774 312.37891 464.85602 301.23251 520 284 C 547.57201 275.38376 569.26815 265.11125 582.66016 255.2168 C 596.05215 245.32235 599.69141 237.53895 599.69141 232.37891 L 600 232.37891 L 600 149.67969 C 581.93283 161.57337 559.1282 171.3983 532.24023 179.80078 C 471.56758 198.761 390.05399 210 300 210 C 209.94601 210 128.43244 198.761 67.759766 179.80078 C 40.871811 171.3983 18.067172 161.57337 0 149.67969 z M 600 291.79688 C 590.25148 298.2521 579.18165 304.12941 566.75 309.46875 C 556.06951 314.05598 544.44003 318.27081 531.93164 322.17969 C 471.2589 341.13992 389.74549 352.37891 299.69141 352.37891 C 209.63733 352.37891 128.12391 341.13993 67.451172 322.17969 C 40.720883 313.82647 18.016718 304.0712 0 292.27148 L 0 380 C 0 385.16005 3.6392334 392.94343 17.03125 402.83789 C 30.423267 412.73235 52.119364 423.00484 79.691406 431.62109 C 134.83545 448.85363 213.32358 460 300 460 C 386.67642 460 465.16455 448.85363 520.30859 431.62109 C 547.88068 423.00484 569.57666 412.73235 582.96875 402.83789 C 596.36074 392.94343 600 385.16005 600 380 L 600 291.79688 z M 0 439.67969 L 0 508.59375 L 0 515 L 0.53125 515 C 3.2445947 532.0713 16.579952 544.41257 31.677734 553.51562 C 48.605572 563.7221 70.553292 571.70292 97.068359 578.46484 C 150.09851 591.98873 221.30229 600 300 600 C 378.69771 600 449.90149 591.98873 502.93164 578.46484 C 529.4467 571.70292 551.3944 563.7221 568.32227 553.51562 C 583.42003 544.41257 596.7554 532.0713 599.46875 515 L 600 515 L 600 508.59375 L 600 439.67969 C 581.93278 451.57339 559.1283 461.39828 532.24023 469.80078 C 471.56747 488.76104 390.05417 500 300 500 C 209.94583 500 128.43256 488.76104 67.759766 469.80078 C 40.871757 461.39828 18.067208 451.57339 0 439.67969 z "})],-1)])],2))],10,Qv),$(nt,null,{default:J(()=>[...b[31]||(b[31]=[me("Hero Database",-1)])]),_:1})])]),_:1}),$(W(_e),{to:"/hero-coach",custom:""},{default:J(({navigate:N,isActive:K,isExactActive:G})=>[f("div",Yv,[f("button",{type:"button",class:ue([["flex items-center justify-center rounded-2xl border-2 shadow-lg transition-all duration-200 relative cursor-pointer origin-center",K||G?"border-yellow-400 bg-gradient-to-br from-yellow-400 to-yellow-600 ring-4 ring-yellow-400/50 scale-110":"border-slate-700 bg-slate-800 group-hover:bg-gradient-to-br group-hover:from-yellow-400 group-hover:to-yellow-600 group-hover:border-yellow-400/50","group-hover:scale-110 focus:outline-none"],"w-[48px] h-[48px] md:w-[56px] md:h-[56px]"]),onClick:N,"aria-label":"Hero Coach"},[(q(),Q("svg",{version:"1.1",id:"_x32_",xmlns:"http://www.w3.org/2000/svg","xmlns:xlink":"http://www.w3.org/1999/xlink",viewBox:"0 0 512 512","xml:space":"preserve",fill:"currentColor",class:ue(["h-8 w-8 flex-shrink-0 transition-colors",K||G?"text-black":"text-slate-400 group-hover:text-black"])},[...b[32]||(b[32]=[f("g",{id:"SVGRepo_bgCarrier","stroke-width":"0"},null,-1),f("g",{id:"SVGRepo_tracerCarrier","stroke-linecap":"round","stroke-linejoin":"round"},null,-1),f("g",{id:"SVGRepo_iconCarrier"},[f("g",null,[f("path",{d:"M141.698,141.549H79.077c-8.488,0-15.37,6.882-15.37,15.362v198.179c0,8.479,6.882,15.362,15.37,15.362h62.622 c8.489,0,15.371-6.883,15.371-15.362V156.911C157.07,148.431,150.187,141.549,141.698,141.549z"}),f("path",{d:"M32.374,189.734H12.803C5.736,189.734,0,195.47,0,202.537v106.925c0,7.068,5.736,12.803,12.803,12.803h19.571 c7.067,0,12.803-5.736,12.803-12.803V202.537C45.177,195.47,39.441,189.734,32.374,189.734z"}),f("rect",{x:"177.69",y:"228.894",width:"156.62",height:"54.212"}),f("path",{d:"M432.922,141.549h-62.621c-8.488,0-15.371,6.882-15.371,15.362v198.179c0,8.479,6.882,15.362,15.371,15.362 h62.621c8.488,0,15.371-6.883,15.371-15.362V156.911C448.293,148.431,441.411,141.549,432.922,141.549z"}),f("path",{d:"M499.197,189.734h-19.57c-7.068,0-12.803,5.736-12.803,12.803v106.925c0,7.068,5.736,12.803,12.803,12.803 h19.57c7.068,0,12.803-5.736,12.803-12.803V202.537C512,195.47,506.264,189.734,499.197,189.734z"})])],-1)])],2))],10,Jv),$(nt,null,{default:J(()=>[...b[33]||(b[33]=[me("Hero Coach",-1)])]),_:1})])]),_:1}),$(W(_e),{to:"/visiting-outfitter",custom:""},{default:J(({navigate:N,isActive:K,isExactActive:G})=>[f("div",Xv,[f("button",{type:"button",class:ue([["flex items-center justify-center rounded-2xl border-2 shadow-lg transition-all duration-200 relative cursor-pointer origin-center",K||G?"border-pink-400 bg-gradient-to-br from-pink-400 to-pink-600 ring-4 ring-pink-400/50 scale-110":"border-slate-700 bg-slate-800 group-hover:bg-gradient-to-br group-hover:from-pink-400 group-hover:to-pink-600 group-hover:border-pink-400/50","group-hover:scale-110 focus:outline-none"],"w-[48px] h-[48px] md:w-[56px] md:h-[56px]"]),onClick:N,"aria-label":"Visiting Outfitter"},[(q(),Q("svg",{viewBox:"0 0 24 24",fill:"none",xmlns:"http://www.w3.org/2000/svg",class:ue(["h-8 w-8 flex-shrink-0 transition-colors",K||G?"text-black":"text-slate-400 group-hover:text-black"])},[...b[34]||(b[34]=[f("g",{id:"SVGRepo_bgCarrier","stroke-width":"0"},null,-1),f("g",{id:"SVGRepo_tracerCarrier","stroke-linecap":"round","stroke-linejoin":"round"},null,-1),f("g",{id:"SVGRepo_iconCarrier"},[f("path",{d:"M21 18L14.9339 13.8837M11.7895 11.75L7 8.5M21 5.5L7 15M8 6.5C8 7.88071 6.88071 9 5.5 9C4.11929 9 3 7.88071 3 6.5C3 5.11929 4.11929 4 5.5 4C6.88071 4 8 5.11929 8 6.5ZM8 17C8 15.6193 6.88071 14.5 5.5 14.5C4.11929 14.5 3 15.6193 3 17C3 18.3807 4.11929 19.5 5.5 19.5C6.88071 19.5 8 18.3807 8 17Z",stroke:"currentColor","stroke-width":"2","stroke-linecap":"round","stroke-linejoin":"round"})],-1)])],2))],10,Zv),$(nt,null,{default:J(()=>[...b[35]||(b[35]=[me("Visiting Outfitter",-1)])]),_:1})])]),_:1}),$(W(_e),{to:"/soul-exchange",custom:""},{default:J(({navigate:N,isActive:K,isExactActive:G})=>[f("div",ew,[f("button",{type:"button",class:ue([["flex items-center justify-center rounded-2xl border-2 shadow-lg transition-all duration-200 relative cursor-pointer origin-center",K||G?"border-purple-400 bg-gradient-to-br from-purple-400 to-purple-600 ring-4 ring-purple-400/50 scale-110":"border-slate-700 bg-slate-800 group-hover:bg-gradient-to-br group-hover:from-purple-400 group-hover:to-purple-600 group-hover:border-purple-400/50","group-hover:scale-110 focus:outline-none"],"w-[48px] h-[48px] md:w-[56px] md:h-[56px]"]),onClick:N,"aria-label":"Soul Exchange"},[(q(),Q("svg",{version:"1.1",id:"_x32_",xmlns:"http://www.w3.org/2000/svg","xmlns:xlink":"http://www.w3.org/1999/xlink",viewBox:"0 0 512 512","xml:space":"preserve",fill:"currentColor",class:ue(["h-8 w-8 flex-shrink-0 transition-colors",K||G?"text-black":"text-slate-400 group-hover:text-black"])},[...b[36]||(b[36]=[f("g",{id:"SVGRepo_bgCarrier","stroke-width":"0"},null,-1),f("g",{id:"SVGRepo_tracerCarrier","stroke-linecap":"round","stroke-linejoin":"round"},null,-1),f("g",{id:"SVGRepo_iconCarrier"},[f("g",null,[f("path",{d:"M405.878,357.099c-3.641-41.297-29.703-99.953-92.734-102.781c-92.922,0.25-106.391,72.141-97.656,103.984 c7.328,26.75,26.781,48.078,54.422,45.656s48.469-26.844,45.656-54.438c-0.484-29.266,24.344-28.5,25.094,3.875 c1.016,43.094-28.094,80.922-71.031,84.703c-42.938,3.75-77.531-28.547-84.719-71.031c-4.344-25.781,0.594-75.172,44.438-113.766 c56.344-49.594,117.719,9.875,112.734-70.578c-5.031-81.188-25.438-82.906-78.063-114.531 c-34.797-20.922-40.75-54.109-38.797-67.109c0.078-0.625,0.078-1.563-1.156-0.781c-32.594,20.469-32.859,58-13.813,87.25 c9.141,14.016,28.031,21.234,29.969,43.422c2.641,30.094-14.672,39.281-28.938,51.703c-14.25,12.422-31.219,25.75-56.813,52.078 c-40.875,42.063-51.625,95.219-48.359,140.266c3.609,41.281,23.625,77.203,53.031,101.875 c29.453,24.688,68.313,38.141,109.594,34.516c41.297-3.625,77.203-23.641,101.906-53.063 C395.315,428.911,409.487,398.38,405.878,357.099z"})])],-1)])],2))],10,tw),$(nt,null,{default:J(()=>[...b[37]||(b[37]=[me("Soul Exchange",-1)])]),_:1})])]),_:1}),$(W(_e),{to:"/fated-summon",custom:""},{default:J(({navigate:N,isActive:K,isExactActive:G})=>[f("div",nw,[f("button",{type:"button",class:ue([["flex items-center justify-center rounded-2xl border-2 shadow-lg transition-all duration-200 relative cursor-pointer origin-center",K||G?"border-cyan-400 bg-gradient-to-br from-cyan-400 to-cyan-600 ring-4 ring-cyan-500/50 scale-110":"border-slate-700 bg-slate-800 group-hover:bg-gradient-to-br group-hover:from-cyan-400 group-hover:to-cyan-600 group-hover:border-cyan-400/50","group-hover:scale-110 focus:outline-none"],"w-[48px] h-[48px] md:w-[56px] md:h-[56px]"]),onClick:N,"aria-label":"Fated Summon"},[(q(),Q("svg",{viewBox:"0 0 16 16",fill:"currentColor",xmlns:"http://www.w3.org/2000/svg",class:ue(["h-8 w-8 flex-shrink-0 transition-colors",K||G?"text-black":"text-slate-400 group-hover:text-black"])},[...b[38]||(b[38]=[f("g",{id:"SVGRepo_bgCarrier","stroke-width":"0"},null,-1),f("g",{id:"SVGRepo_tracerCarrier","stroke-linecap":"round","stroke-linejoin":"round"},null,-1),f("g",{id:"SVGRepo_iconCarrier"},[f("path",{"fill-rule":"evenodd","clip-rule":"evenodd",d:"M12.4722 10C13.4223 8.93849 14 7.53671 14 6C14 2.68629 11.3137 0 8 0C4.68629 0 2 2.68629 2 6C2 7.53671 2.57771 8.93849 3.52779 10H12.4722ZM8 5L10 3L12 5L10 7L8 5Z"}),f("path",{d:"M15 15V14L13 12H3L1 14V15H15Z"})],-1)])],2))],10,rw),$(nt,null,{default:J(()=>[...b[39]||(b[39]=[me("Fated Summon",-1)])]),_:1})])]),_:1}),$(W(_e),{to:"/tier-list",custom:""},{default:J(({navigate:N,isActive:K,isExactActive:G})=>[f("div",sw,[f("button",{type:"button",class:ue([["flex items-center justify-center rounded-2xl border-2 shadow-lg transition-all duration-200 relative cursor-pointer origin-center",K||G?"border-lime-400 bg-gradient-to-br from-lime-400 to-lime-600 ring-4 ring-lime-500/50 scale-110":"border-slate-700 bg-slate-800 group-hover:bg-gradient-to-br group-hover:from-lime-400 group-hover:to-lime-600 group-hover:border-lime-400/50","group-hover:scale-110 focus:outline-none"],"w-[48px] h-[48px] md:w-[56px] md:h-[56px]"]),onClick:N,"aria-label":"Tier List Maker"},[(q(),Q("svg",{class:ue(["h-8 w-8 flex-shrink-0 transition-colors",K||G?"text-black":"text-slate-400 group-hover:text-black"]),viewBox:"0 0 24 24",version:"1.1",xmlns:"http://www.w3.org/2000/svg",fill:"currentColor"},[...b[40]||(b[40]=[f("path",{d:"M7.23767,17.0125 C7.62819,16.622 8.26136,16.622 8.65188,17.0125 C9.01236,17.3729615 9.04008923,17.9402207 8.73506769,18.3324973 L8.65188,18.4267 L6.35378,20.7248 C5.89817333,21.1804533 5.17834996,21.2108302 4.68751439,20.8159307 L4.58602,20.7248 L3.34856,19.4874 C2.95803,19.0968 2.95803,18.4637 3.34856,18.0731 C3.70904,17.7126385 4.27627503,17.6849107 4.6685635,17.9899166 L4.76277,18.0731 L5.4699,18.7803 L7.23767,17.0125 Z M20.0002,17.9999 C20.5525,17.9999 21.0002,18.4477 21.0002,18.9999 C21.0002,19.5522 20.5525,19.9999 20.0002,19.9999 L11.0002,19.9999 C10.4479,19.9999 10.0002,19.5522 10.0002,18.9999 C10.0002,18.4477 10.4479,17.9999 11.0002,17.9999 L20.0002,17.9999 Z M8.65188,10.0125 C9.0424,10.403 9.0424,11.0362 8.65188,11.4267 L6.35378,13.7248 C5.86563,14.213 5.07417,14.213 4.58602,13.7248 L3.34856,12.4873 C2.95803,12.0968 2.95803,11.4637 3.34856,11.0731 C3.73908,10.6826 4.37225,10.6826 4.76277,11.0731 L5.4699,11.7803 L7.23767,10.0125 C7.62819,9.62197 8.26136,9.62197 8.65188,10.0125 Z M20.0002,10.9999 C20.5525,10.9999 21.0002,11.4477 21.0002,11.9999 C21.0002,12.51275 20.614173,12.9354092 20.1168239,12.9931725 L20.0002,12.9999 L11.0002,12.9999 C10.4479,12.9999 10.0002,12.5522 10.0002,11.9999 C10.0002,11.4871429 10.386227,11.0644041 10.8835761,11.0066289 L11.0002,10.9999 L20.0002,10.9999 Z M7.23767,3.0125 C7.62819,2.62197 8.26136,2.62197 8.65188,3.0125 C9.01236,3.37298 9.04008923,3.94021503 8.73506769,4.3325035 L8.65188,4.42671 L6.35378,6.72481 C5.89817333,7.18041667 5.17834996,7.21079044 4.68751439,6.81593133 L4.58602,6.72481 L3.34856,5.48735 C2.95803,5.09683 2.95803,4.46366 3.34856,4.07314 C3.70904,3.71265077 4.27627503,3.68492083 4.6685635,3.98995018 L4.76277,4.07314 L5.4699,4.78026 L7.23767,3.0125 Z M20.0002,3.99995 C20.5525,3.99995 21.0002,4.44766 21.0002,4.99995 C21.0002,5.51278143 20.614173,5.93545653 20.1168239,5.9932222 L20.0002,5.99995 L11.0002,5.99995 C10.4479,5.99995 10.0002,5.55223 10.0002,4.99995 C10.0002,4.48710929 10.386227,4.06429043 10.8835761,4.00651523 L11.0002,3.99995 L20.0002,3.99995 Z"},null,-1)])],2))],10,iw),$(nt,null,{default:J(()=>[...b[41]||(b[41]=[me("Tier List Maker",-1)])]),_:1})])]),_:1}),$(W(_e),{to:"/talent-simulator",custom:""},{default:J(({navigate:N,isActive:K,isExactActive:G})=>[f("div",ow,[f("button",{type:"button",class:ue([["flex items-center justify-center rounded-2xl border-2 shadow-lg transition-all duration-200 relative cursor-pointer origin-center",K||G?"border-orange-400 bg-gradient-to-br from-orange-400 to-orange-600 ring-4 ring-orange-500/50 scale-110":"border-slate-700 bg-slate-800 group-hover:bg-gradient-to-br group-hover:from-orange-400 group-hover:to-orange-600 group-hover:border-orange-400/50","group-hover:scale-110 focus:outline-none"],"w-[48px] h-[48px] md:w-[56px] md:h-[56px]"]),onClick:N,"aria-label":"Talent Simulator"},[(q(),Q("svg",{fill:"currentColor",viewBox:"0 0 24 24",stroke:"currentColor","stroke-width":"1.5",class:ue(["h-8 w-8 flex-shrink-0 transition-colors",K||G?"text-black":"text-slate-400 group-hover:text-black"])},[...b[42]||(b[42]=[f("circle",{cx:"12",cy:"7",r:"2"},null,-1),f("circle",{cx:"8",cy:"17",r:"2"},null,-1),f("circle",{cx:"16",cy:"17",r:"2"},null,-1),f("line",{x1:"12",y1:"9",x2:"8",y2:"15"},null,-1),f("line",{x1:"12",y1:"9",x2:"16",y2:"15"},null,-1)])],2))],10,aw),$(nt,null,{default:J(()=>[...b[43]||(b[43]=[me("Talent Simulator",-1)])]),_:1})])]),_:1}),$(W(_e),{to:"/codes",custom:""},{default:J(({navigate:N,isActive:K,isExactActive:G})=>[f("div",lw,[f("button",{type:"button",class:ue([["flex items-center justify-center rounded-2xl border-2 shadow-lg transition-all duration-200 relative cursor-pointer origin-center",K||G?"border-green-400 bg-gradient-to-br from-green-400 to-green-600 ring-4 ring-green-500/50 scale-110":"border-slate-700 bg-slate-800 group-hover:bg-gradient-to-br group-hover:from-green-400 group-hover:to-green-600 group-hover:border-green-400/50","group-hover:scale-110 focus:outline-none"],"w-[48px] h-[48px] md:w-[56px] md:h-[56px]"]),onClick:N,"aria-label":"Redeem Codes"},[(q(),Q("svg",{viewBox:"0 0 48 48",xmlns:"http://www.w3.org/2000/svg",fill:"currentColor",class:ue(["h-8 w-8 flex-shrink-0 transition-colors",K||G?"text-black":"text-slate-400 group-hover:text-black"])},[...b[44]||(b[44]=[f("g",{id:"SVGRepo_bgCarrier","stroke-width":"0"},null,-1),f("g",{id:"SVGRepo_tracerCarrier","stroke-linecap":"round","stroke-linejoin":"round"},null,-1),f("g",{id:"SVGRepo_iconCarrier"},[f("g",{id:"Layer_2","data-name":"Layer 2"},[f("g",{id:"invisible_box","data-name":"invisible box"},[f("rect",{width:"48",height:"48",fill:"none"})]),f("g",{id:"Layer_7","data-name":"Layer 7"},[f("g",null,[f("path",{d:"M43,12H38.3a4.2,4.2,0,0,0,.4-1,7,7,0,0,0-.6-5.3,6.7,6.7,0,0,0-4.3-3.4A7.1,7.1,0,0,0,25,7l-1,3.4L23,7a7.1,7.1,0,0,0-8.8-4.7A6.7,6.7,0,0,0,9.9,5.7,7,7,0,0,0,9.3,11a4.2,4.2,0,0,0,.4,1H5a2.9,2.9,0,0,0-3,3v7H17V16h4v6h6V16h4v6H46V15A2.9,2.9,0,0,0,43,12ZM17,12h-.9a3.1,3.1,0,0,1-3-2.2,2.9,2.9,0,0,1,.3-2.2,3,3,0,0,1,1.8-1.5,3.3,3.3,0,0,1,4,2.1L20.3,12ZM34.9,9.8a3.1,3.1,0,0,1-3,2.2H27.7l1.1-3.8a3.3,3.3,0,0,1,4-2.1,3,3,0,0,1,1.8,1.5A2.9,2.9,0,0,1,34.9,9.8Z"}),f("rect",{x:"21",y:"26",width:"6",height:"20"}),f("path",{d:"M4,43a3,3,0,0,0,3,3H17V26H4Z"}),f("path",{d:"M31,46H41a3,3,0,0,0,3-3V26H31Z"})])])])],-1)])],2))],10,cw),$(nt,null,{default:J(()=>[...b[45]||(b[45]=[me("Redeem Codes",-1)])]),_:1})])]),_:1}),b[46]||(b[46]=f("div",{class:"menu-bar-decor"},null,-1))])])):Ue("",!0),(q(),Zn(Uo,{to:"body"},[c.value?(q(),Q("div",uw,[f("div",hw,[f("div",dw,[f("button",{onClick:b[2]||(b[2]=N=>{A.value=!0,c.value=!1}),class:"absolute top-1 left-1 text-white p-1 rounded-full hover:bg-blue-600 shadow-lg transition duration-150 focus:outline-none focus:ring-2 focus:ring-blue-400 cursor-pointer overflow-hidden","aria-label":"Account"},[W(L)?.photoURL?(q(),Q("img",{key:0,src:W(L).photoURL,class:"w-9 h-9 rounded-full object-cover"},null,8,fw)):(q(),Zn(W(Lo),{key:1,class:"w-8 h-8 m-0.5"}))]),$(W(_e),{to:"/",class:"block"},{default:J(()=>[f("img",{alt:"Empuzzled logo",class:"logo w-[100px] md:w-[180px]",src:`${W(e)}/logo-crop.webp`,loading:"lazy"},null,8,pw)]),_:1}),f("button",{onClick:b[3]||(b[3]=N=>c.value=!1),class:"absolute top-1 right-1 text-white p-2","aria-label":"Close menu"},[$(W(Dy),{class:"w-8 h-8"})])]),f("div",gw,[f("h2",{onMouseenter:a,class:"text-[14px] sm:text-lg md:text-2xl font-black text-center tracking-tight leading-tight bg-gradient-to-b from-white via-slate-200 to-slate-400 bg-clip-text text-transparent drop-shadow-md max-w-[300px] sm:max-w-none mx-auto transition-all duration-500 ease-out hover:scale-[1.02] hover:brightness-125 cursor-default select-none companion-glow",style:Pn({"--glow-color":o.value})}," Your Ultimate E&P Companion ",36)]),f("div",mw,[$(W(_e),{to:"/classic",class:"group no-underline"},{default:J(()=>[f("div",_w,[f("div",yw,[$(W(qu),{class:"h-8 w-8 text-black"})]),b[47]||(b[47]=f("div",{class:"flex-1"},[f("h2",{class:"text-xl font-bold text-white leading-tight"},"Daily Hero Hunt"),f("p",{class:"text-sm text-slate-400 mt-0.5"},"Test your knowledge! Crack the clues and find today's mystery hero.")],-1))])]),_:1}),$(W(_e),{to:"/skill",class:"group no-underline"},{default:J(()=>[f("div",vw,[f("div",ww,[$(W(zu),{class:"h-8 w-8 text-black"})]),b[48]||(b[48]=f("div",{class:"flex-1"},[f("h2",{class:"text-xl font-bold text-white leading-tight"},"Skill Master Quest"),f("p",{class:"text-sm text-slate-400 mt-0.5"},"Recognize the power! Can you identify the hero by their unique ability?")],-1))])]),_:1}),$(W(_e),{to:"/shadow",class:"group no-underline"},{default:J(()=>[f("div",bw,[f("div",Ew,[$(W(Hu),{class:"h-8 w-8 text-black"})]),b[49]||(b[49]=f("div",{class:"flex-1"},[f("h2",{class:"text-xl font-bold text-white leading-tight"},"Into The Shadows"),f("p",{class:"text-sm text-slate-400 mt-0.5"},"The hunt is on! Unmask the hero lurking in the darkness of the shadow realm.")],-1)),f("span",{class:ue(["absolute -top-1 -right-1 text-[8px] font-black px-2 py-0.5 rounded-full shadow-lg border animate-pulse z-20 transition-all duration-300",g.value?"bg-slate-900 text-yellow-400 border-yellow-400/50":"bg-gradient-to-r from-yellow-400 to-yellow-600 text-slate-900 border-yellow-300/50"])}," NEW ",2)])]),_:1}),$(W(_e),{to:"/blog",class:"group no-underline"},{default:J(()=>[...b[50]||(b[50]=[f("div",{class:"h-full flex items-center p-4 bg-slate-900/60 backdrop-blur-md border border-slate-700/50 rounded-2xl transition-all duration-300 group-hover:border-red-400/50 group-hover:bg-slate-800/60 shadow-xl"},[f("div",{class:"flex-shrink-0 w-14 h-14 rounded-xl bg-gradient-to-br from-red-400 to-red-600 flex items-center justify-center mr-4 shadow-lg border-2 border-red-400/20"},[f("svg",{class:"h-8 w-8 text-black",version:"1.1",xmlns:"http://www.w3.org/2000/svg",viewBox:"0 0 512 512",fill:"currentColor"},[f("rect",{x:"293.186",y:"307.184",width:"131.572",height:"112.986"}),f("rect",{x:"87.243",y:"308.893",width:"154.448",height:"17.162"}),f("rect",{x:"87.243",y:"401.298",width:"154.448",height:"17.162"}),f("rect",{x:"87.243",y:"355.1",width:"154.448",height:"17.162"}),f("path",{d:"M416.428,0.004H95.58C42.787,0.013,0.016,42.792,0,95.577v303.685 c0.025,62.262,50.463,112.717,112.742,112.734h286.524c62.27-0.017,112.717-50.464,112.734-112.734V95.577 C511.992,42.792,469.212,0.013,416.428,0.004z M464.805,399.262c-0.008,18.15-7.308,34.424-19.198,46.34 c-11.916,11.891-28.19,19.19-46.34,19.198H112.742c-18.15-0.009-34.433-7.308-46.348-19.198 c-11.892-11.916-19.182-28.19-19.198-46.34V118.696h417.61V399.262z"}),f("path",{d:"M88.96,267.908h34.583c19.71,0,31.642-8.581,31.642-26.548c0-10.852-6.167-18.368-12.2-20.648v-0.268 c6.034-3.352,10.592-9.519,10.592-19.432c0-14.489-9.251-24.268-29.086-24.268H88.96c-0.796,0-1.332,0.536-1.332,1.34v88.475 C87.628,267.371,88.164,267.908,88.96,267.908z M107.338,193.495c0-0.528,0.251-0.804,0.804-0.804h13.944 c7.5,0,11.925,3.888,11.925,10.584c0,6.712-4.425,10.734-11.925,10.734h-13.944c-0.553,0-0.804-0.268-0.804-0.804V193.495z M107.338,229.955c0-0.528,0.251-0.795,0.804-0.795h15c8.061,0,12.343,4.424,12.343,11.405c0,7.097-4.282,11.396-12.343,11.396h-15 c-0.553,0-0.804-0.276-0.804-0.812V229.955z"}),f("path",{d:"M181.516,267.908h59.404c0.796,0,1.332-0.536,1.332-1.349v-14.874c0-0.813-0.536-1.341-1.332-1.341h-40.224 c-0.544,0-0.804-0.268-0.804-0.812v-71.447c0-0.804-0.528-1.34-1.341-1.34h-17.036c-0.805,0-1.332,0.536-1.332,1.34v88.475 C180.183,267.371,180.711,267.908,181.516,267.908z"}),f("path",{d:"M292.708,269.374c15.963,0,28.558-7.366,33.251-22.115c2.011-6.301,2.539-11.396,2.539-24.938 c0-13.542-0.528-18.637-2.539-24.939c-4.693-14.739-17.288-22.114-33.251-22.114c-15.956,0-28.558,7.375-33.243,22.114 c-2.02,6.302-2.556,11.397-2.556,24.939c0,13.542,0.536,18.637,2.556,24.938C264.149,262.009,276.752,269.374,292.708,269.374z M278.361,202.746c2.011-6.301,6.847-10.055,14.346-10.055c7.508,0,12.335,3.754,14.346,10.055 c1.073,3.226,1.474,7.634,1.474,19.576c0,11.924-0.402,16.357-1.474,19.567c-2.011,6.31-6.838,10.072-14.346,10.072 c-7.5,0-12.335-3.763-14.346-10.072c-1.064-3.21-1.475-7.643-1.475-19.567C276.886,210.38,277.297,205.972,278.361,202.746z"}),f("path",{d:"M387.961,269.374c16.081,0,28.685-8.171,33.251-22.794c1.6-4.952,2.263-12.46,2.263-20.505v-7.517 c0-0.788-0.536-1.333-1.332-1.333h-31.366c-0.813,0-1.349,0.545-1.349,1.333v12.888c0,0.796,0.536,1.332,1.349,1.332h12.326 c0.536,0,0.805,0.277,0.805,0.805c0,3.879-0.403,6.703-1.073,8.991c-1.878,6.026-7.777,9.386-14.614,9.386 c-7.91,0-12.88-3.763-14.891-10.072c-1.064-3.21-1.466-7.643-1.466-19.567c0-11.941,0.402-16.223,1.466-19.441 c2.011-6.302,6.847-10.19,14.631-10.19c7.5,0,12.05,3.218,15.678,9.385c0.269,0.67,0.939,0.939,1.886,0.67l14.338-6.033 c0.796-0.402,0.947-1.206,0.536-2.019c-4.299-10.995-15.419-19.425-32.439-19.425c-16.232,0-28.835,7.375-33.527,22.114 c-2.012,6.302-2.556,11.397-2.556,24.939c0,13.542,0.545,18.637,2.556,24.938C359.126,262.009,371.73,269.374,387.961,269.374z"})])]),f("div",{class:"flex-1"},[f("h2",{class:"text-xl font-bold text-white leading-tight"},"Reviews & Guides"),f("p",{class:"text-sm text-slate-400 mt-0.5"},"Read hero reviews, guides and latest news")])],-1)])]),_:1}),$(W(_e),{to:"/hero-database",class:"group no-underline"},{default:J(()=>[...b[51]||(b[51]=[f("div",{class:"h-full flex items-center p-4 bg-slate-900/60 backdrop-blur-md border border-slate-700/50 rounded-2xl transition-all duration-300 group-hover:border-teal-400/50 group-hover:bg-slate-800/60 shadow-xl"},[f("div",{class:"flex-shrink-0 w-14 h-14 rounded-xl bg-gradient-to-br from-teal-400 to-teal-600 flex items-center justify-center mr-4 shadow-lg border-2 border-teal-400/20"},[f("svg",{class:"h-8 w-8 text-black",viewBox:"0 0 600 600",fill:"currentColor"},[f("path",{d:"M 300 0 C 221.30245 0 150.09841 8.0113158 97.068359 21.535156 C 70.553346 28.297076 48.605538 36.277916 31.677734 46.484375 C 16.579982 55.587421 3.2445893 67.928721 0.53125 85 L 0 85 L 0 90 C 0 95.160045 3.6392602 102.94345 17.03125 112.83789 C 30.423241 122.73233 52.11942 133.00486 79.691406 141.62109 C 134.83535 158.85361 213.32376 170 300 170 C 386.67624 170 465.16467 158.85361 520.30859 141.62109 C 547.8806 133.00486 569.57675 122.73233 582.96875 112.83789 C 596.36075 102.94345 600 95.160045 600 90 L 599.87305 90 C 599.19452 70.318664 584.84711 56.447884 568.32227 46.484375 C 551.39442 36.277916 529.44664 28.297076 502.93164 21.535156 C 449.90159 8.0113158 378.69755 0 300 0 z M 0 149.67969 L 0 234.10742 C 0.70499641 239.21983 4.6599347 246.30446 16.722656 255.2168 C 30.11466 265.11125 51.810798 275.38376 79.382812 284 C 134.52681 301.23251 213.01506 312.37891 299.69141 312.37891 C 386.36774 312.37891 464.85602 301.23251 520 284 C 547.57201 275.38376 569.26815 265.11125 582.66016 255.2168 C 596.05215 245.32235 599.69141 237.53895 599.69141 232.37891 L 600 232.37891 L 600 149.67969 C 581.93283 161.57337 559.1282 171.3983 532.24023 179.80078 C 471.56758 198.761 390.05399 210 300 210 C 209.94601 210 128.43244 198.761 67.759766 179.80078 C 40.871811 171.3983 18.067172 161.57337 0 149.67969 z M 600 291.79688 C 590.25148 298.2521 579.18165 304.12941 566.75 309.46875 C 556.06951 314.05598 544.44003 318.27081 531.93164 322.17969 C 471.2589 341.13992 389.74549 352.37891 299.69141 352.37891 C 209.63733 352.37891 128.12391 341.13993 67.451172 322.17969 C 40.720883 313.82647 18.016718 304.0712 0 292.27148 L 0 380 C 0 385.16005 3.6392334 392.94343 17.03125 402.83789 C 30.423267 412.73235 52.119364 423.00484 79.691406 431.62109 C 134.83545 448.85363 213.32358 460 300 460 C 386.67642 460 465.16455 448.85363 520.30859 431.62109 C 547.88068 423.00484 569.57666 412.73235 582.96875 402.83789 C 596.36074 392.94343 600 385.16005 600 380 L 600 291.79688 z M 0 292.27148 L 0 380 C 0 385.16005 3.6392334 392.94343 17.03125 402.83789 C 30.423267 412.73235 52.119364 423.00484 79.691406 431.62109 C 134.83545 448.85363 213.32358 460 300 460 C 386.67642 460 465.16455 448.85363 520.30859 431.62109 C 547.88068 423.00484 569.57666 412.73235 582.96875 402.83789 C 596.36074 392.94343 600 385.16005 600 380 L 600 464.10742 C 599.295 469.21983 595.34007 476.30446 583.27734 485.2168 C 569.88534 495.11125 548.1892 505.38376 520.61719 514 C 465.47319 531.23251 386.98494 542.37891 300.30859 542.37891 C 213.63226 542.37891 135.14398 531.23251 80 514 C 52.427994 505.38376 30.73185 495.11125 17.339844 485.2168 C 3.9478438 475.32235 0.30859375 467.53895 0.30859375 462.37891 L 0 462.37891 L 0 380 C 18.067282 391.82663 40.871811 401.6016 67.759766 410.05859 C 128.43242 429.01883 209.94601 440 300 440 C 390.05399 440 471.56756 429.01883 532.24023 410.05859 C 559.12819 401.6016 581.93283 391.82663 600 380 L 600 292.27148 z"})])]),f("div",{class:"flex-1"},[f("h2",{class:"text-xl font-bold text-white leading-tight"},"Hero Database"),f("p",{class:"text-sm text-slate-400 mt-0.5"},"Browse stats and skills for all heroes")])],-1)])]),_:1}),$(W(_e),{to:"/farming-guide",class:"group no-underline"},{default:J(()=>[...b[52]||(b[52]=[f("div",{class:"h-full flex items-center p-4 bg-slate-900/60 backdrop-blur-md border border-slate-700/50 rounded-2xl transition-all duration-300 group-hover:border-indigo-400/50 group-hover:bg-slate-800/60 shadow-xl"},[f("div",{class:"flex-shrink-0 w-14 h-14 rounded-xl bg-gradient-to-br from-indigo-400 to-indigo-600 flex items-center justify-center mr-4 shadow-lg border-2 border-indigo-400/20"},[f("svg",{class:"h-8 w-8 text-black",viewBox:"0 0 16 16",fill:"currentColor"},[f("path",{d:"M16 0H13L3.70711 9.29289L2.20711 7.79289L0.792893 9.20711L3.08579 11.5L1.5835 13.0023C1.55586 13.0008 1.52802 13 1.5 13C0.671573 13 0 13.6716 0 14.5C0 15.3284 0.671573 16 1.5 16C2.32843 16 3 15.3284 3 14.5C3 14.472 2.99923 14.4441 2.99771 14.4165L4.5 12.9142L6.79289 15.2071L8.20711 13.7929L6.70711 12.2929L16 3V0Z"})])]),f("div",{class:"flex-1"},[f("h2",{class:"text-xl font-bold text-white leading-tight"},"Farming Guide"),f("p",{class:"text-sm text-slate-400 mt-0.5"},"Optimize your resource farming routes")])],-1)])]),_:1}),$(W(_e),{to:"/calendar",class:"group no-underline"},{default:J(()=>[...b[53]||(b[53]=[f("div",{class:"h-full flex items-center p-4 bg-slate-900/60 backdrop-blur-md border border-slate-700/50 rounded-2xl transition-all duration-300 group-hover:border-orange-400/50 group-hover:bg-slate-800/60 shadow-xl"},[f("div",{class:"flex-shrink-0 w-14 h-14 rounded-xl bg-gradient-to-br from-orange-400 to-orange-600 flex items-center justify-center mr-4 shadow-lg border-2 border-orange-400/20"},[f("svg",{class:"h-8 w-8 text-black",viewBox:"0 0 24 24",fill:"currentColor"},[f("path",{"fill-rule":"evenodd","clip-rule":"evenodd",d:"M7 1C6.44772 1 6 1.44772 6 2V3H5C3.34315 3 2 4.34315 2 6V20C2 21.6569 3.34315 23 5 23H13.101C12.5151 22.4259 12.0297 21.7496 11.6736 21H5C4.44772 21 4 20.5523 4 20V11H20V11.2899C20.7224 11.5049 21.396 11.8334 22 12.2547V6C22 4.34315 20.6569 3 19 3H18V2C18 1.44772 17.5523 1 17 1C16.4477 1 16 1.44772 16 2V3H8V2C8 1.44772 7.55228 1 7 1ZM16 6V5H8V6C8 6.55228 7.55228 7 7 7C6.44772 7 6 6.55228 6 6V5H5C4.44772 5 4 5.44772 4 6V9H20V6C20 5.44772 19.5523 5 19 5H18V6C18 6.55228 17.5523 7 17 7C16.4477 7 16 6.55228 16 6Z"}),f("path",{d:"M17 16C17 15.4477 17.4477 15 18 15C18.5523 15 19 15.4477 19 16V17.703L19.8801 18.583C20.2706 18.9736 20.2706 19.6067 19.8801 19.9973C19.4896 20.3878 18.8564 20.3878 18.4659 19.9973L17.2929 18.8243C17.0828 18.6142 16.9857 18.3338 17.0017 18.0588C17.0006 18.0393 17 18.0197 17 18V16Z"}),f("path",{"fill-rule":"evenodd","clip-rule":"evenodd",d:"M24 18C24 21.3137 21.3137 24 18 24C14.6863 24 12 21.3137 12 18C12 14.6863 14.6863 12 18 12C21.3137 12 24 14.6863 24 18ZM13.9819 18C13.9819 20.2191 15.7809 22.0181 18 22.0181C20.2191 22.0181 22.0181 20.2191 22.0181 18C22.0181 15.7809 20.2191 13.9819 18 13.9819C15.7809 13.9819 13.9819 15.7809 13.9819 18Z"})])]),f("div",{class:"flex-1"},[f("h2",{class:"text-xl font-bold text-white leading-tight"},"Event Calendar"),f("p",{class:"text-sm text-slate-400 mt-0.5"},"Track monthly events and hero schedules")])],-1)])]),_:1}),$(W(_e),{to:"/hero-coach",class:"group no-underline"},{default:J(()=>[...b[54]||(b[54]=[f("div",{class:"h-full flex items-center p-4 bg-slate-900/60 backdrop-blur-md border border-slate-700/50 rounded-2xl transition-all duration-300 group-hover:border-yellow-400/50 group-hover:bg-slate-800/60 shadow-xl"},[f("div",{class:"flex-shrink-0 w-14 h-14 rounded-xl bg-gradient-to-br from-yellow-400 to-yellow-600 flex items-center justify-center mr-4 shadow-lg border-2 border-yellow-400/20"},[f("svg",{class:"h-8 w-8 text-black",version:"1.1",xmlns:"http://www.w3.org/2000/svg",viewBox:"0 0 512 512",fill:"currentColor"},[f("path",{d:"M141.698,141.549H79.077c-8.488,0-15.37,6.882-15.37,15.362v198.179c0,8.479,6.882,15.362,15.37,15.362h62.622 c8.489,0,15.371-6.883,15.371-15.362V156.911C157.07,148.431,150.187,141.549,141.698,141.549z"}),f("path",{d:"M32.374,189.734H12.803C5.736,189.734,0,195.47,0,202.537v106.925c0,7.068,5.736,12.803,12.803,12.803h19.571 c7.067,0,12.803-5.736,12.803-12.803V202.537C45.177,195.47,39.441,189.734,32.374,189.734z"}),f("rect",{x:"177.69",y:"228.894",width:"156.62",height:"54.212"}),f("path",{d:"M432.922,141.549h-62.621c-8.488,0-15.371,6.882-15.371,15.362v198.179c0,8.479,6.882,15.362,15.371,15.362 h62.621c8.488,0,15.371-6.883,15.371-15.362V156.911C448.293,148.431,441.411,141.549,432.922,141.549z"}),f("path",{d:"M499.197,189.734h-19.57c-7.068,0-12.803,5.736-12.803,12.803v106.925c0,7.068,5.736,12.803,12.803,12.803 h19.57c7.068,0,12.803-5.736,12.803-12.803V202.537C512,195.47,506.264,189.734,499.197,189.734z"})])]),f("div",{class:"flex-1"},[f("h2",{class:"text-xl font-bold text-white leading-tight"},"Hero Coach"),f("p",{class:"text-sm text-slate-400 mt-0.5"},"See eligible heroes for instant max")])],-1)])]),_:1}),$(W(_e),{to:"/visiting-outfitter",class:"group no-underline"},{default:J(()=>[...b[55]||(b[55]=[f("div",{class:"h-full flex items-center p-4 bg-slate-900/60 backdrop-blur-md border border-slate-700/50 rounded-2xl transition-all duration-300 group-hover:border-pink-400/50 group-hover:bg-slate-800/60 shadow-xl"},[f("div",{class:"flex-shrink-0 w-14 h-14 rounded-xl bg-gradient-to-br from-pink-400 to-pink-600 flex items-center justify-center mr-4 shadow-lg border-2 border-pink-400/20"},[f("svg",{class:"h-8 w-8 text-black",viewBox:"0 0 24 24",fill:"none",stroke:"currentColor","stroke-width":"2"},[f("path",{d:"M21 18L14.9339 13.8837M11.7895 11.75L7 8.5M21 5.5L7 15M8 6.5C8 7.88071 6.88071 9 5.5 9C4.11929 9 3 7.88071 3 6.5C3 5.11929 4.11929 4 5.5 4C6.88071 4 8 5.11929 8 6.5ZM8 17C8 15.6193 6.88071 14.5 5.5 14.5C4.11929 14.5 3 15.6193 3 17C3 18.3807 4.11929 19.5 5.5 19.5C6.88071 19.5 8 18.3807 8 17Z"})])]),f("div",{class:"flex-1"},[f("h2",{class:"text-xl font-bold text-white leading-tight"},"Visiting Outfitter"),f("p",{class:"text-sm text-slate-400 mt-0.5"},"See costumes available in Outfitter")])],-1)])]),_:1}),$(W(_e),{to:"/soul-exchange",class:"group no-underline"},{default:J(()=>[...b[56]||(b[56]=[f("div",{class:"h-full flex items-center p-4 bg-slate-900/60 backdrop-blur-md border border-slate-700/50 rounded-2xl transition-all duration-300 group-hover:border-purple-400/50 group-hover:bg-slate-800/60 shadow-xl"},[f("div",{class:"flex-shrink-0 w-14 h-14 rounded-xl bg-gradient-to-br from-purple-400 to-purple-600 flex items-center justify-center mr-4 shadow-lg border-2 border-purple-400/20"},[f("svg",{class:"h-8 w-8 text-black",version:"1.1",xmlns:"http://www.w3.org/2000/svg",viewBox:"0 0 512 512",fill:"currentColor"},[f("path",{d:"M405.878,357.099c-3.641-41.297-29.703-99.953-92.734-102.781c-92.922,0.25-106.391,72.141-97.656,103.984 c7.328,26.75,26.781,48.078,54.422,45.656s48.469-26.844,45.656-54.438c-0.484-29.266,24.344-28.5,25.094,3.875 c1.016,43.094-28.094,80.922-71.031,84.703c-42.938,3.75-77.531-28.547-84.719-71.031c-4.344-25.781,0.594-75.172,44.438-113.766 c56.344-49.594,117.719,9.875,112.734-70.578c-5.031-81.188-25.438-82.906-78.063-114.531 c-34.797-20.922-40.75-54.109-38.797-67.109c0.078-0.625,0.078-1.563-1.156-0.781c-32.594,20.469-32.859,58-13.813,87.25 c9.141,14.016,28.031,21.234,29.969,43.422c2.641,30.094-14.672,39.281-28.938,51.703c-14.25,12.422-31.219,25.75-56.813,52.078 c-40.875,42.063-51.625,95.219-48.359,140.266c3.609,41.281,23.625,77.203,53.031,101.875 c29.453,24.688,68.313,38.141,109.594,34.516c41.297-3.625,77.203-23.641,101.906-53.063 C395.315,428.911,409.487,398.38,405.878,357.099z"})])]),f("div",{class:"flex-1"},[f("h2",{class:"text-xl font-bold text-white leading-tight"},"Soul Exchange"),f("p",{class:"text-sm text-slate-400 mt-0.5"},"Browse Soul Exchange heroes")])],-1)])]),_:1}),$(W(_e),{to:"/fated-summon",class:"group no-underline"},{default:J(()=>[...b[57]||(b[57]=[f("div",{class:"h-full flex items-center p-4 bg-slate-900/60 backdrop-blur-md border border-slate-700/50 rounded-2xl transition-all duration-300 group-hover:border-cyan-400/50 group-hover:bg-slate-800/60 shadow-xl"},[f("div",{class:"flex-shrink-0 w-14 h-14 rounded-xl bg-gradient-to-br from-cyan-400 to-cyan-600 flex items-center justify-center mr-4 shadow-lg border-2 border-cyan-400/20"},[f("svg",{class:"h-8 w-8 text-black",viewBox:"0 0 16 16",fill:"currentColor"},[f("path",{"fill-rule":"evenodd","clip-rule":"evenodd",d:"M12.4722 10C13.4223 8.93849 14 7.53671 14 6C14 2.68629 11.3137 0 8 0C4.68629 0 2 2.68629 2 6C2 7.53671 2.57771 8.93849 3.52779 10H12.4722ZM8 5L10 3L12 5L10 7L8 5Z"}),f("path",{d:"M15 15V14L13 12H3L1 14V15H15Z"})])]),f("div",{class:"flex-1"},[f("h2",{class:"text-xl font-bold text-white leading-tight"},"Fated Summon"),f("p",{class:"text-sm text-slate-400 mt-0.5"},"Pick a guaranteed legendary hero")])],-1)])]),_:1}),$(W(_e),{to:"/tier-list",class:"group no-underline"},{default:J(()=>[...b[58]||(b[58]=[f("div",{class:"h-full flex items-center p-4 bg-slate-900/60 backdrop-blur-md border border-slate-700/50 rounded-2xl transition-all duration-300 group-hover:border-lime-400/50 group-hover:bg-slate-800/60 shadow-xl"},[f("div",{class:"flex-shrink-0 w-14 h-14 rounded-xl bg-gradient-to-br from-lime-400 to-lime-600 flex items-center justify-center mr-4 shadow-lg border-2 border-lime-400/20"},[f("svg",{class:"h-8 w-8 text-black",viewBox:"0 0 24 24",version:"1.1",xmlns:"http://www.w3.org/2000/svg",fill:"currentColor"},[f("path",{d:"M7.23767,17.0125 C7.62819,16.622 8.26136,16.622 8.65188,17.0125 C9.01236,17.3729615 9.04008923,17.9402207 8.73506769,18.3324973 L8.65188,18.4267 L6.35378,20.7248 C5.89817333,21.1804533 5.17834996,21.2108302 4.68751439,20.8159307 L4.58602,20.7248 L3.34856,19.4874 C2.95803,19.0968 2.95803,18.4637 3.34856,18.0731 C3.70904,17.7126385 4.27627503,17.6849107 4.6685635,17.9899166 L4.76277,18.0731 L5.4699,18.7803 L7.23767,17.0125 Z M20.0002,17.9999 C20.5525,17.9999 21.0002,18.4477 21.0002,18.9999 C21.0002,19.5522 20.5525,19.9999 20.0002,19.9999 L11.0002,19.9999 C10.4479,19.9999 10.0002,19.5522 10.0002,18.9999 C10.0002,18.4477 10.4479,17.9999 11.0002,17.9999 L20.0002,17.9999 Z M8.65188,10.0125 C9.0424,10.403 9.0424,11.0362 8.65188,11.4267 L6.35378,13.7248 C5.86563,14.213 5.07417,14.213 4.58602,13.7248 L3.34856,12.4873 C2.95803,12.0968 2.95803,11.4637 3.34856,11.0731 C3.73908,10.6826 4.37225,10.6826 4.76277,11.0731 L5.4699,11.7803 L7.23767,10.0125 C7.62819,9.62197 8.26136,9.62197 8.65188,10.0125 Z M20.0002,10.9999 C20.5525,10.9999 21.0002,11.4477 21.0002,11.9999 C21.0002,12.51275 20.614173,12.9354092 20.1168239,12.9931725 L20.0002,12.9999 L11.0002,12.9999 C10.4479,12.9999 10.0002,12.5522 10.0002,11.9999 C10.0002,11.4871429 10.386227,11.0644041 10.8835761,11.0066289 L11.0002,10.9999 L20.0002,10.9999 Z M7.23767,3.0125 C7.62819,2.62197 8.26136,2.62197 8.65188,3.0125 C9.01236,3.37298 9.04008923,3.94021503 8.73506769,4.3325035 L8.65188,4.42671 L6.35378,6.72481 C5.89817333,7.18041667 5.17834996,7.21079044 4.68751439,6.81593133 L4.58602,6.72481 L3.34856,5.48735 C2.95803,5.09683 2.95803,4.46366 3.34856,4.07314 C3.70904,3.71265077 4.27627503,3.68492083 4.6685635,3.98995018 L4.76277,4.07314 L5.4699,4.78026 L7.23767,3.0125 Z M20.0002,3.99995 C20.5525,3.99995 21.0002,4.44766 21.0002,4.99995 C21.0002,5.51278143 20.614173,5.93545653 20.1168239,5.9932222 L20.0002,5.99995 L11.0002,5.99995 C10.4479,5.99995 10.0002,5.55223 10.0002,4.99995 C10.0002,4.48710929 10.386227,4.06429043 10.8835761,4.00651523 L11.0002,3.99995 L20.0002,3.99995 Z"})])]),f("div",{class:"flex-1"},[f("h2",{class:"text-xl font-bold text-white leading-tight"},"Tier List"),f("p",{class:"text-sm text-slate-400 mt-0.5"},"Create and view hero tier lists")])],-1)])]),_:1}),$(W(_e),{to:"/talent-simulator",class:"group no-underline"},{default:J(()=>[...b[59]||(b[59]=[f("div",{class:"h-full flex items-center p-4 bg-slate-900/60 backdrop-blur-md border border-slate-700/50 rounded-2xl transition-all duration-300 group-hover:border-orange-400/50 group-hover:bg-slate-800/60 shadow-xl"},[f("div",{class:"flex-shrink-0 w-14 h-14 rounded-xl bg-gradient-to-br from-orange-400 to-orange-600 flex items-center justify-center mr-4 shadow-lg border-2 border-orange-400/20"},[f("svg",{class:"h-8 w-8 text-black",fill:"currentColor",viewBox:"0 0 24 24",stroke:"currentColor","stroke-width":"1.5"},[f("circle",{cx:"12",cy:"7",r:"2",fill:"currentColor",stroke:"currentColor"}),f("circle",{cx:"8",cy:"17",r:"2",fill:"currentColor",stroke:"currentColor"}),f("circle",{cx:"16",cy:"17",r:"2",fill:"currentColor",stroke:"currentColor"}),f("line",{x1:"12",y1:"9",x2:"8",y2:"15",stroke:"currentColor","stroke-width":"1.5"}),f("line",{x1:"12",y1:"9",x2:"16",y2:"15",stroke:"currentColor","stroke-width":"1.5"})])]),f("div",{class:"flex-1"},[f("h2",{class:"text-xl font-bold text-white leading-tight"},"Talent Simulator"),f("p",{class:"text-sm text-slate-400 mt-0.5"},"Plan your hero's talent grid")])],-1)])]),_:1}),$(W(_e),{to:"/codes",class:"group no-underline"},{default:J(()=>[...b[60]||(b[60]=[f("div",{class:"h-full flex items-center p-4 bg-slate-900/60 backdrop-blur-md border border-slate-700/50 rounded-2xl transition-all duration-300 group-hover:border-green-400/50 group-hover:bg-slate-800/60 shadow-xl"},[f("div",{class:"flex-shrink-0 w-14 h-14 rounded-xl bg-gradient-to-br from-green-400 to-green-600 flex items-center justify-center mr-4 shadow-lg border-2 border-green-400/20"},[f("svg",{class:"h-8 w-8 text-black",viewBox:"0 0 48 48",xmlns:"http://www.w3.org/2000/svg",fill:"currentColor"},[f("path",{d:"M43,12H38.3a4.2,4.2,0,0,0,.4-1,7,7,0,0,0-.6-5.3,6.7,6.7,0,0,0-4.3-3.4A7.1,7.1,0,0,0,25,7l-1,3.4L23,7a7.1,7.1,0,0,0-8.8-4.7A6.7,6.7,0,0,0,9.9,5.7,7,7,0,0,0,9.3,11a4.2,4.2,0,0,0,.4,1H5a2.9,2.9,0,0,0-3,3v7H17V16h4v6h6V16h4v6H46V15A2.9,2.9,0,0,0,43,12ZM17,12h-.9a3.1,3.1,0,0,1-3-2.2,2.9,2.9,0,0,1,.3-2.2,3,3,0,0,1,1.8-1.5,3.3,3.3,0,0,1,4,2.1L20.3,12ZM34.9,9.8a3.1,3.1,0,0,1-3,2.2H27.7l1.1-3.8a3.3,3.3,0,0,1,4-2.1,3,3,0,0,1,1.8,1.5A2.9,2.9,0,0,1,34.9,9.8Z"}),f("rect",{x:"21",y:"26",width:"6",height:"20"}),f("path",{d:"M4,43a3,3,0,0,0,3,3H17V26H4Z"}),f("path",{d:"M31,46H41a3,3,0,0,0,3-3V26H31Z"})])]),f("div",{class:"flex-1"},[f("h2",{class:"text-xl font-bold text-white leading-tight"},"Redeem Codes"),f("p",{class:"text-sm text-slate-400 mt-0.5"},"Find and redeem the latest E&P codes")])],-1)])]),_:1})])])])):Ue("",!0)])),f("div",null,[$(H,{modelValue:W(A),"onUpdate:modelValue":b[15]||(b[15]=N=>dp(A)?A.value=N:null),"bg-opacity":xe.value,"z-index":200},{default:J(()=>[f("div",Tw,[b[79]||(b[79]=f("h2",{class:"text-center text-3xl font-bold text-white mb-2"},"Account",-1)),W(L)?(q(),Q("div",Iw,[f("div",Cw,[W(L).photoURL?(q(),Q("img",{key:0,src:W(L).photoURL,class:"w-16 h-16 rounded-full border-2 border-blue-500"},null,8,Aw)):(q(),Q("div",Rw,[$(W(Lo),{class:"w-8 h-8 text-gray-400"})])),f("p",Sw,qe(W(L).displayName||W(L).email),1),W(L).displayName?(q(),Q("p",xw,qe(W(L).email),1)):Ue("",!0)]),f("div",kw,[b[63]||(b[63]=f("h3",{class:"font-bold mb-3 text-sm uppercase tracking-wider text-gray-400"},"Profile Settings",-1)),f("div",Pw,[b[61]||(b[61]=f("label",{for:"display-name",class:"text-xs text-gray-400"},"Public Display Name",-1)),f("div",Vw,[Wn(f("input",{id:"display-name","onUpdate:modelValue":b[4]||(b[4]=N=>De.value=N),type:"text",placeholder:"Enter display name",class:"flex-1 bg-gray-900 border border-gray-600 rounded px-3 py-2 text-white focus:outline-none focus:border-blue-500 transition"},null,512),[[Kn,De.value]]),f("button",{onClick:Ht,disabled:Rt.value||!De.value,class:"bg-blue-600 hover:bg-blue-500 disabled:opacity-50 text-white px-4 py-2 rounded font-bold text-sm transition"},qe(Rt.value?"...":"Save"),9,Mw)]),b[62]||(b[62]=f("p",{class:"text-[10px] text-gray-500 mt-1 italic"},"This name will be shown on the leaderboard and on your tier lists. ",-1))])]),f("div",Dw,[b[64]||(b[64]=f("h3",{class:"text-white font-bold mb-2 border-b border-gray-700 pb-1"},"My Saved Tierlists",-1)),v.value?(q(),Q("div",Nw,"Loading lists...")):R.value.length===0?(q(),Q("div",Lw,"No saved tierlists yet. ")):(q(),Q("ul",Ow,[(q(!0),Q(ns,null,ci(R.value,N=>(q(),Q("li",{key:N.id,class:"flex items-center justify-between group"},[$(W(_e),{to:`/tier-list/${N.id}`,onClick:b[5]||(b[5]=K=>A.value=!1),class:"text-blue-400 hover:text-blue-300 truncate flex-1 mr-2"},{default:J(()=>[me(qe(N.name||"Untitled List"),1)]),_:2},1032,["to"]),f("span",Fw,qe(new Date(N.updatedAt?.toDate()).toLocaleDateString()),1)]))),128))]))]),f("button",{onClick:se,class:"flex items-center gap-2 px-6 py-2 rounded-lg bg-red-500/80 hover:bg-red-600 text-white font-semibold transition cursor-pointer mt-4"},[$(W(ky),{class:"w-5 h-5"}),b[65]||(b[65]=me(" Sign Out ",-1))])])):(q(),Q("div",Uw,[E.value?(q(),Q("div",Bw,qe(E.value),1)):Ue("",!0),f("div",jw,[f("button",{class:"flex items-center gap-2 px-4 py-2 rounded-lg bg-white text-gray-900 font-semibold shadow hover:bg-gray-100 transition cursor-pointer disabled:opacity-50",onClick:te,"aria-label":"Sign in with Google",type:"button",disabled:w.value},[...b[66]||(b[66]=[f("svg",{class:"w-6 h-6",viewBox:"0 0 48 48"},[f("g",null,[f("path",{fill:"#4285F4",d:"M44.5 20H24v8.5h11.7C34.9 33.1 30.2 36 24 36c-6.6 0-12-5.4-12-12s5.4-12 12-12c3.1 0 5.9 1.1 8.1 2.9l6.1-6.1C34.5 6.2 29.6 4 24 4 12.9 4 4 12.9 4 24s8.9 20 20 20c11 0 19.7-8 19.7-20 0-1.3-.1-2.7-.3-4z"}),f("path",{fill:"#34A853",d:"M6.3 14.7l7 5.1C15.3 16.2 19.3 13 24 13c3.1 0 5.9 1.1 8.1 2.9l6.1-6.1C34.5 6.2 29.6 4 24 4c-7.2 0-13.4 4.1-16.7 10.7z"}),f("path",{fill:"#FBBC05",d:"M24 44c5.2 0 9.9-1.7 13.2-4.7l-6.1-5.1C29.9 36.9 27.1 38 24 38c-6.2 0-11.4-4.2-13.3-9.9l-7 5.4C6.6 39.9 14.7 44 24 44z"}),f("path",{fill:"#EA4335",d:"M44.5 20H24v8.5h11.7c-1.1 3.1-4.1 5.5-7.7 5.5-4.6 0-8.3-3.7-8.3-8.3s3.7-8.3 8.3-8.3c2.6 0 4.9 1.1 6.5 2.8l6.2-6.2C37.9 10.1 31.4 7 24 7c-9.4 0-17 7.6-17 17s7.6 17 17 17c8.8 0 16.1-6.2 16.1-15.1 0-1-.1-2-.3-3z"})])],-1),me(" Continue with Google ",-1)])],8,$w)]),b[78]||(b[78]=f("div",{class:"flex items-center mb-4"},[f("div",{class:"flex-grow border-t border-gray-600"}),f("span",{class:"mx-3 text-gray-400"},"or"),f("div",{class:"flex-grow border-t border-gray-600"})],-1)),!ge.value&&!T.value?(q(),Q("form",{key:1,onSubmit:Ys(x,["prevent"]),class:"space-y-4"},[f("div",null,[b[67]||(b[67]=f("label",{class:"block text-gray-200 mb-1",for:"email"},"Email",-1)),Wn(f("input",{id:"email","onUpdate:modelValue":b[6]||(b[6]=N=>m.value=N),type:"email",class:"w-full px-4 py-2 rounded-lg bg-gray-800 text-white border border-gray-600 focus:outline-none focus:ring-2 focus:ring-blue-400",autocomplete:"email",required:""},null,512),[[Kn,m.value]])]),f("div",null,[b[68]||(b[68]=f("label",{class:"block text-gray-200 mb-1",for:"password"},"Password",-1)),Wn(f("input",{id:"password","onUpdate:modelValue":b[7]||(b[7]=N=>_.value=N),type:"password",class:"w-full px-4 py-2 rounded-lg bg-gray-800 text-white border border-gray-600 focus:outline-none focus:ring-2 focus:ring-blue-400",autocomplete:"current-password",required:""},null,512),[[Kn,_.value]])]),f("button",{type:"submit",class:"w-full py-2 rounded-lg bg-blue-500 hover:bg-blue-600 text-white font-semibold shadow transition cursor-pointer disabled:opacity-50",disabled:w.value},qe(w.value?"Signing In...":"Sign In"),9,qw)],32)):Ue("",!0),!ge.value&&!T.value?(q(),Q("div",zw,[f("button",{class:"flex items-center justify-center gap-1 px-3 py-2 rounded transition hover:bg-gray-800/60 focus:outline-none focus:ring-2 focus:ring-blue-400 cursor-pointer",type:"button",onClick:b[8]||(b[8]=N=>{T.value=!0,E.value=""})},[...b[69]||(b[69]=[f("svg",{class:"w-4 h-4 mr-1 text-blue-400",fill:"none",stroke:"currentColor","stroke-width":"2",viewBox:"0 0 24 24"},[f("path",{"stroke-linecap":"round","stroke-linejoin":"round",d:"M12 8v4l3 3m6-3a9 9 0 11-18 0 9 9 0 0118 0z"})],-1),me(" Forgot password? ",-1)])]),f("button",{class:"flex items-center justify-center gap-1 px-3 py-2 rounded transition hover:bg-gray-800/60 focus:outline-none focus:ring-2 focus:ring-green-400 cursor-pointer",type:"button",onClick:b[9]||(b[9]=N=>{ge.value=!0,E.value=""})},[...b[70]||(b[70]=[f("svg",{class:"w-4 h-4 mr-1 text-green-400",fill:"none",stroke:"currentColor","stroke-width":"2",viewBox:"0 0 24 24"},[f("path",{"stroke-linecap":"round","stroke-linejoin":"round",d:"M12 4v16m8-8H4"})],-1),f("span",null,[me("Don't have an account? "),f("span",{class:"underline"},"Sign Up")],-1)])])])):Ue("",!0),ge.value?(q(),Q("form",{key:3,onSubmit:Ys(C,["prevent"]),class:"space-y-4 mt-2"},[f("div",null,[b[71]||(b[71]=f("label",{class:"block text-gray-200 mb-1",for:"signup-email"},"Email",-1)),Wn(f("input",{id:"signup-email","onUpdate:modelValue":b[10]||(b[10]=N=>m.value=N),type:"email",class:"w-full px-4 py-2 rounded-lg bg-gray-800 text-white border border-gray-600 focus:outline-none focus:ring-2 focus:ring-blue-400",autocomplete:"email",required:""},null,512),[[Kn,m.value]])]),f("div",null,[b[72]||(b[72]=f("label",{class:"block text-gray-200 mb-1",for:"signup-password"},"Password",-1)),Wn(f("input",{id:"signup-password","onUpdate:modelValue":b[11]||(b[11]=N=>_.value=N),type:"password",class:"w-full px-4 py-2 rounded-lg bg-gray-800 text-white border border-gray-600 focus:outline-none focus:ring-2 focus:ring-blue-400",autocomplete:"new-password",required:""},null,512),[[Kn,_.value]])]),f("div",Hw,[f("button",{type:"submit",class:"flex items-center justify-center gap-2 w-full py-2 rounded-lg bg-green-500 hover:bg-green-600 text-white font-semibold shadow transition focus:outline-none focus:ring-2 focus:ring-green-300 cursor-pointer disabled:opacity-50",disabled:w.value},[w.value?Ue("",!0):(q(),Q("svg",Ww,[...b[73]||(b[73]=[f("path",{"stroke-linecap":"round","stroke-linejoin":"round",d:"M12 4v16m8-8H4"},null,-1)])])),me(" "+qe(w.value?"Creating Account...":"Create Account"),1)],8,Gw),f("button",{class:"flex items-center justify-center gap-2 w-full py-2 rounded-lg bg-gray-800 hover:bg-gray-700 text-gray-200 font-semibold transition focus:outline-none focus:ring-2 focus:ring-blue-400 cursor-pointer",type:"button",onClick:b[12]||(b[12]=N=>{ge.value=!1,E.value=""})},[...b[74]||(b[74]=[f("svg",{class:"w-4 h-4 text-blue-400",fill:"none",stroke:"currentColor","stroke-width":"2",viewBox:"0 0 24 24"},[f("path",{"stroke-linecap":"round","stroke-linejoin":"round",d:"M15 19l-7-7 7-7"})],-1),me(" Back to Sign In ",-1)])])])],32)):Ue("",!0),T.value?(q(),Q("form",{key:4,onSubmit:Ys(X,["prevent"]),class:"space-y-4 mt-2"},[f("div",null,[b[75]||(b[75]=f("label",{class:"block text-gray-200 mb-1",for:"forgot-email"},"Email",-1)),Wn(f("input",{id:"forgot-email","onUpdate:modelValue":b[13]||(b[13]=N=>m.value=N),type:"email",class:"w-full px-4 py-2 rounded-lg bg-gray-800 text-white border border-gray-600 focus:outline-none focus:ring-2 focus:ring-blue-400",autocomplete:"email",required:""},null,512),[[Kn,m.value]])]),f("div",Kw,[f("button",{type:"submit",class:"flex items-center justify-center gap-2 w-full py-2 rounded-lg bg-yellow-500 hover:bg-yellow-600 text-white font-semibold shadow transition cursor-pointer focus:outline-none focus:ring-2 focus:ring-yellow-300 disabled:opacity-50",disabled:w.value},[w.value?Ue("",!0):(q(),Q("svg",Yw,[...b[76]||(b[76]=[f("path",{"stroke-linecap":"round","stroke-linejoin":"round",d:"M16 12v1a4 4 0 01-8 0v-1m8 0V8a4 4 0 00-8 0v4m8 0H8"},null,-1)])])),me(" "+qe(w.value?"Sending...":"Send Reset Link"),1)],8,Qw),f("button",{class:"flex items-center justify-center gap-2 w-full py-2 rounded-lg bg-gray-800 hover:bg-gray-700 text-gray-200 font-semibold transition focus:outline-none focus:ring-2 focus:ring-blue-400 cursor-pointer",type:"button",onClick:b[14]||(b[14]=N=>{T.value=!1,E.value=""})},[...b[77]||(b[77]=[f("svg",{class:"w-4 h-4 text-blue-400",fill:"none",stroke:"currentColor","stroke-width":"2",viewBox:"0 0 24 24"},[f("path",{"stroke-linecap":"round","stroke-linejoin":"round",d:"M15 19l-7-7 7-7"})],-1),me(" Back to Sign In ",-1)])])])],32)):Ue("",!0)]))])]),_:1},8,["modelValue","bg-opacity"])]),$(H,{modelValue:t.value,"onUpdate:modelValue":b[16]||(b[16]=N=>t.value=N),"bg-opacity":70,"no-padding":"","no-border":""},{default:J(()=>[$(Z,{code:W(r)},null,8,["code"])]),_:1},8,["modelValue"]),(q(),Zn(Uo,{to:"body"},[$(eh,{"enter-active-class":"transition duration-300 ease-out","enter-from-class":"transform translate-y-10 opacity-0","enter-to-class":"transform translate-y-0 opacity-100","leave-active-class":"transition duration-200 ease-in","leave-from-class":"transform translate-y-0 opacity-100","leave-to-class":"transform translate-y-10 opacity-0"},{default:J(()=>[O.showScrollToTop&&I.value?(q(),Q("button",{key:0,onClick:D,class:"fixed bottom-6 right-6 z-[90] p-3 rounded-full bg-slate-900/80 border border-cyan-400/30 text-cyan-400 shadow-[0_0_20px_rgba(34,211,238,0.2)] hover:bg-cyan-400 hover:text-slate-900 hover:shadow-[0_0_25px_rgba(34,211,238,0.4)] transition-all duration-300 cursor-pointer backdrop-blur-sm group","aria-label":"Scroll to top"},[$(W(Vy),{class:"w-6 h-6 transform group-hover:-translate-y-0.5 transition-transform duration-300"})])):Ue("",!0)]),_:1})]))])}}}),p4=Object.assign(pr(Xw,[["__scopeId","data-v-94c8f988"]]),{__name:"AppHeader"}),Zw={class:"w-full text-gray-400 text-center py-6 px-3 mt-12 mb-0 md:mb-0 border-t border-gray-900 bottom-0"},e4={class:"container mx-auto flex flex-col items-center space-y-2"},t4={class:"mb-2 flex flex-wrap justify-center gap-4 text-sm"},n4={class:"flex md:hidden flex-col items-center justify-center relative"},r4=["src"],s4="https://raw.githubusercontent.com/vabe44/31f5d518-epzl-cdn/main",i4=fr({__name:"AppFooter",setup(n){const e=s4;return(t,r)=>{const s=th,o=fp("RouterLink");return q(),Q("footer",Zw,[f("div",e4,[f("nav",t4,[$(s,{to:"/about",class:"hover:underline"},{default:J(()=>[...r[0]||(r[0]=[me("About Us",-1)])]),_:1}),$(s,{to:"/contact",class:"hover:underline"},{default:J(()=>[...r[1]||(r[1]=[me("Contact Us",-1)])]),_:1}),$(s,{to:"/privacy-policy",class:"hover:underline"},{default:J(()=>[...r[2]||(r[2]=[me("Privacy Policy",-1)])]),_:1}),$(s,{to:"/terms",class:"hover:underline"},{default:J(()=>[...r[3]||(r[3]=[me("Terms & Conditions",-1)])]),_:1}),$(s,{to:"/disclaimer",class:"hover:underline"},{default:J(()=>[...r[4]||(r[4]=[me("Disclaimer",-1)])]),_:1}),$(s,{to:"/support-us",class:"hover:underline"},{default:J(()=>[...r[5]||(r[5]=[me("Support Us",-1)])]),_:1})]),fa(t.$slots,"default",{},void 0,!0)]),f("div",n4,[$(o,{to:"/",class:"block"},{default:J(()=>[f("img",{alt:"Empuzzled logo",class:"logo w-[128px] md:w-[180px]",src:`${W(e)}/logo-crop.webp`,loading:"lazy"},null,8,r4)]),_:1})])])}}}),g4=Object.assign(pr(i4,[["__scopeId","data-v-adfa0299"]]),{__name:"AppFooter"});export{u2 as A,Vy as B,wt as C,si as D,h4 as E,d4 as F,My as G,f4 as H,Ce as T,p4 as _,g4 as a,zu as b,Hu as c,_l as d,av as e,Ws as f,nt as g,gp as h,Dy as i,xn as j,xt as k,uv as l,cv as m,c4 as n,u4 as o,Wa as p,dv as q,qu as r,ri as s,l4 as t,yl as u,Ti as v,qd as w,la as x,Ii as y,il as z};
